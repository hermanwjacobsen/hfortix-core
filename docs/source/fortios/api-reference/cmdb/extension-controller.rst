...
.. automodule:: hfortix_fortios.api.v2.cmdb.extension_controller
   :members:
   :undoc-members:
   :show-inheritance:
   :recursive:
...
.. note::
   ...
   the ``fgt.api.cmdb.extension_controller`` namespace.
...
.. code-block:: python
   ...
   result = fgt.api.cmdb.extension_controller.<endpoint>.list()
