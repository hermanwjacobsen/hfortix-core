...
.. code-block:: python
   ...
   fgt.api.cmdb.switch-controller.custom_command
...
- :doc:`/fortios/api-reference/cmdb/switch-controller/index` - Switch Controller overview
