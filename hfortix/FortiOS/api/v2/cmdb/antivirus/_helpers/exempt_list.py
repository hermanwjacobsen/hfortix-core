...
def validate_exempt_list_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'hash-type' in payload:
        ...
        if value and value not in VALID_BODY_HASH_TYPE:
            return (False, f"Invalid hash-type '{value}'. Must be one of: {', '.join(VALID_BODY_HASH_TYPE)}")
...
def validate_exempt_list_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
