...
def validate_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'log-all-domain' in payload:
        ...
        if value and value not in VALID_BODY_LOG_ALL_DOMAIN:
            return (False, f"Invalid log-all-domain '{value}'. Must be one of: {', '.join(VALID_BODY_LOG_ALL_DOMAIN)}")
    ...
    if 'sdns-ftgd-err-log' in payload:
        ...
        if value and value not in VALID_BODY_SDNS_FTGD_ERR_LOG:
            return (False, f"Invalid sdns-ftgd-err-log '{value}'. Must be one of: {', '.join(VALID_BODY_SDNS_FTGD_ERR_LOG)}")
    ...
    if 'sdns-domain-log' in payload:
        ...
        if value and value not in VALID_BODY_SDNS_DOMAIN_LOG:
            return (False, f"Invalid sdns-domain-log '{value}'. Must be one of: {', '.join(VALID_BODY_SDNS_DOMAIN_LOG)}")
    ...
    if 'block-action' in payload:
        ...
        if value and value not in VALID_BODY_BLOCK_ACTION:
            return (False, f"Invalid block-action '{value}'. Must be one of: {', '.join(VALID_BODY_BLOCK_ACTION)}")
    ...
    if 'block-botnet' in payload:
        ...
        if value and value not in VALID_BODY_BLOCK_BOTNET:
            return (False, f"Invalid block-botnet '{value}'. Must be one of: {', '.join(VALID_BODY_BLOCK_BOTNET)}")
    ...
    if 'safe-search' in payload:
        ...
        if value and value not in VALID_BODY_SAFE_SEARCH:
            return (False, f"Invalid safe-search '{value}'. Must be one of: {', '.join(VALID_BODY_SAFE_SEARCH)}")
    ...
    if 'youtube-restrict' in payload:
        ...
        if value and value not in VALID_BODY_YOUTUBE_RESTRICT:
            return (False, f"Invalid youtube-restrict '{value}'. Must be one of: {', '.join(VALID_BODY_YOUTUBE_RESTRICT)}")
    ...
    if 'strip-ech' in payload:
        ...
        if value and value not in VALID_BODY_STRIP_ECH:
            return (False, f"Invalid strip-ech '{value}'. Must be one of: {', '.join(VALID_BODY_STRIP_ECH)}")
