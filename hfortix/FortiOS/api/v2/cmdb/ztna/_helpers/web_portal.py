...
VALID_BODY_THEME = ['jade', 'neutrino', 'mariner', 'graphite', 'melongene', 'jet-stream', 'security-fabric', 'dark-matter', 'onyx', 'eclipse']
...
def validate_web_portal_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'display-bookmark' in payload:
        ...
        if value and value not in VALID_BODY_DISPLAY_BOOKMARK:
            return (False, f"Invalid display-bookmark '{value}'. Must be one of: {', '.join(VALID_BODY_DISPLAY_BOOKMARK)}")
    ...
    if 'focus-bookmark' in payload:
        ...
        if value and value not in VALID_BODY_FOCUS_BOOKMARK:
            return (False, f"Invalid focus-bookmark '{value}'. Must be one of: {', '.join(VALID_BODY_FOCUS_BOOKMARK)}")
    ...
    if 'display-status' in payload:
        ...
        if value and value not in VALID_BODY_DISPLAY_STATUS:
            return (False, f"Invalid display-status '{value}'. Must be one of: {', '.join(VALID_BODY_DISPLAY_STATUS)}")
    ...
    if 'display-history' in payload:
        ...
        if value and value not in VALID_BODY_DISPLAY_HISTORY:
            return (False, f"Invalid display-history '{value}'. Must be one of: {', '.join(VALID_BODY_DISPLAY_HISTORY)}")
    ...
    if 'policy-auth-sso' in payload:
        ...
        if value and value not in VALID_BODY_POLICY_AUTH_SSO:
            return (False, f"Invalid policy-auth-sso '{value}'. Must be one of: {', '.join(VALID_BODY_POLICY_AUTH_SSO)}")
    ...
    if 'theme' in payload:
        ...
        if value and value not in VALID_BODY_THEME:
            return (False, f"Invalid theme '{value}'. Must be one of: {', '.join(VALID_BODY_THEME)}")
    ...
    if 'clipboard' in payload:
        ...
        if value and value not in VALID_BODY_CLIPBOARD:
            return (False, f"Invalid clipboard '{value}'. Must be one of: {', '.join(VALID_BODY_CLIPBOARD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (False, f"default-window-width must be between 0 and 65535")
            except (ValueError, TypeError):
                return (False, f"default-window-width must be numeric, got: {value}")
    ...
    if 'default-window-height' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"default-window-height must be between 0 and 65535")
            except (ValueError, TypeError):
                return (False, f"default-window-height must be numeric, got: {value}")
    ...
    if 'forticlient-download' in payload:
        ...
        if value and value not in VALID_BODY_FORTICLIENT_DOWNLOAD:
            return (False, f"Invalid forticlient-download '{value}'. Must be one of: {', '.join(VALID_BODY_FORTICLIENT_DOWNLOAD)}")
    ...
    if 'customize-forticlient-download-url' in payload:
        ...
        if value and value not in VALID_BODY_CUSTOMIZE_FORTICLIENT_DOWNLOAD_URL:
            return (False, f"Invalid customize-forticlient-download-url '{value}'. Must be one of: {', '.join(VALID_BODY_CUSTOMIZE_FORTICLIENT_DOWNLOAD_URL)}")
    ...
    if 'windows-forticlient-download-url' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 1023:
            return (False, f"windows-forticlient-download-url cannot exceed 1023 characters")
    ...
    if 'macos-forticlient-download-url' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 1023:
            return (False, f"macos-forticlient-download-url cannot exceed 1023 characters")
...
def validate_web_portal_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
