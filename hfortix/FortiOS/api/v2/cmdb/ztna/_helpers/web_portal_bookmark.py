...
def validate_web_portal_bookmark_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_web_portal_bookmark_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
