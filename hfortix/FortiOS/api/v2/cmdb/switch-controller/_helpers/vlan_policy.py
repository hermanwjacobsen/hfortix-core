...
def validate_vlan_policy_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'allowed-vlans-all' in payload:
        ...
        if value and value not in VALID_BODY_ALLOWED_VLANS_ALL:
            return (False, f"Invalid allowed-vlans-all '{value}'. Must be one of: {', '.join(VALID_BODY_ALLOWED_VLANS_ALL)}")
    ...
    if 'discard-mode' in payload:
        ...
        if value and value not in VALID_BODY_DISCARD_MODE:
            return (False, f"Invalid discard-mode '{value}'. Must be one of: {', '.join(VALID_BODY_DISCARD_MODE)}")
...
def validate_vlan_policy_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
