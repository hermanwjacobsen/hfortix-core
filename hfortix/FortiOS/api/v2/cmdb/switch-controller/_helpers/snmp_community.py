...
VALID_BODY_EVENTS = ['cpu-high', 'mem-low', 'log-full', 'intf-ip', 'ent-conf-change', 'l2mac']
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (False, f"query-v1-port must be between 0 and 65535")
            except (ValueError, TypeError):
    ...
    if 'trap-v1-lport' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"trap-v1-lport must be between 0 and 65535")
            except (ValueError, TypeError):
    ...
    if 'trap-v1-rport' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"trap-v1-rport must be between 0 and 65535")
            except (ValueError, TypeError):
    ...
    if 'trap-v2c-lport' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"trap-v2c-lport must be between 0 and 65535")
            except (ValueError, TypeError):
    ...
    if 'trap-v2c-rport' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"trap-v2c-rport must be between 0 and 65535")
            except (ValueError, TypeError):
