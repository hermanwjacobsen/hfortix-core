...
VALID_BODY_PRIORITY_0 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_1 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_2 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_3 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_4 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_5 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_6 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
VALID_BODY_PRIORITY_7 = ['queue-0', 'queue-1', 'queue-2', 'queue-3', 'queue-4', 'queue-5', 'queue-6', 'queue-7']
...
def validate_qos_dot1p_map_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'egress-pri-tagging' in payload:
        ...
        if value and value not in VALID_BODY_EGRESS_PRI_TAGGING:
            return (False, f"Invalid egress-pri-tagging '{value}'. Must be one of: {', '.join(VALID_BODY_EGRESS_PRI_TAGGING)}")
    ...
    if 'priority-0' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_0:
            return (False, f"Invalid priority-0 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_0)}")
    ...
    if 'priority-1' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_1:
            return (False, f"Invalid priority-1 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_1)}")
    ...
    if 'priority-2' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_2:
            return (False, f"Invalid priority-2 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_2)}")
    ...
    if 'priority-3' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_3:
            return (False, f"Invalid priority-3 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_3)}")
    ...
    if 'priority-4' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_4:
            return (False, f"Invalid priority-4 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_4)}")
    ...
    if 'priority-5' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_5:
            return (False, f"Invalid priority-5 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_5)}")
    ...
    if 'priority-6' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_6:
            return (False, f"Invalid priority-6 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_6)}")
    ...
    if 'priority-7' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_7:
            return (False, f"Invalid priority-7 '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_7)}")
...
def validate_qos_dot1p_map_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
