...
def validate_ptp_interface_policy_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_ptp_interface_policy_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
