...
def validate_krb_keytab_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'pac-data' in payload:
        ...
        if value and value not in VALID_BODY_PAC_DATA:
            return (False, f"Invalid pac-data '{value}'. Must be one of: {', '.join(VALID_BODY_PAC_DATA)}")
...
def validate_krb_keytab_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
