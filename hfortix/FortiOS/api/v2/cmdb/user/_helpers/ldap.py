...
VALID_BODY_GROUP_MEMBER_CHECK = ['user-attr', 'group-object', 'posix-group-object']
VALID_BODY_SECURE = ['disable', 'starttls', 'ldaps']
VALID_BODY_SSL_MIN_PROTO_VERSION = ['default', 'SSLv3', 'TLSv1', 'TLSv1-1', 'TLSv1-2', 'TLSv1-3']
...
def validate_ldap_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'two-factor' in payload:
        ...
        if value and value not in VALID_BODY_TWO_FACTOR:
            return (False, f"Invalid two-factor '{value}'. Must be one of: {', '.join(VALID_BODY_TWO_FACTOR)}")
    ...
    if 'two-factor-authentication' in payload:
        ...
        if value and value not in VALID_BODY_TWO_FACTOR_AUTHENTICATION:
            return (False, f"Invalid two-factor-authentication '{value}'. Must be one of: {', '.join(VALID_BODY_TWO_FACTOR_AUTHENTICATION)}")
    ...
    if 'two-factor-notification' in payload:
        ...
        if value and value not in VALID_BODY_TWO_FACTOR_NOTIFICATION:
            return (False, f"Invalid two-factor-notification '{value}'. Must be one of: {', '.join(VALID_BODY_TWO_FACTOR_NOTIFICATION)}")
    ...
    if 'group-member-check' in payload:
        ...
        if value and value not in VALID_BODY_GROUP_MEMBER_CHECK:
            return (False, f"Invalid group-member-check '{value}'. Must be one of: {', '.join(VALID_BODY_GROUP_MEMBER_CHECK)}")
    ...
    if 'group-object-filter' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 2047:
            return (False, f"group-object-filter cannot exceed 2047 characters")
    ...
    if 'secure' in payload:
        ...
        if value and value not in VALID_BODY_SECURE:
            return (False, f"Invalid secure '{value}'. Must be one of: {', '.join(VALID_BODY_SECURE)}")
    ...
    if 'password-expiry-warning' in payload:
        ...
        if value and value not in VALID_BODY_PASSWORD_EXPIRY_WARNING:
            return (False, f"Invalid password-expiry-warning '{value}'. Must be one of: {', '.join(VALID_BODY_PASSWORD_EXPIRY_WARNING)}")
    ...
    if 'search-type' in payload:
        ...
        if value and value not in VALID_BODY_SEARCH_TYPE:
            return (False, f"Invalid search-type '{value}'. Must be one of: {', '.join(VALID_BODY_SEARCH_TYPE)}")
    ...
    if 'client-cert-auth' in payload:
        ...
        if value and value not in VALID_BODY_CLIENT_CERT_AUTH:
            return (False, f"Invalid client-cert-auth '{value}'. Must be one of: {', '.join(VALID_BODY_CLIENT_CERT_AUTH)}")
    ...
    if 'obtain-user-info' in payload:
        ...
        if value and value not in VALID_BODY_OBTAIN_USER_INFO:
            return (False, f"Invalid obtain-user-info '{value}'. Must be one of: {', '.join(VALID_BODY_OBTAIN_USER_INFO)}")
    ...
    if 'user-info-exchange-server' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"user-info-exchange-server cannot exceed 35 characters")
    ...
    if 'antiphish' in payload:
        ...
        if value and value not in VALID_BODY_ANTIPHISH:
            return (False, f"Invalid antiphish '{value}'. Must be one of: {', '.join(VALID_BODY_ANTIPHISH)}")
