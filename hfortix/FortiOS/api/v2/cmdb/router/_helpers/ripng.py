        ...
        if value is not None:
            try:
                ...
                if int_val < 5 or int_val > 2147483647:
                    return (False, f"update-timer must be between 5 and 2147483647")
            except (ValueError, TypeError):
    ...
    if 'timeout-timer' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 5 or int_val > 2147483647:
                    return (False, f"timeout-timer must be between 5 and 2147483647")
            except (ValueError, TypeError):
    ...
    if 'garbage-timer' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 5 or int_val > 2147483647:
                    return (False, f"garbage-timer must be between 5 and 2147483647")
            except (ValueError, TypeError):
