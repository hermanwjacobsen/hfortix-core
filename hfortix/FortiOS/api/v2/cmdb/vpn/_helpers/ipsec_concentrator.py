...
def validate_ipsec_concentrator_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_ipsec_concentrator_delete(id: str | None = None) -> tuple[bool, str | None]:
    """
