...
VALID_BODY_AUTHENTICATION = ['null', 'md5', 'sha1', 'sha256', 'sha384', 'sha512']
VALID_BODY_ENCRYPTION = ['null', 'des', '3des', 'aes128', 'aes192', 'aes256', 'aria128', 'aria192', 'aria256', 'seed']
...
def validate_ipsec_manualkey_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_ipsec_manualkey_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
