...
VALID_BODY_SRC_ADDR_TYPE = ['subnet', 'range', 'ip', 'name', 'subnet6', 'range6', 'ip6', 'name6']
VALID_BODY_DST_ADDR_TYPE = ['subnet', 'range', 'ip', 'name', 'subnet6', 'range6', 'ip6', 'name6']
...
def validate_ipsec_phase2_interface_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'dhcp-ipsec' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_IPSEC:
            return (False, f"Invalid dhcp-ipsec '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_IPSEC)}")
    ...
    if 'pfs' in payload:
        ...
        if value and value not in VALID_BODY_PFS:
            return (False, f"Invalid pfs '{value}'. Must be one of: {', '.join(VALID_BODY_PFS)}")
    ...
    if 'replay' in payload:
        ...
        if value and value not in VALID_BODY_REPLAY:
            return (False, f"Invalid replay '{value}'. Must be one of: {', '.join(VALID_BODY_REPLAY)}")
    ...
    if 'keepalive' in payload:
        ...
        if value and value not in VALID_BODY_KEEPALIVE:
            return (False, f"Invalid keepalive '{value}'. Must be one of: {', '.join(VALID_BODY_KEEPALIVE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 120 or int_val > 172800:
                    return (False, f"keylifeseconds must be between 120 and 172800")
        ...
        if value is not None:
            try:
                ...
                if int_val < 5120 or int_val > 4294967295:
                    return (False, f"keylifekbs must be between 5120 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'keylife-type' in payload:
        ...
        if value and value not in VALID_BODY_KEYLIFE_TYPE:
            return (False, f"Invalid keylife-type '{value}'. Must be one of: {', '.join(VALID_BODY_KEYLIFE_TYPE)}")
    ...
    if 'single-source' in payload:
        ...
        if value and value not in VALID_BODY_SINGLE_SOURCE:
            return (False, f"Invalid single-source '{value}'. Must be one of: {', '.join(VALID_BODY_SINGLE_SOURCE)}")
    ...
    if 'route-overlap' in payload:
        ...
        if value and value not in VALID_BODY_ROUTE_OVERLAP:
            return (False, f"Invalid route-overlap '{value}'. Must be one of: {', '.join(VALID_BODY_ROUTE_OVERLAP)}")
    ...
    if 'l2tp' in payload:
        ...
        if value and value not in VALID_BODY_L2TP:
            return (False, f"Invalid l2tp '{value}'. Must be one of: {', '.join(VALID_BODY_L2TP)}")
    ...
    if 'initiator-ts-narrow' in payload:
        ...
        if value and value not in VALID_BODY_INITIATOR_TS_NARROW:
            return (False, f"Invalid initiator-ts-narrow '{value}'. Must be one of: {', '.join(VALID_BODY_INITIATOR_TS_NARROW)}")
    ...
    if 'diffserv' in payload:
        ...
        if value and value not in VALID_BODY_DIFFSERV:
            return (False, f"Invalid diffserv '{value}'. Must be one of: {', '.join(VALID_BODY_DIFFSERV)}")
    ...
    if 'src-addr-type' in payload:
        ...
        if value and value not in VALID_BODY_SRC_ADDR_TYPE:
            return (False, f"Invalid src-addr-type '{value}'. Must be one of: {', '.join(VALID_BODY_SRC_ADDR_TYPE)}")
    ...
    if 'dst-addr-type' in payload:
        ...
        if value and value not in VALID_BODY_DST_ADDR_TYPE:
            return (False, f"Invalid dst-addr-type '{value}'. Must be one of: {', '.join(VALID_BODY_DST_ADDR_TYPE)}")
...
def validate_ipsec_phase2_interface_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
