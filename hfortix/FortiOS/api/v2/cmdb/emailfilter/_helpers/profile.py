...
VALID_BODY_OPTIONS = ['bannedword', 'spambal', 'spamfsip', 'spamfssubmit', 'spamfschksum', 'spamfsurl', 'spamhelodns', 'spamraddrdns', 'spamrbl', 'spamhdrcheck', 'spamfsphish']
...
def validate_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'spam-log' in payload:
        ...
        if value and value not in VALID_BODY_SPAM_LOG:
            return (False, f"Invalid spam-log '{value}'. Must be one of: {', '.join(VALID_BODY_SPAM_LOG)}")
    ...
    if 'spam-log-fortiguard-response' in payload:
        ...
        if value and value not in VALID_BODY_SPAM_LOG_FORTIGUARD_RESPONSE:
            return (False, f"Invalid spam-log-fortiguard-response '{value}'. Must be one of: {', '.join(VALID_BODY_SPAM_LOG_FORTIGUARD_RESPONSE)}")
    ...
    if 'spam-filtering' in payload:
        ...
        if value and value not in VALID_BODY_SPAM_FILTERING:
            return (False, f"Invalid spam-filtering '{value}'. Must be one of: {', '.join(VALID_BODY_SPAM_FILTERING)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 2147483647:
                    return (False, f"spam-bword-threshold must be between 0 and 2147483647")
            except (ValueError, TypeError):
                return (False, f"spam-bword-threshold must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"spam-bword-table must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"spam-bword-table must be numeric, got: {value}")
    ...
    if 'spam-bal-table' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"spam-bal-table must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'spam-mheader-table' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"spam-mheader-table must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"spam-mheader-table must be numeric, got: {value}")
    ...
    if 'spam-rbl-table' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"spam-rbl-table must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'spam-iptrust-table' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"spam-iptrust-table must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"spam-iptrust-table must be numeric, got: {value}")
