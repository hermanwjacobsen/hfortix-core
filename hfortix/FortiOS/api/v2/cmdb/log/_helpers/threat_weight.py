...
VALID_BODY_BLOCKED_CONNECTION = ['disable', 'low', 'medium', 'high', 'critical']
VALID_BODY_FAILED_CONNECTION = ['disable', 'low', 'medium', 'high', 'critical']
VALID_BODY_URL_BLOCK_DETECTED = ['disable', 'low', 'medium', 'high', 'critical']
VALID_BODY_BOTNET_CONNECTION_DETECTED = ['disable', 'low', 'medium', 'high', 'critical']
...
def validate_threat_weight_put(
    ...
    if 'blocked-connection' in payload:
        ...
        if value and value not in VALID_BODY_BLOCKED_CONNECTION:
            return (False, f"Invalid blocked-connection '{value}'. Must be one of: {', '.join(VALID_BODY_BLOCKED_CONNECTION)}")
    ...
    if 'failed-connection' in payload:
        ...
        if value and value not in VALID_BODY_FAILED_CONNECTION:
            return (False, f"Invalid failed-connection '{value}'. Must be one of: {', '.join(VALID_BODY_FAILED_CONNECTION)}")
    ...
    if 'url-block-detected' in payload:
        ...
        if value and value not in VALID_BODY_URL_BLOCK_DETECTED:
            return (False, f"Invalid url-block-detected '{value}'. Must be one of: {', '.join(VALID_BODY_URL_BLOCK_DETECTED)}")
    ...
    if 'botnet-connection-detected' in payload:
        ...
        if value and value not in VALID_BODY_BOTNET_CONNECTION_DETECTED:
            return (False, f"Invalid botnet-connection-detected '{value}'. Must be one of: {', '.join(VALID_BODY_BOTNET_CONNECTION_DETECTED)}")
