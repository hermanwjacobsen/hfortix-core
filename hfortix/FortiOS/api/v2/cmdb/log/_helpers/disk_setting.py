...
VALID_BODY_ROLL_DAY = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday']
VALID_BODY_DISKFULL = ['overwrite', 'nolog']
VALID_BODY_UPLOAD = ['enable', 'disable']
VALID_BODY_UPLOAD_DESTINATION = ['ftp-server']
VALID_BODY_UPLOADTYPE = ['traffic', 'event', 'virus', 'webfilter', 'IPS', 'emailfilter', 'dlp-archive', 'anomaly', 'voip', 'dlp', 'app-ctrl', 'waf', 'dns', 'ssh', 'ssl', 'file-filter', 'icap', 'virtual-patch', 'debug']
...
def validate_disk_setting_put(
    ...
    if 'ips-archive' in payload:
        ...
        if value and value not in VALID_BODY_IPS_ARCHIVE:
            return (False, f"Invalid ips-archive '{value}'. Must be one of: {', '.join(VALID_BODY_IPS_ARCHIVE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 100:
                    return (False, f"max-log-file-size must be between 1 and 100")
            except (ValueError, TypeError):
                return (False, f"max-log-file-size must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"max-policy-packet-capture-size must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"max-policy-packet-capture-size must be numeric, got: {value}")
    ...
    if 'roll-schedule' in payload:
        ...
        if value and value not in VALID_BODY_ROLL_SCHEDULE:
            return (False, f"Invalid roll-schedule '{value}'. Must be one of: {', '.join(VALID_BODY_ROLL_SCHEDULE)}")
    ...
    if 'roll-day' in payload:
        ...
        if value and value not in VALID_BODY_ROLL_DAY:
            return (False, f"Invalid roll-day '{value}'. Must be one of: {', '.join(VALID_BODY_ROLL_DAY)}")
    ...
    if 'diskfull' in payload:
        ...
        if value and value not in VALID_BODY_DISKFULL:
            return (False, f"Invalid diskfull '{value}'. Must be one of: {', '.join(VALID_BODY_DISKFULL)}")
    ...
    if 'log-quota' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"log-quota must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'dlp-archive-quota' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"dlp-archive-quota must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"dlp-archive-quota must be numeric, got: {value}")
    ...
    if 'report-quota' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"report-quota must be between 0 and 4294967295")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 3650:
                    return (False, f"maximum-log-age must be between 0 and 3650")
            except (ValueError, TypeError):
                return (False, f"maximum-log-age must be numeric, got: {value}")
    
    # Validate upload if present
    if 'upload' in payload:
        value = payload.get('upload')
        if value and value not in VALID_BODY_UPLOAD:
            return (False, f"Invalid upload '{value}'. Must be one of: {', '.join(VALID_BODY_UPLOAD)}")
    ...
    if 'upload-destination' in payload:
        ...
        if value and value not in VALID_BODY_UPLOAD_DESTINATION:
            return (False, f"Invalid upload-destination '{value}'. Must be one of: {', '.join(VALID_BODY_UPLOAD_DESTINATION)}")
    ...
    if 'uploadtype' in payload:
        ...
        if value and value not in VALID_BODY_UPLOADTYPE:
            return (False, f"Invalid uploadtype '{value}'. Must be one of: {', '.join(VALID_BODY_UPLOADTYPE)}")
    ...
    if 'uploadsched' in payload:
        ...
        if value and value not in VALID_BODY_UPLOADSCHED:
            return (False, f"Invalid uploadsched '{value}'. Must be one of: {', '.join(VALID_BODY_UPLOADSCHED)}")
    ...
    if 'upload-delete-files' in payload:
        ...
        if value and value not in VALID_BODY_UPLOAD_DELETE_FILES:
            return (False, f"Invalid upload-delete-files '{value}'. Must be one of: {', '.join(VALID_BODY_UPLOAD_DELETE_FILES)}")
    ...
    if 'upload-ssl-conn' in payload:
        ...
        if value and value not in VALID_BODY_UPLOAD_SSL_CONN:
            return (False, f"Invalid upload-ssl-conn '{value}'. Must be one of: {', '.join(VALID_BODY_UPLOAD_SSL_CONN)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 98:
                    return (False, f"full-first-warning-threshold must be between 1 and 98")
            except (ValueError, TypeError):
                return (False, f"full-first-warning-threshold must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 2 or int_val > 99:
                    return (False, f"full-second-warning-threshold must be between 2 and 99")
            except (ValueError, TypeError):
                return (False, f"full-second-warning-threshold must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 3 or int_val > 100:
                    return (False, f"full-final-warning-threshold must be between 3 and 100")
            except (ValueError, TypeError):
                return (False, f"full-final-warning-threshold must be numeric, got: {value}")
