...
def validate_wildcard_fqdn_group_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_wildcard_fqdn_group_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
