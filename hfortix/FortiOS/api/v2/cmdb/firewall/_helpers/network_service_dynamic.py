...
def validate_network_service_dynamic_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_network_service_dynamic_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
