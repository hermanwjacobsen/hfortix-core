...
def validate_access_proxy_virtual_host_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_access_proxy_virtual_host_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
