...
def validate_sniffer_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'non-ip' in payload:
        ...
        if value and value not in VALID_BODY_NON_IP:
            return (False, f"Invalid non-ip '{value}'. Must be one of: {', '.join(VALID_BODY_NON_IP)}")
    ...
    if 'application-list-status' in payload:
        ...
        if value and value not in VALID_BODY_APPLICATION_LIST_STATUS:
            return (False, f"Invalid application-list-status '{value}'. Must be one of: {', '.join(VALID_BODY_APPLICATION_LIST_STATUS)}")
    ...
    if 'ips-sensor-status' in payload:
        ...
        if value and value not in VALID_BODY_IPS_SENSOR_STATUS:
            return (False, f"Invalid ips-sensor-status '{value}'. Must be one of: {', '.join(VALID_BODY_IPS_SENSOR_STATUS)}")
    ...
    if 'av-profile-status' in payload:
        ...
        if value and value not in VALID_BODY_AV_PROFILE_STATUS:
            return (False, f"Invalid av-profile-status '{value}'. Must be one of: {', '.join(VALID_BODY_AV_PROFILE_STATUS)}")
    ...
    if 'webfilter-profile-status' in payload:
        ...
        if value and value not in VALID_BODY_WEBFILTER_PROFILE_STATUS:
            return (False, f"Invalid webfilter-profile-status '{value}'. Must be one of: {', '.join(VALID_BODY_WEBFILTER_PROFILE_STATUS)}")
    ...
    if 'emailfilter-profile-status' in payload:
        ...
        if value and value not in VALID_BODY_EMAILFILTER_PROFILE_STATUS:
            return (False, f"Invalid emailfilter-profile-status '{value}'. Must be one of: {', '.join(VALID_BODY_EMAILFILTER_PROFILE_STATUS)}")
    ...
    if 'dlp-profile-status' in payload:
        ...
        if value and value not in VALID_BODY_DLP_PROFILE_STATUS:
            return (False, f"Invalid dlp-profile-status '{value}'. Must be one of: {', '.join(VALID_BODY_DLP_PROFILE_STATUS)}")
    ...
    if 'ip-threatfeed-status' in payload:
        ...
        if value and value not in VALID_BODY_IP_THREATFEED_STATUS:
            return (False, f"Invalid ip-threatfeed-status '{value}'. Must be one of: {', '.join(VALID_BODY_IP_THREATFEED_STATUS)}")
    ...
    if 'file-filter-profile-status' in payload:
        ...
        if value and value not in VALID_BODY_FILE_FILTER_PROFILE_STATUS:
            return (False, f"Invalid file-filter-profile-status '{value}'. Must be one of: {', '.join(VALID_BODY_FILE_FILTER_PROFILE_STATUS)}")
    ...
    if 'ips-dos-status' in payload:
        ...
        if value and value not in VALID_BODY_IPS_DOS_STATUS:
            return (False, f"Invalid ips-dos-status '{value}'. Must be one of: {', '.join(VALID_BODY_IPS_DOS_STATUS)}")
