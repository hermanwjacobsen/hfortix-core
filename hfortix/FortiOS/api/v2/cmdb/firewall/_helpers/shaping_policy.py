...
def validate_shaping_policy_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'traffic-type' in payload:
        ...
        if value and value not in VALID_BODY_TRAFFIC_TYPE:
            return (False, f"Invalid traffic-type '{value}'. Must be one of: {', '.join(VALID_BODY_TRAFFIC_TYPE)}")
...
def validate_shaping_policy_delete(id: str | None = None) -> tuple[bool, str | None]:
    """
