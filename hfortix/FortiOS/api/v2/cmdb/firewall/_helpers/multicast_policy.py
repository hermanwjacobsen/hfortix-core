...
def validate_multicast_policy_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'snat' in payload:
        ...
        if value and value not in VALID_BODY_SNAT:
            return (False, f"Invalid snat '{value}'. Must be one of: {', '.join(VALID_BODY_SNAT)}")
...
def validate_multicast_policy_delete(id: str | None = None) -> tuple[bool, str | None]:
    """
