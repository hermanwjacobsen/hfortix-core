...
def validate_address6_template_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 6:
                    return (False, f"subnet-segment-count must be between 1 and 6")
            except (ValueError, TypeError):
                return (False, f"subnet-segment-count must be numeric, got: {value}")
...
def validate_address6_template_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
