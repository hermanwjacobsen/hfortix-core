...
def validate_vip6_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'ndp-reply' in payload:
        ...
        if value and value not in VALID_BODY_NDP_REPLY:
            return (False, f"Invalid ndp-reply '{value}'. Must be one of: {', '.join(VALID_BODY_NDP_REPLY)}")
    ...
    if 'nat66' in payload:
        ...
        if value and value not in VALID_BODY_NAT66:
            return (False, f"Invalid nat66 '{value}'. Must be one of: {', '.join(VALID_BODY_NAT66)}")
    ...
    if 'add-nat64-route' in payload:
        ...
        if value and value not in VALID_BODY_ADD_NAT64_ROUTE:
            return (False, f"Invalid add-nat64-route '{value}'. Must be one of: {', '.join(VALID_BODY_ADD_NAT64_ROUTE)}")
    ...
    if 'embedded-ipv4-address' in payload:
        ...
        if value and value not in VALID_BODY_EMBEDDED_IPV4_ADDRESS:
            return (False, f"Invalid embedded-ipv4-address '{value}'. Must be one of: {', '.join(VALID_BODY_EMBEDDED_IPV4_ADDRESS)}")
