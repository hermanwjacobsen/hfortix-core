...
def validate_central_snat_map_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_central_snat_map_delete(policyid: str | None = None) -> tuple[bool, str | None]:
    """
