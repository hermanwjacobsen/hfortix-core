...
def validate_local_in_policy6_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_local_in_policy6_delete(policyid: str | None = None) -> tuple[bool, str | None]:
    """
