...
def validate_wildcard_fqdn_custom_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_wildcard_fqdn_custom_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
