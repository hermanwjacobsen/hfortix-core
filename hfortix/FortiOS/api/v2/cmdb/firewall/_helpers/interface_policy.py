...
def validate_interface_policy_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_interface_policy_delete(policyid: str | None = None) -> tuple[bool, str | None]:
    """
