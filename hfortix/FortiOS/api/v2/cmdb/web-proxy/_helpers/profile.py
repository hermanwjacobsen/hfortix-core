...
def validate_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'header-client-ip' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_CLIENT_IP:
            return (False, f"Invalid header-client-ip '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_CLIENT_IP)}")
    ...
    if 'header-via-request' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_VIA_REQUEST:
            return (False, f"Invalid header-via-request '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_VIA_REQUEST)}")
    ...
    if 'header-via-response' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_VIA_RESPONSE:
            return (False, f"Invalid header-via-response '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_VIA_RESPONSE)}")
    ...
    if 'header-client-cert' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_CLIENT_CERT:
            return (False, f"Invalid header-client-cert '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_CLIENT_CERT)}")
    ...
    if 'header-x-forwarded-for' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_X_FORWARDED_FOR:
            return (False, f"Invalid header-x-forwarded-for '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_X_FORWARDED_FOR)}")
    ...
    if 'header-x-forwarded-client-cert' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_X_FORWARDED_CLIENT_CERT:
            return (False, f"Invalid header-x-forwarded-client-cert '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_X_FORWARDED_CLIENT_CERT)}")
    ...
    if 'header-front-end-https' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_FRONT_END_HTTPS:
            return (False, f"Invalid header-front-end-https '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_FRONT_END_HTTPS)}")
    ...
    if 'header-x-authenticated-user' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_X_AUTHENTICATED_USER:
            return (False, f"Invalid header-x-authenticated-user '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_X_AUTHENTICATED_USER)}")
    ...
    if 'header-x-authenticated-groups' in payload:
        ...
        if value and value not in VALID_BODY_HEADER_X_AUTHENTICATED_GROUPS:
            return (False, f"Invalid header-x-authenticated-groups '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER_X_AUTHENTICATED_GROUPS)}")
    ...
    if 'strip-encoding' in payload:
        ...
        if value and value not in VALID_BODY_STRIP_ENCODING:
            return (False, f"Invalid strip-encoding '{value}'. Must be one of: {', '.join(VALID_BODY_STRIP_ENCODING)}")
    ...
    if 'log-header-change' in payload:
        ...
        if value and value not in VALID_BODY_LOG_HEADER_CHANGE:
            return (False, f"Invalid log-header-change '{value}'. Must be one of: {', '.join(VALID_BODY_LOG_HEADER_CHANGE)}")
