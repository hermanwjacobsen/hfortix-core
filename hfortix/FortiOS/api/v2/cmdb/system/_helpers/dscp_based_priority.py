...
def validate_dscp_based_priority_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_dscp_based_priority_delete(id: str | None = None) -> tuple[bool, str | None]:
    """
