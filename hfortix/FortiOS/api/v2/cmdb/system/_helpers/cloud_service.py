...
def validate_cloud_service_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 3600:
                    return (False, f"gck-access-token-lifetime must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"gck-access-token-lifetime must be numeric, got: {value}")
...
def validate_cloud_service_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
