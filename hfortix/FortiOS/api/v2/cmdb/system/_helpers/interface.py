...
VALID_BODY_ALLOWACCESS = ['ping', 'https', 'ssh', 'snmp', 'http', 'telnet', 'fgfm', 'radius-acct', 'probe-response', 'fabric', 'ftm', 'speed-test', 'scim']
...
VALID_BODY_PPPOE_EGRESS_COS = ['cos0', 'cos1', 'cos2', 'cos3', 'cos4', 'cos5', 'cos6', 'cos7']
...
VALID_BODY_STPFORWARD_MODE = ['rpl-all-ext-id', 'rpl-bridge-ext-id', 'rpl-nothing']
...
VALID_BODY_SPEED = ['auto', '10full', '10half', '100full', '100half', '100auto', '1000full', '1000auto']
VALID_BODY_STATUS = ['up', 'down']
VALID_BODY_NETBIOS_FORWARD = ['disable', 'enable']
VALID_BODY_TYPE = ['physical', 'vlan', 'aggregate', 'redundant', 'tunnel', 'vdom-link', 'loopback', 'switch', 'hard-switch', 'vap-switch', 'wl-mesh', 'fext-wan', 'vxlan', 'geneve', 'switch-vlan', 'emac-vlan', 'lan-extension']
...
VALID_BODY_SECURITY_8021X_MODE = ['default', 'dynamic-vlan', 'fallback', 'slave']
...
VALID_BODY_MANAGED_SUBNETWORK_SIZE = ['4', '8', '16', '32', '64', '128', '256', '512', '1024', '2048', '4096', '8192', '16384', '32768', '65536', '131072', '262144', '524288', '1048576', '2097152', '4194304', '8388608', '16777216']
...
VALID_BODY_SWITCH_CONTROLLER_FEATURE = ['none', 'default-vlan', 'quarantine', 'rspan', 'voice', 'video', 'nac', 'nac-segment']
...
VALID_BODY_DEFAULT_PURDUE_LEVEL = ['1', '1.5', '2', '2.5', '3', '3.5', '4', '5', '5.5']
...
def validate_interface_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"cli-conn-status must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"cli-conn-status must be numeric, got: {value}")
    ...
    if 'fortilink' in payload:
        ...
        if value and value not in VALID_BODY_FORTILINK:
            return (False, f"Invalid fortilink '{value}'. Must be one of: {', '.join(VALID_BODY_FORTILINK)}")
    ...
    if 'switch-controller-source-ip' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_SOURCE_IP:
            return (False, f"Invalid switch-controller-source-ip '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_SOURCE_IP)}")
    
    # Validate mode if present
    if 'mode' in payload:
        value = payload.get('mode')
        if value and value not in VALID_BODY_MODE:
            return (False, f"Invalid mode '{value}'. Must be one of: {', '.join(VALID_BODY_MODE)}")
    ...
    if 'dhcp-relay-interface-select-method' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_RELAY_INTERFACE_SELECT_METHOD:
            return (False, f"Invalid dhcp-relay-interface-select-method '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_RELAY_INTERFACE_SELECT_METHOD)}")
    ...
    if 'dhcp-relay-vrf-select' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 511:
                    return (False, f"dhcp-relay-vrf-select must be between 0 and 511")
            except (ValueError, TypeError):
                return (False, f"dhcp-relay-vrf-select must be numeric, got: {value}")
    ...
    if 'dhcp-broadcast-flag' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_BROADCAST_FLAG:
            return (False, f"Invalid dhcp-broadcast-flag '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_BROADCAST_FLAG)}")
    ...
    if 'dhcp-relay-service' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_RELAY_SERVICE:
            return (False, f"Invalid dhcp-relay-service '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_RELAY_SERVICE)}")
    ...
    if 'dhcp-relay-circuit-id' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 64:
            return (False, f"dhcp-relay-circuit-id cannot exceed 64 characters")
    ...
    if 'dhcp-relay-request-all-server' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_RELAY_REQUEST_ALL_SERVER:
            return (False, f"Invalid dhcp-relay-request-all-server '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_RELAY_REQUEST_ALL_SERVER)}")
    ...
    if 'dhcp-relay-allow-no-end-option' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_RELAY_ALLOW_NO_END_OPTION:
            return (False, f"Invalid dhcp-relay-allow-no-end-option '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_RELAY_ALLOW_NO_END_OPTION)}")
    ...
    if 'dhcp-relay-type' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_RELAY_TYPE:
            return (False, f"Invalid dhcp-relay-type '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_RELAY_TYPE)}")
    ...
    if 'dhcp-smart-relay' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_SMART_RELAY:
            return (False, f"Invalid dhcp-smart-relay '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_SMART_RELAY)}")
    ...
    if 'dhcp-relay-agent-option' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_RELAY_AGENT_OPTION:
            return (False, f"Invalid dhcp-relay-agent-option '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_RELAY_AGENT_OPTION)}")
    ...
    if 'dhcp-classless-route-addition' in payload:
        ...
        if value and value not in VALID_BODY_DHCP_CLASSLESS_ROUTE_ADDITION:
            return (False, f"Invalid dhcp-classless-route-addition '{value}'. Must be one of: {', '.join(VALID_BODY_DHCP_CLASSLESS_ROUTE_ADDITION)}")
    ...
    if 'allowaccess' in payload:
        ...
        if value and value not in VALID_BODY_ALLOWACCESS:
            return (False, f"Invalid allowaccess '{value}'. Must be one of: {', '.join(VALID_BODY_ALLOWACCESS)}")
    ...
    if 'gwdetect' in payload:
        ...
        if value and value not in VALID_BODY_GWDETECT:
            return (False, f"Invalid gwdetect '{value}'. Must be one of: {', '.join(VALID_BODY_GWDETECT)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 255:
                    return (False, f"ping-serv-status must be between 0 and 255")
            except (ValueError, TypeError):
                return (False, f"ping-serv-status must be numeric, got: {value}")
    ...
    if 'detectprotocol' in payload:
        ...
        if value and value not in VALID_BODY_DETECTPROTOCOL:
            return (False, f"Invalid detectprotocol '{value}'. Must be one of: {', '.join(VALID_BODY_DETECTPROTOCOL)}")
    ...
    if 'fail-detect' in payload:
        ...
        if value and value not in VALID_BODY_FAIL_DETECT:
            return (False, f"Invalid fail-detect '{value}'. Must be one of: {', '.join(VALID_BODY_FAIL_DETECT)}")
    ...
    if 'fail-detect-option' in payload:
        ...
        if value and value not in VALID_BODY_FAIL_DETECT_OPTION:
            return (False, f"Invalid fail-detect-option '{value}'. Must be one of: {', '.join(VALID_BODY_FAIL_DETECT_OPTION)}")
    ...
    if 'fail-alert-method' in payload:
        ...
        if value and value not in VALID_BODY_FAIL_ALERT_METHOD:
            return (False, f"Invalid fail-alert-method '{value}'. Must be one of: {', '.join(VALID_BODY_FAIL_ALERT_METHOD)}")
    ...
    if 'fail-action-on-extender' in payload:
        ...
        if value and value not in VALID_BODY_FAIL_ACTION_ON_EXTENDER:
            return (False, f"Invalid fail-action-on-extender '{value}'. Must be one of: {', '.join(VALID_BODY_FAIL_ACTION_ON_EXTENDER)}")
    ...
    if 'dhcp-client-identifier' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 48:
            return (False, f"dhcp-client-identifier cannot exceed 48 characters")
        ...
        if value is not None:
            try:
                ...
                if int_val < 300 or int_val > 604800:
                    return (False, f"dhcp-renew-time must be between 300 and 604800")
            except (ValueError, TypeError):
                return (False, f"dhcp-renew-time must be numeric, got: {value}")
    ...
    if 'pppoe-egress-cos' in payload:
        ...
        if value and value not in VALID_BODY_PPPOE_EGRESS_COS:
            return (False, f"Invalid pppoe-egress-cos '{value}'. Must be one of: {', '.join(VALID_BODY_PPPOE_EGRESS_COS)}")
    ...
    if 'pppoe-unnumbered-negotiate' in payload:
        ...
        if value and value not in VALID_BODY_PPPOE_UNNUMBERED_NEGOTIATE:
            return (False, f"Invalid pppoe-unnumbered-negotiate '{value}'. Must be one of: {', '.join(VALID_BODY_PPPOE_UNNUMBERED_NEGOTIATE)}")
    ...
    if 'multilink' in payload:
        ...
        if value and value not in VALID_BODY_MULTILINK:
            return (False, f"Invalid multilink '{value}'. Must be one of: {', '.join(VALID_BODY_MULTILINK)}")
    ...
    if 'detected-peer-mtu' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"detected-peer-mtu must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"detected-peer-mtu must be numeric, got: {value}")
    ...
    if 'disc-retry-timeout' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"disc-retry-timeout must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"disc-retry-timeout must be numeric, got: {value}")
    ...
    if 'padt-retry-timeout' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"padt-retry-timeout must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"padt-retry-timeout must be numeric, got: {value}")
    ...
    if 'lcp-echo-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 32767:
                    return (False, f"lcp-echo-interval must be between 0 and 32767")
            except (ValueError, TypeError):
                return (False, f"lcp-echo-interval must be numeric, got: {value}")
    ...
    if 'lcp-max-echo-fails' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 32767:
                    return (False, f"lcp-max-echo-fails must be between 0 and 32767")
            except (ValueError, TypeError):
                return (False, f"lcp-max-echo-fails must be numeric, got: {value}")
    ...
    if 'defaultgw' in payload:
        ...
        if value and value not in VALID_BODY_DEFAULTGW:
            return (False, f"Invalid defaultgw '{value}'. Must be one of: {', '.join(VALID_BODY_DEFAULTGW)}")
    ...
    if 'dns-server-override' in payload:
        ...
        if value and value not in VALID_BODY_DNS_SERVER_OVERRIDE:
            return (False, f"Invalid dns-server-override '{value}'. Must be one of: {', '.join(VALID_BODY_DNS_SERVER_OVERRIDE)}")
    ...
    if 'dns-server-protocol' in payload:
        ...
        if value and value not in VALID_BODY_DNS_SERVER_PROTOCOL:
            return (False, f"Invalid dns-server-protocol '{value}'. Must be one of: {', '.join(VALID_BODY_DNS_SERVER_PROTOCOL)}")
    ...
    if 'auth-type' in payload:
        ...
        if value and value not in VALID_BODY_AUTH_TYPE:
            return (False, f"Invalid auth-type '{value}'. Must be one of: {', '.join(VALID_BODY_AUTH_TYPE)}")
    ...
    if 'pptp-client' in payload:
        ...
        if value and value not in VALID_BODY_PPTP_CLIENT:
            return (False, f"Invalid pptp-client '{value}'. Must be one of: {', '.join(VALID_BODY_PPTP_CLIENT)}")
    ...
    if 'pptp-auth-type' in payload:
        ...
        if value and value not in VALID_BODY_PPTP_AUTH_TYPE:
            return (False, f"Invalid pptp-auth-type '{value}'. Must be one of: {', '.join(VALID_BODY_PPTP_AUTH_TYPE)}")
    ...
    if 'arpforward' in payload:
        ...
        if value and value not in VALID_BODY_ARPFORWARD:
            return (False, f"Invalid arpforward '{value}'. Must be one of: {', '.join(VALID_BODY_ARPFORWARD)}")
    ...
    if 'ndiscforward' in payload:
        ...
        if value and value not in VALID_BODY_NDISCFORWARD:
            return (False, f"Invalid ndiscforward '{value}'. Must be one of: {', '.join(VALID_BODY_NDISCFORWARD)}")
    ...
    if 'broadcast-forward' in payload:
        ...
        if value and value not in VALID_BODY_BROADCAST_FORWARD:
            return (False, f"Invalid broadcast-forward '{value}'. Must be one of: {', '.join(VALID_BODY_BROADCAST_FORWARD)}")
    
    # Validate bfd if present
    if 'bfd' in payload:
        value = payload.get('bfd')
        if value and value not in VALID_BODY_BFD:
            return (False, f"Invalid bfd '{value}'. Must be one of: {', '.join(VALID_BODY_BFD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 100000:
                    return (False, f"bfd-desired-min-tx must be between 1 and 100000")
            except (ValueError, TypeError):
                return (False, f"bfd-desired-min-tx must be numeric, got: {value}")
    ...
    if 'bfd-detect-mult' in payload:
        ...
        if value is not None:
            try:
                ...
                return (False, f"bfd-detect-mult must be numeric, got: {value}")
    ...
    if 'bfd-required-min-rx' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 100000:
                    return (False, f"bfd-required-min-rx must be between 1 and 100000")
            except (ValueError, TypeError):
                return (False, f"bfd-required-min-rx must be numeric, got: {value}")
    ...
    if 'l2forward' in payload:
        ...
        if value and value not in VALID_BODY_L2FORWARD:
            return (False, f"Invalid l2forward '{value}'. Must be one of: {', '.join(VALID_BODY_L2FORWARD)}")
    ...
    if 'icmp-send-redirect' in payload:
        ...
        if value and value not in VALID_BODY_ICMP_SEND_REDIRECT:
            return (False, f"Invalid icmp-send-redirect '{value}'. Must be one of: {', '.join(VALID_BODY_ICMP_SEND_REDIRECT)}")
    ...
    if 'icmp-accept-redirect' in payload:
        ...
        if value and value not in VALID_BODY_ICMP_ACCEPT_REDIRECT:
            return (False, f"Invalid icmp-accept-redirect '{value}'. Must be one of: {', '.join(VALID_BODY_ICMP_ACCEPT_REDIRECT)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 30000 or int_val > 3600000:
                    return (False, f"reachable-time must be between 30000 and 3600000")
            except (ValueError, TypeError):
    ...
    if 'vlanforward' in payload:
        ...
        if value and value not in VALID_BODY_VLANFORWARD:
            return (False, f"Invalid vlanforward '{value}'. Must be one of: {', '.join(VALID_BODY_VLANFORWARD)}")
    ...
    if 'stpforward' in payload:
        ...
        if value and value not in VALID_BODY_STPFORWARD:
            return (False, f"Invalid stpforward '{value}'. Must be one of: {', '.join(VALID_BODY_STPFORWARD)}")
    ...
    if 'stpforward-mode' in payload:
        ...
        if value and value not in VALID_BODY_STPFORWARD_MODE:
            return (False, f"Invalid stpforward-mode '{value}'. Must be one of: {', '.join(VALID_BODY_STPFORWARD_MODE)}")
    ...
    if 'ips-sniffer-mode' in payload:
        ...
        if value and value not in VALID_BODY_IPS_SNIFFER_MODE:
            return (False, f"Invalid ips-sniffer-mode '{value}'. Must be one of: {', '.join(VALID_BODY_IPS_SNIFFER_MODE)}")
    ...
    if 'ident-accept' in payload:
        ...
        if value and value not in VALID_BODY_IDENT_ACCEPT:
            return (False, f"Invalid ident-accept '{value}'. Must be one of: {', '.join(VALID_BODY_IDENT_ACCEPT)}")
    
    # Validate ipmac if present
    if 'ipmac' in payload:
        value = payload.get('ipmac')
        if value and value not in VALID_BODY_IPMAC:
            return (False, f"Invalid ipmac '{value}'. Must be one of: {', '.join(VALID_BODY_IPMAC)}")
    
    # Validate subst if present
    if 'subst' in payload:
        value = payload.get('subst')
        if value and value not in VALID_BODY_SUBST:
            return (False, f"Invalid subst '{value}'. Must be one of: {', '.join(VALID_BODY_SUBST)}")
    
    # Validate speed if present
    if 'speed' in payload:
        value = payload.get('speed')
        if value and value not in VALID_BODY_SPEED:
            return (False, f"Invalid speed '{value}'. Must be one of: {', '.join(VALID_BODY_SPEED)}")
    ...
    if 'netbios-forward' in payload:
        ...
        if value and value not in VALID_BODY_NETBIOS_FORWARD:
            return (False, f"Invalid netbios-forward '{value}'. Must be one of: {', '.join(VALID_BODY_NETBIOS_FORWARD)}")
    ...
    if 'dedicated-to' in payload:
        ...
        if value and value not in VALID_BODY_DEDICATED_TO:
            return (False, f"Invalid dedicated-to '{value}'. Must be one of: {', '.join(VALID_BODY_DEDICATED_TO)}")
    
    # Validate wccp if present
    if 'wccp' in payload:
        value = payload.get('wccp')
        if value and value not in VALID_BODY_WCCP:
            return (False, f"Invalid wccp '{value}'. Must be one of: {', '.join(VALID_BODY_WCCP)}")
    ...
    if 'netflow-sampler' in payload:
        ...
        if value and value not in VALID_BODY_NETFLOW_SAMPLER:
            return (False, f"Invalid netflow-sampler '{value}'. Must be one of: {', '.join(VALID_BODY_NETFLOW_SAMPLER)}")
    ...
    if 'netflow-sample-rate' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"netflow-sample-rate must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"netflow-sample-rate must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 254:
                    return (False, f"netflow-sampler-id must be between 1 and 254")
            except (ValueError, TypeError):
                return (False, f"netflow-sampler-id must be numeric, got: {value}")
    ...
    if 'sflow-sampler' in payload:
        ...
        if value and value not in VALID_BODY_SFLOW_SAMPLER:
            return (False, f"Invalid sflow-sampler '{value}'. Must be one of: {', '.join(VALID_BODY_SFLOW_SAMPLER)}")
    ...
    if 'drop-fragment' in payload:
        ...
        if value and value not in VALID_BODY_DROP_FRAGMENT:
            return (False, f"Invalid drop-fragment '{value}'. Must be one of: {', '.join(VALID_BODY_DROP_FRAGMENT)}")
    ...
    if 'src-check' in payload:
        ...
        if value and value not in VALID_BODY_SRC_CHECK:
            return (False, f"Invalid src-check '{value}'. Must be one of: {', '.join(VALID_BODY_SRC_CHECK)}")
    ...
    if 'polling-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 255:
                    return (False, f"polling-interval must be between 1 and 255")
            except (ValueError, TypeError):
                return (False, f"polling-interval must be numeric, got: {value}")
    ...
    if 'sample-direction' in payload:
        ...
        if value and value not in VALID_BODY_SAMPLE_DIRECTION:
            return (False, f"Invalid sample-direction '{value}'. Must be one of: {', '.join(VALID_BODY_SAMPLE_DIRECTION)}")
    ...
    if 'explicit-web-proxy' in payload:
        ...
        if value and value not in VALID_BODY_EXPLICIT_WEB_PROXY:
            return (False, f"Invalid explicit-web-proxy '{value}'. Must be one of: {', '.join(VALID_BODY_EXPLICIT_WEB_PROXY)}")
    ...
    if 'explicit-ftp-proxy' in payload:
        ...
        if value and value not in VALID_BODY_EXPLICIT_FTP_PROXY:
            return (False, f"Invalid explicit-ftp-proxy '{value}'. Must be one of: {', '.join(VALID_BODY_EXPLICIT_FTP_PROXY)}")
    ...
    if 'proxy-captive-portal' in payload:
        ...
        if value and value not in VALID_BODY_PROXY_CAPTIVE_PORTAL:
            return (False, f"Invalid proxy-captive-portal '{value}'. Must be one of: {', '.join(VALID_BODY_PROXY_CAPTIVE_PORTAL)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 80000000:
                    return (False, f"inbandwidth must be between 0 and 80000000")
            except (ValueError, TypeError):
    ...
    if 'outbandwidth' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 80000000:
                    return (False, f"outbandwidth must be between 0 and 80000000")
            except (ValueError, TypeError):
    ...
    if 'egress-shaping-profile' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"egress-shaping-profile cannot exceed 35 characters")
    ...
    if 'ingress-shaping-profile' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"ingress-shaping-profile cannot exceed 35 characters")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 16776000:
                    return (False, f"spillover-threshold must be between 0 and 16776000")
            except (ValueError, TypeError):
                return (False, f"spillover-threshold must be numeric, got: {value}")
    ...
    if 'ingress-spillover-threshold' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 16776000:
                    return (False, f"ingress-spillover-threshold must be between 0 and 16776000")
            except (ValueError, TypeError):
                return (False, f"ingress-spillover-threshold must be numeric, got: {value}")
    ...
    if 'mtu-override' in payload:
        ...
        if value and value not in VALID_BODY_MTU_OVERRIDE:
            return (False, f"Invalid mtu-override '{value}'. Must be one of: {', '.join(VALID_BODY_MTU_OVERRIDE)}")
    ...
    if 'vlan-protocol' in payload:
        ...
        if value and value not in VALID_BODY_VLAN_PROTOCOL:
            return (False, f"Invalid vlan-protocol '{value}'. Must be one of: {', '.join(VALID_BODY_VLAN_PROTOCOL)}")
    ...
    if 'trunk' in payload:
        ...
        if value and value not in VALID_BODY_TRUNK:
            return (False, f"Invalid trunk '{value}'. Must be one of: {', '.join(VALID_BODY_TRUNK)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 2147483647:
                    return (False, f"forward-domain must be between 0 and 2147483647")
            except (ValueError, TypeError):
    ...
    if 'lacp-mode' in payload:
        ...
        if value and value not in VALID_BODY_LACP_MODE:
            return (False, f"Invalid lacp-mode '{value}'. Must be one of: {', '.join(VALID_BODY_LACP_MODE)}")
    ...
    if 'lacp-ha-secondary' in payload:
        ...
        if value and value not in VALID_BODY_LACP_HA_SECONDARY:
            return (False, f"Invalid lacp-ha-secondary '{value}'. Must be one of: {', '.join(VALID_BODY_LACP_HA_SECONDARY)}")
    ...
    if 'system-id-type' in payload:
        ...
        if value and value not in VALID_BODY_SYSTEM_ID_TYPE:
            return (False, f"Invalid system-id-type '{value}'. Must be one of: {', '.join(VALID_BODY_SYSTEM_ID_TYPE)}")
    ...
    if 'lacp-speed' in payload:
        ...
        if value and value not in VALID_BODY_LACP_SPEED:
            return (False, f"Invalid lacp-speed '{value}'. Must be one of: {', '.join(VALID_BODY_LACP_SPEED)}")
    ...
    if 'min-links-down' in payload:
        ...
        if value and value not in VALID_BODY_MIN_LINKS_DOWN:
            return (False, f"Invalid min-links-down '{value}'. Must be one of: {', '.join(VALID_BODY_MIN_LINKS_DOWN)}")
    ...
    if 'algorithm' in payload:
        ...
        if value and value not in VALID_BODY_ALGORITHM:
            return (False, f"Invalid algorithm '{value}'. Must be one of: {', '.join(VALID_BODY_ALGORITHM)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 50 or int_val > 3600000:
                    return (False, f"link-up-delay must be between 50 and 3600000")
            except (ValueError, TypeError):
    ...
    if 'aggregate-type' in payload:
        ...
        if value and value not in VALID_BODY_AGGREGATE_TYPE:
            return (False, f"Invalid aggregate-type '{value}'. Must be one of: {', '.join(VALID_BODY_AGGREGATE_TYPE)}")
    ...
    if 'priority-override' in payload:
        ...
        if value and value not in VALID_BODY_PRIORITY_OVERRIDE:
            return (False, f"Invalid priority-override '{value}'. Must be one of: {', '.join(VALID_BODY_PRIORITY_OVERRIDE)}")
    ...
    if 'devindex' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"devindex must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'l2tp-client' in payload:
        ...
        if value and value not in VALID_BODY_L2TP_CLIENT:
            return (False, f"Invalid l2tp-client '{value}'. Must be one of: {', '.join(VALID_BODY_L2TP_CLIENT)}")
    ...
    if 'security-mode' in payload:
        ...
        if value and value not in VALID_BODY_SECURITY_MODE:
            return (False, f"Invalid security-mode '{value}'. Must be one of: {', '.join(VALID_BODY_SECURITY_MODE)}")
    ...
    if 'security-mac-auth-bypass' in payload:
        ...
        if value and value not in VALID_BODY_SECURITY_MAC_AUTH_BYPASS:
            return (False, f"Invalid security-mac-auth-bypass '{value}'. Must be one of: {', '.join(VALID_BODY_SECURITY_MAC_AUTH_BYPASS)}")
    ...
    if 'security-ip-auth-bypass' in payload:
        ...
        if value and value not in VALID_BODY_SECURITY_IP_AUTH_BYPASS:
            return (False, f"Invalid security-ip-auth-bypass '{value}'. Must be one of: {', '.join(VALID_BODY_SECURITY_IP_AUTH_BYPASS)}")
    ...
    if 'security-8021x-mode' in payload:
        ...
        if value and value not in VALID_BODY_SECURITY_8021X_MODE:
            return (False, f"Invalid security-8021x-mode '{value}'. Must be one of: {', '.join(VALID_BODY_SECURITY_8021X_MODE)}")
    
    # Validate security-8021x-master if present
    if 'security-8021x-master' in payload:
        value = payload.get('security-8021x-master')
        if value and isinstance(value, str) and len(value) > 15:
            return (False, f"security-8021x-master cannot exceed 15 characters")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4094:
                    return (False, f"security-8021x-dynamic-vlan-id must be between 0 and 4094")
            except (ValueError, TypeError):
                return (False, f"security-8021x-dynamic-vlan-id must be numeric, got: {value}")
    ...
    if 'security-8021x-member-mode' in payload:
        ...
        if value and value not in VALID_BODY_SECURITY_8021X_MEMBER_MODE:
            return (False, f"Invalid security-8021x-member-mode '{value}'. Must be one of: {', '.join(VALID_BODY_SECURITY_8021X_MEMBER_MODE)}")
    ...
    if 'security-external-web' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 1023:
            return (False, f"security-external-web cannot exceed 1023 characters")
    ...
    if 'security-external-logout' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 127:
            return (False, f"security-external-logout cannot exceed 127 characters")
    ...
    if 'replacemsg-override-group' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"replacemsg-override-group cannot exceed 35 characters")
    
    # Validate security-redirect-url if present
    if 'security-redirect-url' in payload:
        value = payload.get('security-redirect-url')
        if value and isinstance(value, str) and len(value) > 1023:
            return (False, f"security-redirect-url cannot exceed 1023 characters")
    ...
    if 'stp' in payload:
        ...
        if value and value not in VALID_BODY_STP:
            return (False, f"Invalid stp '{value}'. Must be one of: {', '.join(VALID_BODY_STP)}")
    ...
    if 'stp-ha-secondary' in payload:
        ...
        if value and value not in VALID_BODY_STP_HA_SECONDARY:
            return (False, f"Invalid stp-ha-secondary '{value}'. Must be one of: {', '.join(VALID_BODY_STP_HA_SECONDARY)}")
    ...
    if 'stp-edge' in payload:
        ...
        if value and value not in VALID_BODY_STP_EDGE:
            return (False, f"Invalid stp-edge '{value}'. Must be one of: {', '.join(VALID_BODY_STP_EDGE)}")
    ...
    if 'device-identification' in payload:
        ...
        if value and value not in VALID_BODY_DEVICE_IDENTIFICATION:
            return (False, f"Invalid device-identification '{value}'. Must be one of: {', '.join(VALID_BODY_DEVICE_IDENTIFICATION)}")
    ...
    if 'exclude-signatures' in payload:
        ...
        if value and value not in VALID_BODY_EXCLUDE_SIGNATURES:
            return (False, f"Invalid exclude-signatures '{value}'. Must be one of: {', '.join(VALID_BODY_EXCLUDE_SIGNATURES)}")
    ...
    if 'device-user-identification' in payload:
        ...
        if value and value not in VALID_BODY_DEVICE_USER_IDENTIFICATION:
            return (False, f"Invalid device-user-identification '{value}'. Must be one of: {', '.join(VALID_BODY_DEVICE_USER_IDENTIFICATION)}")
    ...
    if 'estimated-upstream-bandwidth' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"estimated-upstream-bandwidth must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"estimated-upstream-bandwidth must be numeric, got: {value}")
    ...
    if 'estimated-downstream-bandwidth' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"estimated-downstream-bandwidth must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"estimated-downstream-bandwidth must be numeric, got: {value}")
    ...
    if 'measured-upstream-bandwidth' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"measured-upstream-bandwidth must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"measured-upstream-bandwidth must be numeric, got: {value}")
    ...
    if 'measured-downstream-bandwidth' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"measured-downstream-bandwidth must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"measured-downstream-bandwidth must be numeric, got: {value}")
    ...
    if 'bandwidth-measure-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"bandwidth-measure-time must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"bandwidth-measure-time must be numeric, got: {value}")
    ...
    if 'monitor-bandwidth' in payload:
        ...
        if value and value not in VALID_BODY_MONITOR_BANDWIDTH:
            return (False, f"Invalid monitor-bandwidth '{value}'. Must be one of: {', '.join(VALID_BODY_MONITOR_BANDWIDTH)}")
    ...
    if 'vrrp-virtual-mac' in payload:
        ...
        if value and value not in VALID_BODY_VRRP_VIRTUAL_MAC:
            return (False, f"Invalid vrrp-virtual-mac '{value}'. Must be one of: {', '.join(VALID_BODY_VRRP_VIRTUAL_MAC)}")
    ...
    if 'snmp-index' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2147483647:
                    return (False, f"snmp-index must be between 0 and 2147483647")
            except (ValueError, TypeError):
    ...
    if 'secondary-IP' in payload:
        ...
        if value and value not in VALID_BODY_SECONDARY_IP:
            return (False, f"Invalid secondary-IP '{value}'. Must be one of: {', '.join(VALID_BODY_SECONDARY_IP)}")
    ...
    if 'preserve-session-route' in payload:
        ...
        if value and value not in VALID_BODY_PRESERVE_SESSION_ROUTE:
            return (False, f"Invalid preserve-session-route '{value}'. Must be one of: {', '.join(VALID_BODY_PRESERVE_SESSION_ROUTE)}")
    ...
    if 'ap-discover' in payload:
        ...
        if value and value not in VALID_BODY_AP_DISCOVER:
            return (False, f"Invalid ap-discover '{value}'. Must be one of: {', '.join(VALID_BODY_AP_DISCOVER)}")
    ...
    if 'fortilink-neighbor-detect' in payload:
        ...
        if value and value not in VALID_BODY_FORTILINK_NEIGHBOR_DETECT:
            return (False, f"Invalid fortilink-neighbor-detect '{value}'. Must be one of: {', '.join(VALID_BODY_FORTILINK_NEIGHBOR_DETECT)}")
    ...
    if 'ip-managed-by-fortiipam' in payload:
        ...
        if value and value not in VALID_BODY_IP_MANAGED_BY_FORTIIPAM:
            return (False, f"Invalid ip-managed-by-fortiipam '{value}'. Must be one of: {', '.join(VALID_BODY_IP_MANAGED_BY_FORTIIPAM)}")
    ...
    if 'managed-subnetwork-size' in payload:
        ...
        if value and value not in VALID_BODY_MANAGED_SUBNETWORK_SIZE:
            return (False, f"Invalid managed-subnetwork-size '{value}'. Must be one of: {', '.join(VALID_BODY_MANAGED_SUBNETWORK_SIZE)}")
    ...
    if 'fortilink-split-interface' in payload:
        ...
        if value and value not in VALID_BODY_FORTILINK_SPLIT_INTERFACE:
            return (False, f"Invalid fortilink-split-interface '{value}'. Must be one of: {', '.join(VALID_BODY_FORTILINK_SPLIT_INTERFACE)}")
    ...
    if 'fortilink-backup-link' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 255:
                    return (False, f"fortilink-backup-link must be between 0 and 255")
            except (ValueError, TypeError):
                return (False, f"fortilink-backup-link must be numeric, got: {value}")
    ...
    if 'switch-controller-access-vlan' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_ACCESS_VLAN:
            return (False, f"Invalid switch-controller-access-vlan '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_ACCESS_VLAN)}")
    ...
    if 'switch-controller-traffic-policy' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 63:
            return (False, f"switch-controller-traffic-policy cannot exceed 63 characters")
    ...
    if 'switch-controller-rspan-mode' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_RSPAN_MODE:
            return (False, f"Invalid switch-controller-rspan-mode '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_RSPAN_MODE)}")
    ...
    if 'switch-controller-netflow-collect' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_NETFLOW_COLLECT:
            return (False, f"Invalid switch-controller-netflow-collect '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_NETFLOW_COLLECT)}")
    ...
    if 'switch-controller-mgmt-vlan' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 4094:
                    return (False, f"switch-controller-mgmt-vlan must be between 1 and 4094")
            except (ValueError, TypeError):
                return (False, f"switch-controller-mgmt-vlan must be numeric, got: {value}")
    ...
    if 'switch-controller-igmp-snooping' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_IGMP_SNOOPING:
            return (False, f"Invalid switch-controller-igmp-snooping '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_IGMP_SNOOPING)}")
    ...
    if 'switch-controller-igmp-snooping-proxy' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_IGMP_SNOOPING_PROXY:
            return (False, f"Invalid switch-controller-igmp-snooping-proxy '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_IGMP_SNOOPING_PROXY)}")
    ...
    if 'switch-controller-igmp-snooping-fast-leave' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_IGMP_SNOOPING_FAST_LEAVE:
            return (False, f"Invalid switch-controller-igmp-snooping-fast-leave '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_IGMP_SNOOPING_FAST_LEAVE)}")
    ...
    if 'switch-controller-dhcp-snooping' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_DHCP_SNOOPING:
            return (False, f"Invalid switch-controller-dhcp-snooping '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_DHCP_SNOOPING)}")
    ...
    if 'switch-controller-dhcp-snooping-verify-mac' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_DHCP_SNOOPING_VERIFY_MAC:
            return (False, f"Invalid switch-controller-dhcp-snooping-verify-mac '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_DHCP_SNOOPING_VERIFY_MAC)}")
    ...
    if 'switch-controller-dhcp-snooping-option82' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_DHCP_SNOOPING_OPTION82:
            return (False, f"Invalid switch-controller-dhcp-snooping-option82 '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_DHCP_SNOOPING_OPTION82)}")
    ...
    if 'switch-controller-arp-inspection' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_ARP_INSPECTION:
            return (False, f"Invalid switch-controller-arp-inspection '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_ARP_INSPECTION)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 128:
                    return (False, f"switch-controller-learning-limit must be between 0 and 128")
            except (ValueError, TypeError):
                return (False, f"switch-controller-learning-limit must be numeric, got: {value}")
    
    # Validate switch-controller-nac if present
    if 'switch-controller-nac' in payload:
        value = payload.get('switch-controller-nac')
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"switch-controller-nac cannot exceed 35 characters")
    ...
    if 'switch-controller-dynamic' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"switch-controller-dynamic cannot exceed 35 characters")
    ...
    if 'switch-controller-feature' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_FEATURE:
            return (False, f"Invalid switch-controller-feature '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_FEATURE)}")
    ...
    if 'switch-controller-iot-scanning' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_IOT_SCANNING:
            return (False, f"Invalid switch-controller-iot-scanning '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_IOT_SCANNING)}")
    ...
    if 'switch-controller-offload' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_OFFLOAD:
            return (False, f"Invalid switch-controller-offload '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_OFFLOAD)}")
    ...
    if 'switch-controller-offload-gw' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER_OFFLOAD_GW:
            return (False, f"Invalid switch-controller-offload-gw '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER_OFFLOAD_GW)}")
    ...
    if 'swc-vlan' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"swc-vlan must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'swc-first-create' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"swc-first-create must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"swc-first-create must be numeric, got: {value}")
    ...
    if 'eap-supplicant' in payload:
        ...
        if value and value not in VALID_BODY_EAP_SUPPLICANT:
            return (False, f"Invalid eap-supplicant '{value}'. Must be one of: {', '.join(VALID_BODY_EAP_SUPPLICANT)}")
    ...
    if 'eap-method' in payload:
        ...
        if value and value not in VALID_BODY_EAP_METHOD:
            return (False, f"Invalid eap-method '{value}'. Must be one of: {', '.join(VALID_BODY_EAP_METHOD)}")
    ...
    if 'default-purdue-level' in payload:
        ...
        if value and value not in VALID_BODY_DEFAULT_PURDUE_LEVEL:
            return (False, f"Invalid default-purdue-level '{value}'. Must be one of: {', '.join(VALID_BODY_DEFAULT_PURDUE_LEVEL)}")
...
def validate_interface_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
