...
VALID_BODY_LANGUAGE = ['english', 'french', 'spanish', 'portuguese', 'japanese', 'trach', 'simch', 'korean']
...
VALID_BODY_ADMIN_HTTPS_SSL_CIPHERSUITES = ['TLS-AES-128-GCM-SHA256', 'TLS-AES-256-GCM-SHA384', 'TLS-CHACHA20-POLY1305-SHA256', 'TLS-AES-128-CCM-SHA256', 'TLS-AES-128-CCM-8-SHA256']
VALID_BODY_ADMIN_HTTPS_SSL_BANNED_CIPHERS = ['RSA', 'DHE', 'ECDHE', 'DSS', 'ECDSA', 'AES', 'AESGCM', 'CAMELLIA', '3DES', 'SHA1', 'SHA256', 'SHA384', 'STATIC', 'CHACHA20', 'ARIA', 'AESCCM']
VALID_BODY_SSD_TRIM_FREQ = ['never', 'hourly', 'daily', 'weekly', 'monthly']
VALID_BODY_SSD_TRIM_WEEKDAY = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday']
...
VALID_BODY_SSL_MIN_PROTO_VERSION = ['SSLv3', 'TLSv1', 'TLSv1-1', 'TLSv1-2', 'TLSv1-3']
...
VALID_BODY_FGD_ALERT_SUBSCRIPTION = ['advisory', 'latest-threat', 'latest-virus', 'latest-attack', 'new-antivirus-db', 'new-attack-db']
...
VALID_BODY_GUI_THEME = ['jade', 'neutrino', 'mariner', 'graphite', 'melongene', 'jet-stream', 'security-fabric', 'retro', 'dark-matter', 'onyx', 'eclipse']
VALID_BODY_GUI_DATE_FORMAT = ['yyyy/MM/dd', 'dd/MM/yyyy', 'MM/dd/yyyy', 'yyyy-MM-dd', 'dd-MM-yyyy', 'MM-dd-yyyy']
...
VALID_BODY_INTERNET_SERVICE_DATABASE = ['mini', 'standard', 'full', 'on-demand']
...
VALID_BODY_AUTH_SESSION_AUTO_BACKUP_INTERVAL = ['1min', '5min', '15min', '30min', '1hr']
...
def validate_global__put(
    ...
    if 'language' in payload:
        ...
        if value and value not in VALID_BODY_LANGUAGE:
            return (False, f"Invalid language '{value}'. Must be one of: {', '.join(VALID_BODY_LANGUAGE)}")
    ...
    if 'gui-allow-incompatible-fabric-fgt' in payload:
        ...
        if value and value not in VALID_BODY_GUI_ALLOW_INCOMPATIBLE_FABRIC_FGT:
            return (False, f"Invalid gui-allow-incompatible-fabric-fgt '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_ALLOW_INCOMPATIBLE_FABRIC_FGT)}")
    ...
    if 'gui-ipv6' in payload:
        ...
        if value and value not in VALID_BODY_GUI_IPV6:
            return (False, f"Invalid gui-ipv6 '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_IPV6)}")
    ...
    if 'gui-replacement-message-groups' in payload:
        ...
        if value and value not in VALID_BODY_GUI_REPLACEMENT_MESSAGE_GROUPS:
            return (False, f"Invalid gui-replacement-message-groups '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_REPLACEMENT_MESSAGE_GROUPS)}")
    ...
    if 'gui-local-out' in payload:
        ...
        if value and value not in VALID_BODY_GUI_LOCAL_OUT:
            return (False, f"Invalid gui-local-out '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_LOCAL_OUT)}")
    ...
    if 'gui-certificates' in payload:
        ...
        if value and value not in VALID_BODY_GUI_CERTIFICATES:
            return (False, f"Invalid gui-certificates '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_CERTIFICATES)}")
    ...
    if 'gui-custom-language' in payload:
        ...
        if value and value not in VALID_BODY_GUI_CUSTOM_LANGUAGE:
            return (False, f"Invalid gui-custom-language '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_CUSTOM_LANGUAGE)}")
    ...
    if 'gui-wireless-opensecurity' in payload:
        ...
        if value and value not in VALID_BODY_GUI_WIRELESS_OPENSECURITY:
            return (False, f"Invalid gui-wireless-opensecurity '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_WIRELESS_OPENSECURITY)}")
    ...
    if 'gui-app-detection-sdwan' in payload:
        ...
        if value and value not in VALID_BODY_GUI_APP_DETECTION_SDWAN:
            return (False, f"Invalid gui-app-detection-sdwan '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_APP_DETECTION_SDWAN)}")
    ...
    if 'gui-display-hostname' in payload:
        ...
        if value and value not in VALID_BODY_GUI_DISPLAY_HOSTNAME:
            return (False, f"Invalid gui-display-hostname '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_DISPLAY_HOSTNAME)}")
    ...
    if 'gui-fortigate-cloud-sandbox' in payload:
        ...
        if value and value not in VALID_BODY_GUI_FORTIGATE_CLOUD_SANDBOX:
            return (False, f"Invalid gui-fortigate-cloud-sandbox '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_FORTIGATE_CLOUD_SANDBOX)}")
    ...
    if 'gui-firmware-upgrade-warning' in payload:
        ...
        if value and value not in VALID_BODY_GUI_FIRMWARE_UPGRADE_WARNING:
            return (False, f"Invalid gui-firmware-upgrade-warning '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_FIRMWARE_UPGRADE_WARNING)}")
    ...
    if 'gui-forticare-registration-setup-warning' in payload:
        ...
        if value and value not in VALID_BODY_GUI_FORTICARE_REGISTRATION_SETUP_WARNING:
            return (False, f"Invalid gui-forticare-registration-setup-warning '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_FORTICARE_REGISTRATION_SETUP_WARNING)}")
    ...
    if 'gui-auto-upgrade-setup-warning' in payload:
        ...
        if value and value not in VALID_BODY_GUI_AUTO_UPGRADE_SETUP_WARNING:
            return (False, f"Invalid gui-auto-upgrade-setup-warning '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_AUTO_UPGRADE_SETUP_WARNING)}")
    ...
    if 'gui-workflow-management' in payload:
        ...
        if value and value not in VALID_BODY_GUI_WORKFLOW_MANAGEMENT:
            return (False, f"Invalid gui-workflow-management '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_WORKFLOW_MANAGEMENT)}")
    ...
    if 'gui-cdn-usage' in payload:
        ...
        if value and value not in VALID_BODY_GUI_CDN_USAGE:
            return (False, f"Invalid gui-cdn-usage '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_CDN_USAGE)}")
    ...
    if 'admin-https-ssl-versions' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_HTTPS_SSL_VERSIONS:
            return (False, f"Invalid admin-https-ssl-versions '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_HTTPS_SSL_VERSIONS)}")
    ...
    if 'admin-https-ssl-ciphersuites' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_HTTPS_SSL_CIPHERSUITES:
            return (False, f"Invalid admin-https-ssl-ciphersuites '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_HTTPS_SSL_CIPHERSUITES)}")
    ...
    if 'admin-https-ssl-banned-ciphers' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_HTTPS_SSL_BANNED_CIPHERS:
            return (False, f"Invalid admin-https-ssl-banned-ciphers '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_HTTPS_SSL_BANNED_CIPHERS)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 15 or int_val > 300:
                    return (False, f"admin-console-timeout must be between 15 and 300")
            except (ValueError, TypeError):
                return (False, f"admin-console-timeout must be numeric, got: {value}")
    ...
    if 'ssd-trim-freq' in payload:
        ...
        if value and value not in VALID_BODY_SSD_TRIM_FREQ:
            return (False, f"Invalid ssd-trim-freq '{value}'. Must be one of: {', '.join(VALID_BODY_SSD_TRIM_FREQ)}")
    ...
    if 'ssd-trim-weekday' in payload:
        ...
        if value and value not in VALID_BODY_SSD_TRIM_WEEKDAY:
            return (False, f"Invalid ssd-trim-weekday '{value}'. Must be one of: {', '.join(VALID_BODY_SSD_TRIM_WEEKDAY)}")
    ...
    if 'admin-concurrent' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_CONCURRENT:
            return (False, f"Invalid admin-concurrent '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_CONCURRENT)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 10:
                    return (False, f"admin-lockout-threshold must be between 1 and 10")
            except (ValueError, TypeError):
                return (False, f"admin-lockout-threshold must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 2147483647:
                    return (False, f"admin-lockout-duration must be between 1 and 2147483647")
            except (ValueError, TypeError):
                return (False, f"admin-lockout-duration must be numeric, got: {value}")
    ...
    if 'interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"interval must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'failtime' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"failtime must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'purdue-level' in payload:
        ...
        if value and value not in VALID_BODY_PURDUE_LEVEL:
            return (False, f"Invalid purdue-level '{value}'. Must be one of: {', '.join(VALID_BODY_PURDUE_LEVEL)}")
    ...
    if 'daily-restart' in payload:
        ...
        if value and value not in VALID_BODY_DAILY_RESTART:
            return (False, f"Invalid daily-restart '{value}'. Must be one of: {', '.join(VALID_BODY_DAILY_RESTART)}")
    ...
    if 'wad-restart-mode' in payload:
        ...
        if value and value not in VALID_BODY_WAD_RESTART_MODE:
            return (False, f"Invalid wad-restart-mode '{value}'. Must be one of: {', '.join(VALID_BODY_WAD_RESTART_MODE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 32:
                    return (False, f"wad-p2s-max-body-size must be between 1 and 32")
            except (ValueError, TypeError):
                return (False, f"wad-p2s-max-body-size must be numeric, got: {value}")
    ...
    if 'speedtestd-server-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"speedtestd-server-port must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"speedtestd-server-port must be numeric, got: {value}")
    ...
    if 'speedtestd-ctrl-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"speedtestd-ctrl-port must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"speedtestd-ctrl-port must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 100:
                    return (False, f"admin-login-max must be between 1 and 100")
            except (ValueError, TypeError):
                return (False, f"admin-login-max must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 300:
                    return (False, f"remoteauthtimeout must be between 1 and 300")
            except (ValueError, TypeError):
                return (False, f"remoteauthtimeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 300000:
                    return (False, f"ldapconntimeout must be between 1 and 300000")
            except (ValueError, TypeError):
                return (False, f"ldapconntimeout must be numeric, got: {value}")
    ...
    if 'batch-cmdb' in payload:
        ...
        if value and value not in VALID_BODY_BATCH_CMDB:
            return (False, f"Invalid batch-cmdb '{value}'. Must be one of: {', '.join(VALID_BODY_BATCH_CMDB)}")
    ...
    if 'multi-factor-authentication' in payload:
        ...
        if value and value not in VALID_BODY_MULTI_FACTOR_AUTHENTICATION:
            return (False, f"Invalid multi-factor-authentication '{value}'. Must be one of: {', '.join(VALID_BODY_MULTI_FACTOR_AUTHENTICATION)}")
    ...
    if 'ssl-min-proto-version' in payload:
        ...
        if value and value not in VALID_BODY_SSL_MIN_PROTO_VERSION:
            return (False, f"Invalid ssl-min-proto-version '{value}'. Must be one of: {', '.join(VALID_BODY_SSL_MIN_PROTO_VERSION)}")
    ...
    if 'autorun-log-fsck' in payload:
        ...
        if value and value not in VALID_BODY_AUTORUN_LOG_FSCK:
            return (False, f"Invalid autorun-log-fsck '{value}'. Must be one of: {', '.join(VALID_BODY_AUTORUN_LOG_FSCK)}")
    ...
    if 'traffic-priority' in payload:
        ...
        if value and value not in VALID_BODY_TRAFFIC_PRIORITY:
            return (False, f"Invalid traffic-priority '{value}'. Must be one of: {', '.join(VALID_BODY_TRAFFIC_PRIORITY)}")
    ...
    if 'traffic-priority-level' in payload:
        ...
        if value and value not in VALID_BODY_TRAFFIC_PRIORITY_LEVEL:
            return (False, f"Invalid traffic-priority-level '{value}'. Must be one of: {', '.join(VALID_BODY_TRAFFIC_PRIORITY_LEVEL)}")
    ...
    if 'quic-congestion-control-algo' in payload:
        ...
        if value and value not in VALID_BODY_QUIC_CONGESTION_CONTROL_ALGO:
            return (False, f"Invalid quic-congestion-control-algo '{value}'. Must be one of: {', '.join(VALID_BODY_QUIC_CONGESTION_CONTROL_ALGO)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1200 or int_val > 1500:
                    return (False, f"quic-max-datagram-size must be between 1200 and 1500")
            except (ValueError, TypeError):
                return (False, f"quic-max-datagram-size must be numeric, got: {value}")
    ...
    if 'quic-udp-payload-size-shaping-per-cid' in payload:
        ...
        if value and value not in VALID_BODY_QUIC_UDP_PAYLOAD_SIZE_SHAPING_PER_CID:
            return (False, f"Invalid quic-udp-payload-size-shaping-per-cid '{value}'. Must be one of: {', '.join(VALID_BODY_QUIC_UDP_PAYLOAD_SIZE_SHAPING_PER_CID)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 2 or int_val > 5:
                    return (False, f"quic-ack-thresold must be between 2 and 5")
            except (ValueError, TypeError):
                return (False, f"quic-ack-thresold must be numeric, got: {value}")
    ...
    if 'quic-pmtud' in payload:
        ...
        if value and value not in VALID_BODY_QUIC_PMTUD:
            return (False, f"Invalid quic-pmtud '{value}'. Must be one of: {', '.join(VALID_BODY_QUIC_PMTUD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 60:
                    return (False, f"quic-tls-handshake-timeout must be between 1 and 60")
            except (ValueError, TypeError):
                return (False, f"quic-tls-handshake-timeout must be numeric, got: {value}")
    ...
    if 'anti-replay' in payload:
        ...
        if value and value not in VALID_BODY_ANTI_REPLAY:
            return (False, f"Invalid anti-replay '{value}'. Must be one of: {', '.join(VALID_BODY_ANTI_REPLAY)}")
    ...
    if 'send-pmtu-icmp' in payload:
        ...
        if value and value not in VALID_BODY_SEND_PMTU_ICMP:
            return (False, f"Invalid send-pmtu-icmp '{value}'. Must be one of: {', '.join(VALID_BODY_SEND_PMTU_ICMP)}")
    ...
    if 'honor-df' in payload:
        ...
        if value and value not in VALID_BODY_HONOR_DF:
            return (False, f"Invalid honor-df '{value}'. Must be one of: {', '.join(VALID_BODY_HONOR_DF)}")
    ...
    if 'pmtu-discovery' in payload:
        ...
        if value and value not in VALID_BODY_PMTU_DISCOVERY:
            return (False, f"Invalid pmtu-discovery '{value}'. Must be one of: {', '.join(VALID_BODY_PMTU_DISCOVERY)}")
    ...
    if 'virtual-switch-vlan' in payload:
        ...
        if value and value not in VALID_BODY_VIRTUAL_SWITCH_VLAN:
            return (False, f"Invalid virtual-switch-vlan '{value}'. Must be one of: {', '.join(VALID_BODY_VIRTUAL_SWITCH_VLAN)}")
    ...
    if 'revision-image-auto-backup' in payload:
        ...
        if value and value not in VALID_BODY_REVISION_IMAGE_AUTO_BACKUP:
            return (False, f"Invalid revision-image-auto-backup '{value}'. Must be one of: {', '.join(VALID_BODY_REVISION_IMAGE_AUTO_BACKUP)}")
    ...
    if 'revision-backup-on-logout' in payload:
        ...
        if value and value not in VALID_BODY_REVISION_BACKUP_ON_LOGOUT:
            return (False, f"Invalid revision-backup-on-logout '{value}'. Must be one of: {', '.join(VALID_BODY_REVISION_BACKUP_ON_LOGOUT)}")
    ...
    if 'strong-crypto' in payload:
        ...
        if value and value not in VALID_BODY_STRONG_CRYPTO:
            return (False, f"Invalid strong-crypto '{value}'. Must be one of: {', '.join(VALID_BODY_STRONG_CRYPTO)}")
    ...
    if 'ssl-static-key-ciphers' in payload:
        ...
        if value and value not in VALID_BODY_SSL_STATIC_KEY_CIPHERS:
            return (False, f"Invalid ssl-static-key-ciphers '{value}'. Must be one of: {', '.join(VALID_BODY_SSL_STATIC_KEY_CIPHERS)}")
    ...
    if 'snat-route-change' in payload:
        ...
        if value and value not in VALID_BODY_SNAT_ROUTE_CHANGE:
            return (False, f"Invalid snat-route-change '{value}'. Must be one of: {', '.join(VALID_BODY_SNAT_ROUTE_CHANGE)}")
    ...
    if 'ipv6-snat-route-change' in payload:
        ...
        if value and value not in VALID_BODY_IPV6_SNAT_ROUTE_CHANGE:
            return (False, f"Invalid ipv6-snat-route-change '{value}'. Must be one of: {', '.join(VALID_BODY_IPV6_SNAT_ROUTE_CHANGE)}")
    ...
    if 'speedtest-server' in payload:
        ...
        if value and value not in VALID_BODY_SPEEDTEST_SERVER:
            return (False, f"Invalid speedtest-server '{value}'. Must be one of: {', '.join(VALID_BODY_SPEEDTEST_SERVER)}")
    ...
    if 'cli-audit-log' in payload:
        ...
        if value and value not in VALID_BODY_CLI_AUDIT_LOG:
            return (False, f"Invalid cli-audit-log '{value}'. Must be one of: {', '.join(VALID_BODY_CLI_AUDIT_LOG)}")
    ...
    if 'dh-params' in payload:
        ...
        if value and value not in VALID_BODY_DH_PARAMS:
            return (False, f"Invalid dh-params '{value}'. Must be one of: {', '.join(VALID_BODY_DH_PARAMS)}")
    ...
    if 'fds-statistics' in payload:
        ...
        if value and value not in VALID_BODY_FDS_STATISTICS:
            return (False, f"Invalid fds-statistics '{value}'. Must be one of: {', '.join(VALID_BODY_FDS_STATISTICS)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 1440:
                    return (False, f"fds-statistics-period must be between 1 and 1440")
            except (ValueError, TypeError):
                return (False, f"fds-statistics-period must be numeric, got: {value}")
    ...
    if 'tcp-option' in payload:
        ...
        if value and value not in VALID_BODY_TCP_OPTION:
            return (False, f"Invalid tcp-option '{value}'. Must be one of: {', '.join(VALID_BODY_TCP_OPTION)}")
    ...
    if 'lldp-transmission' in payload:
        ...
        if value and value not in VALID_BODY_LLDP_TRANSMISSION:
            return (False, f"Invalid lldp-transmission '{value}'. Must be one of: {', '.join(VALID_BODY_LLDP_TRANSMISSION)}")
    ...
    if 'lldp-reception' in payload:
        ...
        if value and value not in VALID_BODY_LLDP_RECEPTION:
            return (False, f"Invalid lldp-reception '{value}'. Must be one of: {', '.join(VALID_BODY_LLDP_RECEPTION)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 10000:
                    return (False, f"proxy-auth-timeout must be between 1 and 10000")
            except (ValueError, TypeError):
                return (False, f"proxy-auth-timeout must be numeric, got: {value}")
    ...
    if 'proxy-keep-alive-mode' in payload:
        ...
        if value and value not in VALID_BODY_PROXY_KEEP_ALIVE_MODE:
            return (False, f"Invalid proxy-keep-alive-mode '{value}'. Must be one of: {', '.join(VALID_BODY_PROXY_KEEP_ALIVE_MODE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 86400:
                    return (False, f"proxy-re-authentication-time must be between 1 and 86400")
            except (ValueError, TypeError):
                return (False, f"proxy-re-authentication-time must be numeric, got: {value}")
    ...
    if 'proxy-auth-lifetime' in payload:
        ...
        if value and value not in VALID_BODY_PROXY_AUTH_LIFETIME:
            return (False, f"Invalid proxy-auth-lifetime '{value}'. Must be one of: {', '.join(VALID_BODY_PROXY_AUTH_LIFETIME)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 5 or int_val > 65535:
                    return (False, f"proxy-auth-lifetime-timeout must be between 5 and 65535")
            except (ValueError, TypeError):
                return (False, f"proxy-auth-lifetime-timeout must be numeric, got: {value}")
    ...
    if 'proxy-resource-mode' in payload:
        ...
        if value and value not in VALID_BODY_PROXY_RESOURCE_MODE:
            return (False, f"Invalid proxy-resource-mode '{value}'. Must be one of: {', '.join(VALID_BODY_PROXY_RESOURCE_MODE)}")
    ...
    if 'proxy-cert-use-mgmt-vdom' in payload:
        ...
        if value and value not in VALID_BODY_PROXY_CERT_USE_MGMT_VDOM:
            return (False, f"Invalid proxy-cert-use-mgmt-vdom '{value}'. Must be one of: {', '.join(VALID_BODY_PROXY_CERT_USE_MGMT_VDOM)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 15:
                    return (False, f"sys-perf-log-interval must be between 0 and 15")
            except (ValueError, TypeError):
                return (False, f"sys-perf-log-interval must be numeric, got: {value}")
    ...
    if 'check-protocol-header' in payload:
        ...
        if value and value not in VALID_BODY_CHECK_PROTOCOL_HEADER:
            return (False, f"Invalid check-protocol-header '{value}'. Must be one of: {', '.join(VALID_BODY_CHECK_PROTOCOL_HEADER)}")
    ...
    if 'vip-arp-range' in payload:
        ...
        if value and value not in VALID_BODY_VIP_ARP_RANGE:
            return (False, f"Invalid vip-arp-range '{value}'. Must be one of: {', '.join(VALID_BODY_VIP_ARP_RANGE)}")
    ...
    if 'reset-sessionless-tcp' in payload:
        ...
        if value and value not in VALID_BODY_RESET_SESSIONLESS_TCP:
            return (False, f"Invalid reset-sessionless-tcp '{value}'. Must be one of: {', '.join(VALID_BODY_RESET_SESSIONLESS_TCP)}")
    ...
    if 'allow-traffic-redirect' in payload:
        ...
        if value and value not in VALID_BODY_ALLOW_TRAFFIC_REDIRECT:
            return (False, f"Invalid allow-traffic-redirect '{value}'. Must be one of: {', '.join(VALID_BODY_ALLOW_TRAFFIC_REDIRECT)}")
    ...
    if 'ipv6-allow-traffic-redirect' in payload:
        ...
        if value and value not in VALID_BODY_IPV6_ALLOW_TRAFFIC_REDIRECT:
            return (False, f"Invalid ipv6-allow-traffic-redirect '{value}'. Must be one of: {', '.join(VALID_BODY_IPV6_ALLOW_TRAFFIC_REDIRECT)}")
    ...
    if 'strict-dirty-session-check' in payload:
        ...
        if value and value not in VALID_BODY_STRICT_DIRTY_SESSION_CHECK:
            return (False, f"Invalid strict-dirty-session-check '{value}'. Must be one of: {', '.join(VALID_BODY_STRICT_DIRTY_SESSION_CHECK)}")
    ...
    if 'tcp-halfclose-timer' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 86400:
                    return (False, f"tcp-halfclose-timer must be between 1 and 86400")
            except (ValueError, TypeError):
                return (False, f"tcp-halfclose-timer must be numeric, got: {value}")
    ...
    if 'tcp-halfopen-timer' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 86400:
                    return (False, f"tcp-halfopen-timer must be between 1 and 86400")
            except (ValueError, TypeError):
                return (False, f"tcp-halfopen-timer must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 300:
                    return (False, f"tcp-timewait-timer must be between 0 and 300")
            except (ValueError, TypeError):
                return (False, f"tcp-timewait-timer must be numeric, got: {value}")
    ...
    if 'udp-idle-timer' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 86400:
                    return (False, f"udp-idle-timer must be between 1 and 86400")
            except (ValueError, TypeError):
    ...
    if 'block-session-timer' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 300:
                    return (False, f"block-session-timer must be between 1 and 300")
            except (ValueError, TypeError):
                return (False, f"block-session-timer must be numeric, got: {value}")
    ...
    if 'pre-login-banner' in payload:
        ...
        if value and value not in VALID_BODY_PRE_LOGIN_BANNER:
            return (False, f"Invalid pre-login-banner '{value}'. Must be one of: {', '.join(VALID_BODY_PRE_LOGIN_BANNER)}")
    ...
    if 'post-login-banner' in payload:
        ...
        if value and value not in VALID_BODY_POST_LOGIN_BANNER:
            return (False, f"Invalid post-login-banner '{value}'. Must be one of: {', '.join(VALID_BODY_POST_LOGIN_BANNER)}")
    
    # Validate tftp if present
    if 'tftp' in payload:
        value = payload.get('tftp')
        if value and value not in VALID_BODY_TFTP:
            return (False, f"Invalid tftp '{value}'. Must be one of: {', '.join(VALID_BODY_TFTP)}")
    ...
    if 'av-failopen' in payload:
        ...
        if value and value not in VALID_BODY_AV_FAILOPEN:
            return (False, f"Invalid av-failopen '{value}'. Must be one of: {', '.join(VALID_BODY_AV_FAILOPEN)}")
    ...
    if 'av-failopen-session' in payload:
        ...
        if value and value not in VALID_BODY_AV_FAILOPEN_SESSION:
            return (False, f"Invalid av-failopen-session '{value}'. Must be one of: {', '.join(VALID_BODY_AV_FAILOPEN_SESSION)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 70 or int_val > 97:
                    return (False, f"memory-use-threshold-extreme must be between 70 and 97")
            except (ValueError, TypeError):
                return (False, f"memory-use-threshold-extreme must be numeric, got: {value}")
    ...
    if 'memory-use-threshold-red' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 70 or int_val > 97:
                    return (False, f"memory-use-threshold-red must be between 70 and 97")
            except (ValueError, TypeError):
                return (False, f"memory-use-threshold-red must be numeric, got: {value}")
    ...
    if 'memory-use-threshold-green' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 70 or int_val > 97:
                    return (False, f"memory-use-threshold-green must be between 70 and 97")
            except (ValueError, TypeError):
                return (False, f"memory-use-threshold-green must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 32 or int_val > 2047:
                    return (False, f"ip-fragment-mem-thresholds must be between 32 and 2047")
            except (ValueError, TypeError):
                return (False, f"ip-fragment-mem-thresholds must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 3 or int_val > 30:
                    return (False, f"ip-fragment-timeout must be between 3 and 30")
            except (ValueError, TypeError):
                return (False, f"ip-fragment-timeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 5 or int_val > 60:
                    return (False, f"ipv6-fragment-timeout must be between 5 and 60")
            except (ValueError, TypeError):
                return (False, f"ipv6-fragment-timeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 50 or int_val > 99:
                    return (False, f"cpu-use-threshold must be between 50 and 99")
            except (ValueError, TypeError):
                return (False, f"cpu-use-threshold must be numeric, got: {value}")
    ...
    if 'log-single-cpu-high' in payload:
        ...
        if value and value not in VALID_BODY_LOG_SINGLE_CPU_HIGH:
            return (False, f"Invalid log-single-cpu-high '{value}'. Must be one of: {', '.join(VALID_BODY_LOG_SINGLE_CPU_HIGH)}")
    ...
    if 'check-reset-range' in payload:
        ...
        if value and value not in VALID_BODY_CHECK_RESET_RANGE:
            return (False, f"Invalid check-reset-range '{value}'. Must be one of: {', '.join(VALID_BODY_CHECK_RESET_RANGE)}")
    ...
    if 'single-vdom-npuvlink' in payload:
        ...
        if value and value not in VALID_BODY_SINGLE_VDOM_NPUVLINK:
            return (False, f"Invalid single-vdom-npuvlink '{value}'. Must be one of: {', '.join(VALID_BODY_SINGLE_VDOM_NPUVLINK)}")
    ...
    if 'vdom-mode' in payload:
        ...
        if value and value not in VALID_BODY_VDOM_MODE:
            return (False, f"Invalid vdom-mode '{value}'. Must be one of: {', '.join(VALID_BODY_VDOM_MODE)}")
    ...
    if 'long-vdom-name' in payload:
        ...
        if value and value not in VALID_BODY_LONG_VDOM_NAME:
            return (False, f"Invalid long-vdom-name '{value}'. Must be one of: {', '.join(VALID_BODY_LONG_VDOM_NAME)}")
    ...
    if 'upgrade-report' in payload:
        ...
        if value and value not in VALID_BODY_UPGRADE_REPORT:
            return (False, f"Invalid upgrade-report '{value}'. Must be one of: {', '.join(VALID_BODY_UPGRADE_REPORT)}")
    ...
    if 'edit-vdom-prompt' in payload:
        ...
        if value and value not in VALID_BODY_EDIT_VDOM_PROMPT:
            return (False, f"Invalid edit-vdom-prompt '{value}'. Must be one of: {', '.join(VALID_BODY_EDIT_VDOM_PROMPT)}")
    ...
    if 'admin-https-redirect' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_HTTPS_REDIRECT:
            return (False, f"Invalid admin-https-redirect '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_HTTPS_REDIRECT)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 2147483647:
                    return (False, f"admin-hsts-max-age must be between 0 and 2147483647")
            except (ValueError, TypeError):
                return (False, f"admin-hsts-max-age must be numeric, got: {value}")
    ...
    if 'admin-ssh-password' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_SSH_PASSWORD:
            return (False, f"Invalid admin-ssh-password '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_SSH_PASSWORD)}")
    ...
    if 'admin-restrict-local' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_RESTRICT_LOCAL:
            return (False, f"Invalid admin-restrict-local '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_RESTRICT_LOCAL)}")
    ...
    if 'admin-ssh-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"admin-ssh-port must be between 1 and 65535")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 10 or int_val > 3600:
                    return (False, f"admin-ssh-grace-time must be between 10 and 3600")
            except (ValueError, TypeError):
                return (False, f"admin-ssh-grace-time must be numeric, got: {value}")
    ...
    if 'admin-ssh-v1' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_SSH_V1:
            return (False, f"Invalid admin-ssh-v1 '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_SSH_V1)}")
    ...
    if 'admin-telnet' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_TELNET:
            return (False, f"Invalid admin-telnet '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_TELNET)}")
    ...
    if 'admin-telnet-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"admin-telnet-port must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"admin-telnet-port must be numeric, got: {value}")
    ...
    if 'admin-forticloud-sso-login' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_FORTICLOUD_SSO_LOGIN:
            return (False, f"Invalid admin-forticloud-sso-login '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_FORTICLOUD_SSO_LOGIN)}")
    ...
    if 'admin-forticloud-sso-default-profile' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 35:
            return (False, f"admin-forticloud-sso-default-profile cannot exceed 35 characters")
    ...
    if 'admin-reset-button' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_RESET_BUTTON:
            return (False, f"Invalid admin-reset-button '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_RESET_BUTTON)}")
    ...
    if 'admin-https-pki-required' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_HTTPS_PKI_REQUIRED:
            return (False, f"Invalid admin-https-pki-required '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_HTTPS_PKI_REQUIRED)}")
    ...
    if 'dhcp-lease-backup-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 10 or int_val > 3600:
                    return (False, f"dhcp-lease-backup-interval must be between 10 and 3600")
            except (ValueError, TypeError):
                return (False, f"dhcp-lease-backup-interval must be numeric, got: {value}")
    ...
    if 'auth-http-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"auth-http-port must be between 1 and 65535")
            except (ValueError, TypeError):
    ...
    if 'auth-https-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"auth-https-port must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"auth-https-port must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (False, f"auth-ike-saml-port must be between 0 and 65535")
            except (ValueError, TypeError):
                return (False, f"auth-ike-saml-port must be numeric, got: {value}")
    ...
    if 'auth-keepalive' in payload:
        ...
        if value and value not in VALID_BODY_AUTH_KEEPALIVE:
            return (False, f"Invalid auth-keepalive '{value}'. Must be one of: {', '.join(VALID_BODY_AUTH_KEEPALIVE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 100:
                    return (False, f"policy-auth-concurrent must be between 0 and 100")
            except (ValueError, TypeError):
                return (False, f"policy-auth-concurrent must be numeric, got: {value}")
    ...
    if 'auth-session-limit' in payload:
        ...
        if value and value not in VALID_BODY_AUTH_SESSION_LIMIT:
            return (False, f"Invalid auth-session-limit '{value}'. Must be one of: {', '.join(VALID_BODY_AUTH_SESSION_LIMIT)}")
    ...
    if 'clt-cert-req' in payload:
        ...
        if value and value not in VALID_BODY_CLT_CERT_REQ:
            return (False, f"Invalid clt-cert-req '{value}'. Must be one of: {', '.join(VALID_BODY_CLT_CERT_REQ)}")
    ...
    if 'fortiservice-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"fortiservice-port must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"fortiservice-port must be numeric, got: {value}")
    ...
    if 'cfg-save' in payload:
        ...
        if value and value not in VALID_BODY_CFG_SAVE:
            return (False, f"Invalid cfg-save '{value}'. Must be one of: {', '.join(VALID_BODY_CFG_SAVE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 10 or int_val > 4294967295:
                    return (False, f"cfg-revert-timeout must be between 10 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"cfg-revert-timeout must be numeric, got: {value}")
    ...
    if 'reboot-upon-config-restore' in payload:
        ...
        if value and value not in VALID_BODY_REBOOT_UPON_CONFIG_RESTORE:
            return (False, f"Invalid reboot-upon-config-restore '{value}'. Must be one of: {', '.join(VALID_BODY_REBOOT_UPON_CONFIG_RESTORE)}")
    ...
    if 'admin-scp' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN_SCP:
            return (False, f"Invalid admin-scp '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN_SCP)}")
    ...
    if 'wireless-controller' in payload:
        ...
        if value and value not in VALID_BODY_WIRELESS_CONTROLLER:
            return (False, f"Invalid wireless-controller '{value}'. Must be one of: {', '.join(VALID_BODY_WIRELESS_CONTROLLER)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1024 or int_val > 49150:
                    return (False, f"wireless-controller-port must be between 1024 and 49150")
            except (ValueError, TypeError):
                return (False, f"wireless-controller-port must be numeric, got: {value}")
    ...
    if 'fortiextender-data-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1024 or int_val > 49150:
                    return (False, f"fortiextender-data-port must be between 1024 and 49150")
            except (ValueError, TypeError):
                return (False, f"fortiextender-data-port must be numeric, got: {value}")
    ...
    if 'fortiextender' in payload:
        ...
        if value and value not in VALID_BODY_FORTIEXTENDER:
            return (False, f"Invalid fortiextender '{value}'. Must be one of: {', '.join(VALID_BODY_FORTIEXTENDER)}")
    ...
    if 'fortiextender-discovery-lockdown' in payload:
        ...
        if value and value not in VALID_BODY_FORTIEXTENDER_DISCOVERY_LOCKDOWN:
            return (False, f"Invalid fortiextender-discovery-lockdown '{value}'. Must be one of: {', '.join(VALID_BODY_FORTIEXTENDER_DISCOVERY_LOCKDOWN)}")
    ...
    if 'fortiextender-vlan-mode' in payload:
        ...
        if value and value not in VALID_BODY_FORTIEXTENDER_VLAN_MODE:
            return (False, f"Invalid fortiextender-vlan-mode '{value}'. Must be one of: {', '.join(VALID_BODY_FORTIEXTENDER_VLAN_MODE)}")
    ...
    if 'fortiextender-provision-on-authorization' in payload:
        ...
        if value and value not in VALID_BODY_FORTIEXTENDER_PROVISION_ON_AUTHORIZATION:
            return (False, f"Invalid fortiextender-provision-on-authorization '{value}'. Must be one of: {', '.join(VALID_BODY_FORTIEXTENDER_PROVISION_ON_AUTHORIZATION)}")
    ...
    if 'switch-controller' in payload:
        ...
        if value and value not in VALID_BODY_SWITCH_CONTROLLER:
            return (False, f"Invalid switch-controller '{value}'. Must be one of: {', '.join(VALID_BODY_SWITCH_CONTROLLER)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 8:
                    return (False, f"dnsproxy-worker-count must be between 1 and 8")
            except (ValueError, TypeError):
                return (False, f"dnsproxy-worker-count must be numeric, got: {value}")
    ...
    if 'url-filter-count' in payload:
        ...
        if value is not None:
            try:
                ...
                return (False, f"url-filter-count must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 128:
                    return (False, f"httpd-max-worker-count must be between 0 and 128")
            except (ValueError, TypeError):
                return (False, f"httpd-max-worker-count must be numeric, got: {value}")
    ...
    if 'proxy-worker-count' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 8:
                    return (False, f"proxy-worker-count must be between 1 and 8")
            except (ValueError, TypeError):
                return (False, f"proxy-worker-count must be numeric, got: {value}")
    ...
    if 'proxy-hardware-acceleration' in payload:
        ...
        if value and value not in VALID_BODY_PROXY_HARDWARE_ACCELERATION:
            return (False, f"Invalid proxy-hardware-acceleration '{value}'. Must be one of: {', '.join(VALID_BODY_PROXY_HARDWARE_ACCELERATION)}")
    ...
    if 'fgd-alert-subscription' in payload:
        ...
        if value and value not in VALID_BODY_FGD_ALERT_SUBSCRIPTION:
            return (False, f"Invalid fgd-alert-subscription '{value}'. Must be one of: {', '.join(VALID_BODY_FGD_ALERT_SUBSCRIPTION)}")
    ...
    if 'ipsec-hmac-offload' in payload:
        ...
        if value and value not in VALID_BODY_IPSEC_HMAC_OFFLOAD:
            return (False, f"Invalid ipsec-hmac-offload '{value}'. Must be one of: {', '.join(VALID_BODY_IPSEC_HMAC_OFFLOAD)}")
    ...
    if 'ipv6-accept-dad' in payload:
        ...
        if value is not None:
            try:
                ...
                return (False, f"ipv6-accept-dad must be numeric, got: {value}")
    ...
    if 'ipv6-allow-anycast-probe' in payload:
        ...
        if value and value not in VALID_BODY_IPV6_ALLOW_ANYCAST_PROBE:
            return (False, f"Invalid ipv6-allow-anycast-probe '{value}'. Must be one of: {', '.join(VALID_BODY_IPV6_ALLOW_ANYCAST_PROBE)}")
    ...
    if 'ipv6-allow-multicast-probe' in payload:
        ...
        if value and value not in VALID_BODY_IPV6_ALLOW_MULTICAST_PROBE:
            return (False, f"Invalid ipv6-allow-multicast-probe '{value}'. Must be one of: {', '.join(VALID_BODY_IPV6_ALLOW_MULTICAST_PROBE)}")
    ...
    if 'ipv6-allow-local-in-silent-drop' in payload:
        ...
        if value and value not in VALID_BODY_IPV6_ALLOW_LOCAL_IN_SILENT_DROP:
            return (False, f"Invalid ipv6-allow-local-in-silent-drop '{value}'. Must be one of: {', '.join(VALID_BODY_IPV6_ALLOW_LOCAL_IN_SILENT_DROP)}")
    ...
    if 'csr-ca-attribute' in payload:
        ...
        if value and value not in VALID_BODY_CSR_CA_ATTRIBUTE:
            return (False, f"Invalid csr-ca-attribute '{value}'. Must be one of: {', '.join(VALID_BODY_CSR_CA_ATTRIBUTE)}")
    ...
    if 'wimax-4g-usb' in payload:
        ...
        if value and value not in VALID_BODY_WIMAX_4G_USB:
            return (False, f"Invalid wimax-4g-usb '{value}'. Must be one of: {', '.join(VALID_BODY_WIMAX_4G_USB)}")
    ...
    if 'cert-chain-max' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 2147483647:
                    return (False, f"cert-chain-max must be between 1 and 2147483647")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 60 or int_val > 600:
                    return (False, f"two-factor-ftk-expiry must be between 60 and 600")
            except (ValueError, TypeError):
                return (False, f"two-factor-ftk-expiry must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 30 or int_val > 300:
                    return (False, f"two-factor-email-expiry must be between 30 and 300")
            except (ValueError, TypeError):
                return (False, f"two-factor-email-expiry must be numeric, got: {value}")
    ...
    if 'two-factor-sms-expiry' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 30 or int_val > 300:
                    return (False, f"two-factor-sms-expiry must be between 30 and 300")
            except (ValueError, TypeError):
                return (False, f"two-factor-sms-expiry must be numeric, got: {value}")
    ...
    if 'two-factor-fac-expiry' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 10 or int_val > 3600:
                    return (False, f"two-factor-fac-expiry must be between 10 and 3600")
            except (ValueError, TypeError):
                return (False, f"two-factor-fac-expiry must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 168:
                    return (False, f"two-factor-ftm-expiry must be between 1 and 168")
            except (ValueError, TypeError):
                return (False, f"two-factor-ftm-expiry must be numeric, got: {value}")
    ...
    if 'wad-worker-count' in payload:
        ...
        if value is not None:
            try:
                ...
                return (False, f"wad-worker-count must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 10240:
                    return (False, f"wad-worker-dev-cache must be between 0 and 10240")
            except (ValueError, TypeError):
                return (False, f"wad-worker-dev-cache must be numeric, got: {value}")
    ...
    if 'wad-csvc-cs-count' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 1:
                    return (False, f"wad-csvc-cs-count must be between 1 and 1")
            except (ValueError, TypeError):
                return (False, f"wad-csvc-cs-count must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 8:
                    return (False, f"wad-csvc-db-count must be between 0 and 8")
            except (ValueError, TypeError):
                return (False, f"wad-csvc-db-count must be numeric, got: {value}")
    ...
    if 'wad-source-affinity' in payload:
        ...
        if value and value not in VALID_BODY_WAD_SOURCE_AFFINITY:
            return (False, f"Invalid wad-source-affinity '{value}'. Must be one of: {', '.join(VALID_BODY_WAD_SOURCE_AFFINITY)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 5 or int_val > 25:
                    return (False, f"wad-memory-change-granularity must be between 5 and 25")
            except (ValueError, TypeError):
                return (False, f"wad-memory-change-granularity must be numeric, got: {value}")
    ...
    if 'login-timestamp' in payload:
        ...
        if value and value not in VALID_BODY_LOGIN_TIMESTAMP:
            return (False, f"Invalid login-timestamp '{value}'. Must be one of: {', '.join(VALID_BODY_LOGIN_TIMESTAMP)}")
    ...
    if 'ip-conflict-detection' in payload:
        ...
        if value and value not in VALID_BODY_IP_CONFLICT_DETECTION:
            return (False, f"Invalid ip-conflict-detection '{value}'. Must be one of: {', '.join(VALID_BODY_IP_CONFLICT_DETECTION)}")
    ...
    if 'miglogd-children' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 15:
                    return (False, f"miglogd-children must be between 0 and 15")
            except (ValueError, TypeError):
                return (False, f"miglogd-children must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 99:
                    return (False, f"log-daemon-cpu-threshold must be between 0 and 99")
            except (ValueError, TypeError):
                return (False, f"log-daemon-cpu-threshold must be numeric, got: {value}")
    ...
    if 'special-file-23-support' in payload:
        ...
        if value and value not in VALID_BODY_SPECIAL_FILE_23_SUPPORT:
            return (False, f"Invalid special-file-23-support '{value}'. Must be one of: {', '.join(VALID_BODY_SPECIAL_FILE_23_SUPPORT)}")
    ...
    if 'log-uuid-address' in payload:
        ...
        if value and value not in VALID_BODY_LOG_UUID_ADDRESS:
            return (False, f"Invalid log-uuid-address '{value}'. Must be one of: {', '.join(VALID_BODY_LOG_UUID_ADDRESS)}")
    ...
    if 'log-ssl-connection' in payload:
        ...
        if value and value not in VALID_BODY_LOG_SSL_CONNECTION:
            return (False, f"Invalid log-ssl-connection '{value}'. Must be one of: {', '.join(VALID_BODY_LOG_SSL_CONNECTION)}")
    ...
    if 'rest-api-key-url-query' in payload:
        ...
        if value and value not in VALID_BODY_REST_API_KEY_URL_QUERY:
            return (False, f"Invalid rest-api-key-url-query '{value}'. Must be one of: {', '.join(VALID_BODY_REST_API_KEY_URL_QUERY)}")
    ...
    if 'gui-cdn-domain-override' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 255:
            return (False, f"gui-cdn-domain-override cannot exceed 255 characters")
        ...
        if value is not None:
            try:
                ...
                if int_val < 131072 or int_val > 2147483647:
                    return (False, f"arp-max-entry must be between 131072 and 2147483647")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 65536 or int_val > 2147483647:
                    return (False, f"ndp-max-entry must be between 65536 and 2147483647")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 8192 or int_val > 2147483647:
                    return (False, f"br-fdb-max-entry must be between 8192 and 2147483647")
            except (ValueError, TypeError):
                return (False, f"br-fdb-max-entry must be numeric, got: {value}")
    ...
    if 'max-route-cache-size' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2147483647:
                    return (False, f"max-route-cache-size must be between 0 and 2147483647")
            except (ValueError, TypeError):
                return (False, f"max-route-cache-size must be numeric, got: {value}")
    ...
    if 'ipsec-asic-offload' in payload:
        ...
        if value and value not in VALID_BODY_IPSEC_ASIC_OFFLOAD:
            return (False, f"Invalid ipsec-asic-offload '{value}'. Must be one of: {', '.join(VALID_BODY_IPSEC_ASIC_OFFLOAD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 30 or int_val > 31536000:
                    return (False, f"device-idle-timeout must be between 30 and 31536000")
            except (ValueError, TypeError):
                return (False, f"device-idle-timeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 10135 or int_val > 28959:
                    return (False, f"user-device-store-max-devices must be between 10135 and 28959")
            except (ValueError, TypeError):
                return (False, f"user-device-store-max-devices must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 5:
                    return (False, f"user-device-store-max-device-mem must be between 1 and 5")
            except (ValueError, TypeError):
                return (False, f"user-device-store-max-device-mem must be numeric, got: {value}")
    ...
    if 'user-device-store-max-users' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 10135 or int_val > 28959:
                    return (False, f"user-device-store-max-users must be between 10135 and 28959")
            except (ValueError, TypeError):
                return (False, f"user-device-store-max-users must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 20271513 or int_val > 202715136:
                    return (False, f"user-device-store-max-unified-mem must be between 20271513 and 202715136")
            except (ValueError, TypeError):
                return (False, f"user-device-store-max-unified-mem must be numeric, got: {value}")
    ...
    if 'private-data-encryption' in payload:
        ...
        if value and value not in VALID_BODY_PRIVATE_DATA_ENCRYPTION:
            return (False, f"Invalid private-data-encryption '{value}'. Must be one of: {', '.join(VALID_BODY_PRIVATE_DATA_ENCRYPTION)}")
    ...
    if 'auto-auth-extension-device' in payload:
        ...
        if value and value not in VALID_BODY_AUTO_AUTH_EXTENSION_DEVICE:
            return (False, f"Invalid auto-auth-extension-device '{value}'. Must be one of: {', '.join(VALID_BODY_AUTO_AUTH_EXTENSION_DEVICE)}")
    ...
    if 'gui-theme' in payload:
        ...
        if value and value not in VALID_BODY_GUI_THEME:
            return (False, f"Invalid gui-theme '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_THEME)}")
    ...
    if 'gui-date-format' in payload:
        ...
        if value and value not in VALID_BODY_GUI_DATE_FORMAT:
            return (False, f"Invalid gui-date-format '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_DATE_FORMAT)}")
    ...
    if 'gui-date-time-source' in payload:
        ...
        if value and value not in VALID_BODY_GUI_DATE_TIME_SOURCE:
            return (False, f"Invalid gui-date-time-source '{value}'. Must be one of: {', '.join(VALID_BODY_GUI_DATE_TIME_SOURCE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 96 or int_val > 128000:
                    return (False, f"igmp-state-limit must be between 96 and 128000")
            except (ValueError, TypeError):
                return (False, f"igmp-state-limit must be numeric, got: {value}")
    ...
    if 'cloud-communication' in payload:
        ...
        if value and value not in VALID_BODY_CLOUD_COMMUNICATION:
            return (False, f"Invalid cloud-communication '{value}'. Must be one of: {', '.join(VALID_BODY_CLOUD_COMMUNICATION)}")
    ...
    if 'ipsec-ha-seqjump-rate' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 10:
                    return (False, f"ipsec-ha-seqjump-rate must be between 1 and 10")
            except (ValueError, TypeError):
                return (False, f"ipsec-ha-seqjump-rate must be numeric, got: {value}")
    ...
    if 'fortitoken-cloud' in payload:
        ...
        if value and value not in VALID_BODY_FORTITOKEN_CLOUD:
            return (False, f"Invalid fortitoken-cloud '{value}'. Must be one of: {', '.join(VALID_BODY_FORTITOKEN_CLOUD)}")
    ...
    if 'fortitoken-cloud-push-status' in payload:
        ...
        if value and value not in VALID_BODY_FORTITOKEN_CLOUD_PUSH_STATUS:
            return (False, f"Invalid fortitoken-cloud-push-status '{value}'. Must be one of: {', '.join(VALID_BODY_FORTITOKEN_CLOUD_PUSH_STATUS)}")
    ...
    if 'fortitoken-cloud-region' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 63:
            return (False, f"fortitoken-cloud-region cannot exceed 63 characters")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 336:
                    return (False, f"fortitoken-cloud-sync-interval must be between 0 and 336")
            except (ValueError, TypeError):
                return (False, f"fortitoken-cloud-sync-interval must be numeric, got: {value}")
    ...
    if 'irq-time-accounting' in payload:
        ...
        if value and value not in VALID_BODY_IRQ_TIME_ACCOUNTING:
            return (False, f"Invalid irq-time-accounting '{value}'. Must be one of: {', '.join(VALID_BODY_IRQ_TIME_ACCOUNTING)}")
    ...
    if 'management-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65535:
                    return (False, f"management-port must be between 1 and 65535")
            except (ValueError, TypeError):
                return (False, f"management-port must be numeric, got: {value}")
    ...
    if 'management-port-use-admin-sport' in payload:
        ...
        if value and value not in VALID_BODY_MANAGEMENT_PORT_USE_ADMIN_SPORT:
            return (False, f"Invalid management-port-use-admin-sport '{value}'. Must be one of: {', '.join(VALID_BODY_MANAGEMENT_PORT_USE_ADMIN_SPORT)}")
    ...
    if 'forticonverter-integration' in payload:
        ...
        if value and value not in VALID_BODY_FORTICONVERTER_INTEGRATION:
            return (False, f"Invalid forticonverter-integration '{value}'. Must be one of: {', '.join(VALID_BODY_FORTICONVERTER_INTEGRATION)}")
    ...
    if 'forticonverter-config-upload' in payload:
        ...
        if value and value not in VALID_BODY_FORTICONVERTER_CONFIG_UPLOAD:
            return (False, f"Invalid forticonverter-config-upload '{value}'. Must be one of: {', '.join(VALID_BODY_FORTICONVERTER_CONFIG_UPLOAD)}")
    ...
    if 'internet-service-database' in payload:
        ...
        if value and value not in VALID_BODY_INTERNET_SERVICE_DATABASE:
            return (False, f"Invalid internet-service-database '{value}'. Must be one of: {', '.join(VALID_BODY_INTERNET_SERVICE_DATABASE)}")
    ...
    if 'geoip-full-db' in payload:
        ...
        if value and value not in VALID_BODY_GEOIP_FULL_DB:
            return (False, f"Invalid geoip-full-db '{value}'. Must be one of: {', '.join(VALID_BODY_GEOIP_FULL_DB)}")
    ...
    if 'early-tcp-npu-session' in payload:
        ...
        if value and value not in VALID_BODY_EARLY_TCP_NPU_SESSION:
            return (False, f"Invalid early-tcp-npu-session '{value}'. Must be one of: {', '.join(VALID_BODY_EARLY_TCP_NPU_SESSION)}")
    ...
    if 'npu-neighbor-update' in payload:
        ...
        if value and value not in VALID_BODY_NPU_NEIGHBOR_UPDATE:
            return (False, f"Invalid npu-neighbor-update '{value}'. Must be one of: {', '.join(VALID_BODY_NPU_NEIGHBOR_UPDATE)}")
    ...
    if 'delay-tcp-npu-session' in payload:
        ...
        if value and value not in VALID_BODY_DELAY_TCP_NPU_SESSION:
            return (False, f"Invalid delay-tcp-npu-session '{value}'. Must be one of: {', '.join(VALID_BODY_DELAY_TCP_NPU_SESSION)}")
    ...
    if 'interface-subnet-usage' in payload:
        ...
        if value and value not in VALID_BODY_INTERFACE_SUBNET_USAGE:
            return (False, f"Invalid interface-subnet-usage '{value}'. Must be one of: {', '.join(VALID_BODY_INTERFACE_SUBNET_USAGE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 6:
                    return (False, f"sflowd-max-children-num must be between 0 and 6")
            except (ValueError, TypeError):
                return (False, f"sflowd-max-children-num must be numeric, got: {value}")
    ...
    if 'fortigslb-integration' in payload:
        ...
        if value and value not in VALID_BODY_FORTIGSLB_INTEGRATION:
            return (False, f"Invalid fortigslb-integration '{value}'. Must be one of: {', '.join(VALID_BODY_FORTIGSLB_INTEGRATION)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 3 or int_val > 15:
                    return (False, f"user-history-password-threshold must be between 3 and 15")
            except (ValueError, TypeError):
                return (False, f"user-history-password-threshold must be numeric, got: {value}")
    ...
    if 'auth-session-auto-backup' in payload:
        ...
        if value and value not in VALID_BODY_AUTH_SESSION_AUTO_BACKUP:
            return (False, f"Invalid auth-session-auto-backup '{value}'. Must be one of: {', '.join(VALID_BODY_AUTH_SESSION_AUTO_BACKUP)}")
    ...
    if 'auth-session-auto-backup-interval' in payload:
        ...
        if value and value not in VALID_BODY_AUTH_SESSION_AUTO_BACKUP_INTERVAL:
            return (False, f"Invalid auth-session-auto-backup-interval '{value}'. Must be one of: {', '.join(VALID_BODY_AUTH_SESSION_AUTO_BACKUP_INTERVAL)}")
    ...
    if 'scim-https-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"scim-https-port must be between 0 and 65535")
            except (ValueError, TypeError):
                return (False, f"scim-https-port must be numeric, got: {value}")
    ...
    if 'scim-http-port' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"scim-http-port must be between 0 and 65535")
            except (ValueError, TypeError):
    ...
    if 'application-bandwidth-tracking' in payload:
        ...
        if value and value not in VALID_BODY_APPLICATION_BANDWIDTH_TRACKING:
            return (False, f"Invalid application-bandwidth-tracking '{value}'. Must be one of: {', '.join(VALID_BODY_APPLICATION_BANDWIDTH_TRACKING)}")
    ...
    if 'tls-session-cache' in payload:
        ...
        if value and value not in VALID_BODY_TLS_SESSION_CACHE:
            return (False, f"Invalid tls-session-cache '{value}'. Must be one of: {', '.join(VALID_BODY_TLS_SESSION_CACHE)}")
