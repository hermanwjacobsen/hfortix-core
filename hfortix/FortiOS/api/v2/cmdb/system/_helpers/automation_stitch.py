...
def validate_automation_stitch_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'condition-logic' in payload:
        ...
        if value and value not in VALID_BODY_CONDITION_LOGIC:
            return (False, f"Invalid condition-logic '{value}'. Must be one of: {', '.join(VALID_BODY_CONDITION_LOGIC)}")
...
def validate_automation_stitch_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
