...
def validate_pppoe_interface_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'ipv6' in payload:
        ...
        if value and value not in VALID_BODY_IPV6:
            return (False, f"Invalid ipv6 '{value}'. Must be one of: {', '.join(VALID_BODY_IPV6)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"idle-timeout must be between 0 and 4294967295")
...
def validate_pppoe_interface_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
