...
def validate_replacemsg_fortiguard_wf_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'header' in payload:
        ...
        if value and value not in VALID_BODY_HEADER:
            return (False, f"Invalid header '{value}'. Must be one of: {', '.join(VALID_BODY_HEADER)}")
