...
VALID_BODY_OBJECT = ['log.fortianalyzer.setting', 'log.fortianalyzer.override-setting', 'log.fortianalyzer2.setting', 'log.fortianalyzer2.override-setting', 'log.fortianalyzer3.setting', 'log.fortianalyzer3.override-setting', 'log.fortianalyzer-cloud.setting', 'log.fortianalyzer-cloud.override-setting', 'log.syslogd.setting', 'log.syslogd.override-setting', 'log.syslogd2.setting', 'log.syslogd2.override-setting', 'log.syslogd3.setting', 'log.syslogd3.override-setting', 'log.syslogd4.setting', 'log.syslogd4.override-setting', 'system.gre-tunnel', 'system.central-management', 'system.csf', 'user.radius', 'system.interface', 'log.syslogd.setting', 'log.syslogd.override-setting', 'firewall.address']
...
def validate_vdom_exception_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'object' in payload:
        ...
        if value and value not in VALID_BODY_OBJECT:
            return (False, f"Invalid object '{value}'. Must be one of: {', '.join(VALID_BODY_OBJECT)}")
...
def validate_vdom_exception_delete(id: str | None = None) -> tuple[bool, str | None]:
    """
