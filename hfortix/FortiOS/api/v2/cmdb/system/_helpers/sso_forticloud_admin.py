...
def validate_sso_forticloud_admin_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_sso_forticloud_admin_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
