...
def validate_storage_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'media-status' in payload:
        ...
        if value and value not in VALID_BODY_MEDIA_STATUS:
            return (False, f"Invalid media-status '{value}'. Must be one of: {', '.join(VALID_BODY_MEDIA_STATUS)}")
...
def validate_storage_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
