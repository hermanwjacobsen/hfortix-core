...
def validate_modem_put(
    ...
    if 'auto-dial' in payload:
        ...
        if value and value not in VALID_BODY_AUTO_DIAL:
            return (False, f"Invalid auto-dial '{value}'. Must be one of: {', '.join(VALID_BODY_AUTO_DIAL)}")
    ...
    if 'dial-on-demand' in payload:
        ...
        if value and value not in VALID_BODY_DIAL_ON_DEMAND:
            return (False, f"Invalid dial-on-demand '{value}'. Must be one of: {', '.join(VALID_BODY_DIAL_ON_DEMAND)}")
    ...
    if 'redial' in payload:
        ...
        if value and value not in VALID_BODY_REDIAL:
            return (False, f"Invalid redial '{value}'. Must be one of: {', '.join(VALID_BODY_REDIAL)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 30 or int_val > 255:
                    return (False, f"connect-timeout must be between 30 and 255")
            except (ValueError, TypeError):
                return (False, f"connect-timeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"wireless-port must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'dont-send-CR1' in payload:
        ...
        if value and value not in VALID_BODY_DONT_SEND_CR1:
            return (False, f"Invalid dont-send-CR1 '{value}'. Must be one of: {', '.join(VALID_BODY_DONT_SEND_CR1)}")
    ...
    if 'peer-modem1' in payload:
        ...
        if value and value not in VALID_BODY_PEER_MODEM1:
            return (False, f"Invalid peer-modem1 '{value}'. Must be one of: {', '.join(VALID_BODY_PEER_MODEM1)}")
    ...
    if 'ppp-echo-request1' in payload:
        ...
        if value and value not in VALID_BODY_PPP_ECHO_REQUEST1:
            return (False, f"Invalid ppp-echo-request1 '{value}'. Must be one of: {', '.join(VALID_BODY_PPP_ECHO_REQUEST1)}")
    ...
    if 'authtype1' in payload:
        ...
        if value and value not in VALID_BODY_AUTHTYPE1:
            return (False, f"Invalid authtype1 '{value}'. Must be one of: {', '.join(VALID_BODY_AUTHTYPE1)}")
    ...
    if 'dont-send-CR2' in payload:
        ...
        if value and value not in VALID_BODY_DONT_SEND_CR2:
            return (False, f"Invalid dont-send-CR2 '{value}'. Must be one of: {', '.join(VALID_BODY_DONT_SEND_CR2)}")
    ...
    if 'peer-modem2' in payload:
        ...
        if value and value not in VALID_BODY_PEER_MODEM2:
            return (False, f"Invalid peer-modem2 '{value}'. Must be one of: {', '.join(VALID_BODY_PEER_MODEM2)}")
    ...
    if 'ppp-echo-request2' in payload:
        ...
        if value and value not in VALID_BODY_PPP_ECHO_REQUEST2:
            return (False, f"Invalid ppp-echo-request2 '{value}'. Must be one of: {', '.join(VALID_BODY_PPP_ECHO_REQUEST2)}")
    ...
    if 'authtype2' in payload:
        ...
        if value and value not in VALID_BODY_AUTHTYPE2:
            return (False, f"Invalid authtype2 '{value}'. Must be one of: {', '.join(VALID_BODY_AUTHTYPE2)}")
    ...
    if 'dont-send-CR3' in payload:
        ...
        if value and value not in VALID_BODY_DONT_SEND_CR3:
            return (False, f"Invalid dont-send-CR3 '{value}'. Must be one of: {', '.join(VALID_BODY_DONT_SEND_CR3)}")
    ...
    if 'peer-modem3' in payload:
        ...
        if value and value not in VALID_BODY_PEER_MODEM3:
            return (False, f"Invalid peer-modem3 '{value}'. Must be one of: {', '.join(VALID_BODY_PEER_MODEM3)}")
    ...
    if 'ppp-echo-request3' in payload:
        ...
        if value and value not in VALID_BODY_PPP_ECHO_REQUEST3:
            return (False, f"Invalid ppp-echo-request3 '{value}'. Must be one of: {', '.join(VALID_BODY_PPP_ECHO_REQUEST3)}")
    
    # Validate altmode if present
    if 'altmode' in payload:
        value = payload.get('altmode')
        if value and value not in VALID_BODY_ALTMODE:
            return (False, f"Invalid altmode '{value}'. Must be one of: {', '.join(VALID_BODY_ALTMODE)}")
    ...
    if 'authtype3' in payload:
        ...
        if value and value not in VALID_BODY_AUTHTYPE3:
            return (False, f"Invalid authtype3 '{value}'. Must be one of: {', '.join(VALID_BODY_AUTHTYPE3)}")
    ...
    if 'traffic-check' in payload:
        ...
        if value and value not in VALID_BODY_TRAFFIC_CHECK:
            return (False, f"Invalid traffic-check '{value}'. Must be one of: {', '.join(VALID_BODY_TRAFFIC_CHECK)}")
