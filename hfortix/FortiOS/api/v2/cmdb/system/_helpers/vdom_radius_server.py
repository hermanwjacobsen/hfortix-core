...
def validate_vdom_radius_server_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_vdom_radius_server_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
