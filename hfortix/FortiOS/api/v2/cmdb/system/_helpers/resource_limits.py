    ...
    if 'ipsec-phase1' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"ipsec-phase1 must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'ipsec-phase2' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"ipsec-phase2 must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'ipsec-phase1-interface' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"ipsec-phase1-interface must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"ipsec-phase1-interface must be numeric, got: {value}")
    ...
    if 'ipsec-phase2-interface' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"ipsec-phase2-interface must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"ipsec-phase2-interface must be numeric, got: {value}")
    ...
    if 'dialup-tunnel' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"dialup-tunnel must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'firewall-policy' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"firewall-policy must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"firewall-policy must be numeric, got: {value}")
    ...
    if 'firewall-address' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"firewall-address must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"firewall-address must be numeric, got: {value}")
    ...
    if 'firewall-addrgrp' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"firewall-addrgrp must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"firewall-addrgrp must be numeric, got: {value}")
    ...
    if 'custom-service' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"custom-service must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'service-group' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"service-group must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'onetime-schedule' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"onetime-schedule must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"onetime-schedule must be numeric, got: {value}")
    ...
    if 'recurring-schedule' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"recurring-schedule must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"recurring-schedule must be numeric, got: {value}")
    ...
    if 'user-group' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"user-group must be between 0 and 4294967295")
            except (ValueError, TypeError):
    ...
    if 'log-disk-quota' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"log-disk-quota must be between 0 and 4294967295")
            except (ValueError, TypeError):
