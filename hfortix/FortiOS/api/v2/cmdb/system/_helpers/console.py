...
def validate_console_put(
    ...
    if 'output' in payload:
        ...
        if value and value not in VALID_BODY_OUTPUT:
            return (False, f"Invalid output '{value}'. Must be one of: {', '.join(VALID_BODY_OUTPUT)}")
    ...
    if 'fortiexplorer' in payload:
        ...
        if value and value not in VALID_BODY_FORTIEXPLORER:
            return (False, f"Invalid fortiexplorer '{value}'. Must be one of: {', '.join(VALID_BODY_FORTIEXPLORER)}")
