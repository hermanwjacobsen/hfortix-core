...
def validate_affinity_interrupt_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'default-affinity-cpumask' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 127:
            return (False, f"default-affinity-cpumask cannot exceed 127 characters")
...
def validate_affinity_interrupt_delete(id: str | None = None) -> tuple[bool, str | None]:
    """
