...
def validate_vdom_property_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 2147483647:
                    return (False, f"snmp-index must be between 1 and 2147483647")
...
def validate_vdom_property_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
