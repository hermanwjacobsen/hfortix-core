...
API Endpoints:
    GET    /system.snmp/user           - List all snmp user
    GET    /system.snmp/user/{name}   - Get specific snmp user
    POST   /system.snmp/user           - Create snmp user
    PUT    /system.snmp/user/{name}   - Update snmp user
    DELETE /system.snmp/user/{name}   - Delete snmp user
"""
...
class SnmpUser:
    ...
    def list(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        ...
        Returns:
            dict: API response with list of snmp user

        Examples:
            >>> # List all snmp user
            >>> result = fgt.api.cmdb.system.snmp_user.list()
