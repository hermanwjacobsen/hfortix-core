...
API Endpoints:
    GET    /system/ips           - List all ips
    GET    /system/ips/{name}   - Get specific ips
    POST   /system/ips           - Create ips
    PUT    /system/ips/{name}   - Update ips
    DELETE /system/ips/{name}   - Delete ips
"""
...
class Ips:
    ...
    def list(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        ...
        Returns:
            dict: API response with list of ips

        Examples:
            >>> # List all ips
            >>> result = fgt.api.cmdb.system.ips.list()
