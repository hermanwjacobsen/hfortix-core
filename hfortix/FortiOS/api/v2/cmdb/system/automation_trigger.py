...
API Endpoints:
    GET    /system/automation-trigger           - List all automation-trigger
    GET    /system/automation-trigger/{name}   - Get specific automation-trigger
    POST   /system/automation-trigger           - Create automation-trigger
    PUT    /system/automation-trigger/{name}   - Update automation-trigger
    DELETE /system/automation-trigger/{name}   - Delete automation-trigger
"""
...
class AutomationTrigger:
    ...
    def list(self, vdom: Optional[Union[str, bool]] = None, **kwargs: Any) -> dict[str, Any]:
        ...
        Returns:
            dict: API response with list of automation-trigger

        Examples:
            >>> # List all automation-trigger
            >>> result = fgt.api.cmdb.system.automation_trigger.list()
