...
def validate_rule_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'ip-based' in payload:
        ...
        if value and value not in VALID_BODY_IP_BASED:
            return (False, f"Invalid ip-based '{value}'. Must be one of: {', '.join(VALID_BODY_IP_BASED)}")
    ...
    if 'web-auth-cookie' in payload:
        ...
        if value and value not in VALID_BODY_WEB_AUTH_COOKIE:
            return (False, f"Invalid web-auth-cookie '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_AUTH_COOKIE)}")
    ...
    if 'cors-stateful' in payload:
        ...
        if value and value not in VALID_BODY_CORS_STATEFUL:
            return (False, f"Invalid cors-stateful '{value}'. Must be one of: {', '.join(VALID_BODY_CORS_STATEFUL)}")
    ...
    if 'cert-auth-cookie' in payload:
        ...
        if value and value not in VALID_BODY_CERT_AUTH_COOKIE:
            return (False, f"Invalid cert-auth-cookie '{value}'. Must be one of: {', '.join(VALID_BODY_CERT_AUTH_COOKIE)}")
    ...
    if 'transaction-based' in payload:
        ...
        if value and value not in VALID_BODY_TRANSACTION_BASED:
            return (False, f"Invalid transaction-based '{value}'. Must be one of: {', '.join(VALID_BODY_TRANSACTION_BASED)}")
    ...
    if 'web-portal' in payload:
        ...
        if value and value not in VALID_BODY_WEB_PORTAL:
            return (False, f"Invalid web-portal '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_PORTAL)}")
    ...
    if 'session-logout' in payload:
        ...
        if value and value not in VALID_BODY_SESSION_LOGOUT:
            return (False, f"Invalid session-logout '{value}'. Must be one of: {', '.join(VALID_BODY_SESSION_LOGOUT)}")
