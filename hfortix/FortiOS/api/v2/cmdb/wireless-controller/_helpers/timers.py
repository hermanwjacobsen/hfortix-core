        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 255:
                    return (False, f"nat-session-keep-alive must be between 0 and 255")
            except (ValueError, TypeError):
                return (False, f"nat-session-keep-alive must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 2 or int_val > 180:
                    return (False, f"discovery-interval must be between 2 and 180")
            except (ValueError, TypeError):
                return (False, f"discovery-interval must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 20 or int_val > 3600:
                    return (False, f"client-idle-timeout must be between 20 and 3600")
            except (ValueError, TypeError):
                return (False, f"client-idle-timeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 2 or int_val > 3600:
                    return (False, f"client-idle-rehome-timeout must be between 2 and 3600")
            except (ValueError, TypeError):
                return (False, f"client-idle-rehome-timeout must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"sta-offline-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"sta-offline-cleanup must be numeric, got: {value}")
    ...
    if 'sta-offline-ip2mac-cleanup' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"sta-offline-ip2mac-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"sta-offline-ip2mac-cleanup must be numeric, got: {value}")
    ...
    if 'sta-cap-cleanup' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"sta-cap-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"sta-cap-cleanup must be numeric, got: {value}")
    ...
    if 'rogue-ap-cleanup' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"rogue-ap-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"rogue-ap-cleanup must be numeric, got: {value}")
    ...
    if 'rogue-sta-cleanup' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"rogue-sta-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"rogue-sta-cleanup must be numeric, got: {value}")
    ...
    if 'wids-entry-cleanup' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"wids-entry-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"wids-entry-cleanup must be numeric, got: {value}")
    ...
    if 'ble-device-cleanup' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 4294967295:
                    return (False, f"ble-device-cleanup must be between 0 and 4294967295")
            except (ValueError, TypeError):
                return (False, f"ble-device-cleanup must be numeric, got: {value}")
    ...
    if 'sta-stats-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 255:
                    return (False, f"sta-stats-interval must be between 1 and 255")
            except (ValueError, TypeError):
                return (False, f"sta-stats-interval must be numeric, got: {value}")
    ...
    if 'vap-stats-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 255:
                    return (False, f"vap-stats-interval must be between 1 and 255")
            except (ValueError, TypeError):
                return (False, f"vap-stats-interval must be numeric, got: {value}")
    ...
    if 'radio-stats-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 255:
                    return (False, f"radio-stats-interval must be between 1 and 255")
            except (ValueError, TypeError):
                return (False, f"radio-stats-interval must be numeric, got: {value}")
    ...
    if 'sta-capability-interval' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 255:
                    return (False, f"sta-capability-interval must be between 1 and 255")
            except (ValueError, TypeError):
                return (False, f"sta-capability-interval must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 86400:
                    return (False, f"sta-locate-timer must be between 0 and 86400")
            except (ValueError, TypeError):
                return (False, f"sta-locate-timer must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 30 or int_val > 3600:
                    return (False, f"ipsec-intf-cleanup must be between 30 and 3600")
            except (ValueError, TypeError):
                return (False, f"ipsec-intf-cleanup must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 10 or int_val > 3600:
                    return (False, f"ble-scan-report-intv must be between 10 and 3600")
            except (ValueError, TypeError):
                return (False, f"ble-scan-report-intv must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 5 or int_val > 65535:
                    return (False, f"ap-reboot-wait-interval1 must be between 5 and 65535")
            except (ValueError, TypeError):
                return (False, f"ap-reboot-wait-interval1 must be numeric, got: {value}")
    ...
    if 'ap-reboot-wait-interval2' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 5 or int_val > 65535:
                    return (False, f"ap-reboot-wait-interval2 must be between 5 and 65535")
            except (ValueError, TypeError):
                return (False, f"ap-reboot-wait-interval2 must be numeric, got: {value}")
