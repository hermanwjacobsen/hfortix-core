...
def validate_hotspot20_h2qp_osu_provider_nai_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_hotspot20_h2qp_osu_provider_nai_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
