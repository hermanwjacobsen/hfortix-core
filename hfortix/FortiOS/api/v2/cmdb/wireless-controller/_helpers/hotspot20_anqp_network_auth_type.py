...
VALID_BODY_AUTH_TYPE = ['acceptance-of-terms', 'online-enrollment', 'http-redirection', 'dns-redirection']
...
def validate_hotspot20_anqp_network_auth_type_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_hotspot20_anqp_network_auth_type_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
