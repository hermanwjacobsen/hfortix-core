...
def validate_hotspot20_anqp_roaming_consortium_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
...
def validate_hotspot20_anqp_roaming_consortium_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
