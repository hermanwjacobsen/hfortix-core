        ...
        if value is not None:
            try:
                ...
                if int_val < 10 or int_val > 100:
                    return (False, f"trap-high-cpu-threshold must be between 10 and 100")
    ...
    if 'trap-high-mem-threshold' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 10 or int_val > 100:
                    return (False, f"trap-high-mem-threshold must be between 10 and 100")
            except (ValueError, TypeError):
                return (False, f"trap-high-mem-threshold must be numeric, got: {value}")
