...
def validate_wids_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
    ...
    if 'sensor-mode' in payload:
        ...
        if value and value not in VALID_BODY_SENSOR_MODE:
            return (False, f"Invalid sensor-mode '{value}'. Must be one of: {', '.join(VALID_BODY_SENSOR_MODE)}")
    
    # Validate ap-scan if present
    if 'ap-scan' in payload:
        value = payload.get('ap-scan')
        if value and value not in VALID_BODY_AP_SCAN:
            return (False, f"Invalid ap-scan '{value}'. Must be one of: {', '.join(VALID_BODY_AP_SCAN)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 10 or int_val > 3600:
                    return (False, f"ap-bgscan-period must be between 10 and 3600")
            except (ValueError, TypeError):
                return (False, f"ap-bgscan-period must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 10 or int_val > 1000:
                    return (False, f"ap-bgscan-duration must be between 10 and 1000")
            except (ValueError, TypeError):
                return (False, f"ap-bgscan-duration must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 1000:
                    return (False, f"ap-bgscan-idle must be between 0 and 1000")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 15 or int_val > 600:
                    return (False, f"ap-bgscan-report-intv must be between 15 and 600")
            except (ValueError, TypeError):
                return (False, f"ap-bgscan-report-intv must be numeric, got: {value}")
    ...
    if 'ap-fgscan-report-intv' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 15 or int_val > 600:
                    return (False, f"ap-fgscan-report-intv must be between 15 and 600")
            except (ValueError, TypeError):
                return (False, f"ap-fgscan-report-intv must be numeric, got: {value}")
    ...
    if 'ap-scan-passive' in payload:
        ...
        if value and value not in VALID_BODY_AP_SCAN_PASSIVE:
            return (False, f"Invalid ap-scan-passive '{value}'. Must be one of: {', '.join(VALID_BODY_AP_SCAN_PASSIVE)}")
    ...
    if 'ap-auto-suppress' in payload:
        ...
        if value and value not in VALID_BODY_AP_AUTO_SUPPRESS:
            return (False, f"Invalid ap-auto-suppress '{value}'. Must be one of: {', '.join(VALID_BODY_AP_AUTO_SUPPRESS)}")
    ...
    if 'wireless-bridge' in payload:
        ...
        if value and value not in VALID_BODY_WIRELESS_BRIDGE:
            return (False, f"Invalid wireless-bridge '{value}'. Must be one of: {', '.join(VALID_BODY_WIRELESS_BRIDGE)}")
    ...
    if 'deauth-broadcast' in payload:
        ...
        if value and value not in VALID_BODY_DEAUTH_BROADCAST:
            return (False, f"Invalid deauth-broadcast '{value}'. Must be one of: {', '.join(VALID_BODY_DEAUTH_BROADCAST)}")
    ...
    if 'null-ssid-probe-resp' in payload:
        ...
        if value and value not in VALID_BODY_NULL_SSID_PROBE_RESP:
            return (False, f"Invalid null-ssid-probe-resp '{value}'. Must be one of: {', '.join(VALID_BODY_NULL_SSID_PROBE_RESP)}")
    ...
    if 'long-duration-attack' in payload:
        ...
        if value and value not in VALID_BODY_LONG_DURATION_ATTACK:
            return (False, f"Invalid long-duration-attack '{value}'. Must be one of: {', '.join(VALID_BODY_LONG_DURATION_ATTACK)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1000 or int_val > 32767:
                    return (False, f"long-duration-thresh must be between 1000 and 32767")
            except (ValueError, TypeError):
                return (False, f"long-duration-thresh must be numeric, got: {value}")
    ...
    if 'invalid-mac-oui' in payload:
        ...
        if value and value not in VALID_BODY_INVALID_MAC_OUI:
            return (False, f"Invalid invalid-mac-oui '{value}'. Must be one of: {', '.join(VALID_BODY_INVALID_MAC_OUI)}")
    ...
    if 'weak-wep-iv' in payload:
        ...
        if value and value not in VALID_BODY_WEAK_WEP_IV:
            return (False, f"Invalid weak-wep-iv '{value}'. Must be one of: {', '.join(VALID_BODY_WEAK_WEP_IV)}")
    ...
    if 'auth-frame-flood' in payload:
        ...
        if value and value not in VALID_BODY_AUTH_FRAME_FLOOD:
            return (False, f"Invalid auth-frame-flood '{value}'. Must be one of: {', '.join(VALID_BODY_AUTH_FRAME_FLOOD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 5 or int_val > 120:
                    return (False, f"auth-flood-time must be between 5 and 120")
            except (ValueError, TypeError):
                return (False, f"auth-flood-time must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 100:
                    return (False, f"auth-flood-thresh must be between 1 and 100")
            except (ValueError, TypeError):
                return (False, f"auth-flood-thresh must be numeric, got: {value}")
    ...
    if 'assoc-frame-flood' in payload:
        ...
        if value and value not in VALID_BODY_ASSOC_FRAME_FLOOD:
            return (False, f"Invalid assoc-frame-flood '{value}'. Must be one of: {', '.join(VALID_BODY_ASSOC_FRAME_FLOOD)}")
    ...
    if 'assoc-flood-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 5 or int_val > 120:
                    return (False, f"assoc-flood-time must be between 5 and 120")
            except (ValueError, TypeError):
                return (False, f"assoc-flood-time must be numeric, got: {value}")
    ...
    if 'assoc-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 100:
                    return (False, f"assoc-flood-thresh must be between 1 and 100")
            except (ValueError, TypeError):
                return (False, f"assoc-flood-thresh must be numeric, got: {value}")
    ...
    if 'reassoc-flood' in payload:
        ...
        if value and value not in VALID_BODY_REASSOC_FLOOD:
            return (False, f"Invalid reassoc-flood '{value}'. Must be one of: {', '.join(VALID_BODY_REASSOC_FLOOD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 120:
                    return (False, f"reassoc-flood-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"reassoc-flood-time must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 65100:
                    return (False, f"reassoc-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"reassoc-flood-thresh must be numeric, got: {value}")
    ...
    if 'probe-flood' in payload:
        ...
        if value and value not in VALID_BODY_PROBE_FLOOD:
            return (False, f"Invalid probe-flood '{value}'. Must be one of: {', '.join(VALID_BODY_PROBE_FLOOD)}")
    ...
    if 'probe-flood-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 120:
                    return (False, f"probe-flood-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"probe-flood-time must be numeric, got: {value}")
    ...
    if 'probe-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"probe-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"probe-flood-thresh must be numeric, got: {value}")
    ...
    if 'bcn-flood' in payload:
        ...
        if value and value not in VALID_BODY_BCN_FLOOD:
            return (False, f"Invalid bcn-flood '{value}'. Must be one of: {', '.join(VALID_BODY_BCN_FLOOD)}")
    ...
    if 'bcn-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"bcn-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"bcn-flood-thresh must be numeric, got: {value}")
    ...
    if 'rts-flood' in payload:
        ...
        if value and value not in VALID_BODY_RTS_FLOOD:
            return (False, f"Invalid rts-flood '{value}'. Must be one of: {', '.join(VALID_BODY_RTS_FLOOD)}")
    ...
    if 'rts-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"rts-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"rts-flood-thresh must be numeric, got: {value}")
    ...
    if 'cts-flood' in payload:
        ...
        if value and value not in VALID_BODY_CTS_FLOOD:
            return (False, f"Invalid cts-flood '{value}'. Must be one of: {', '.join(VALID_BODY_CTS_FLOOD)}")
    ...
    if 'cts-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"cts-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"cts-flood-thresh must be numeric, got: {value}")
    ...
    if 'client-flood' in payload:
        ...
        if value and value not in VALID_BODY_CLIENT_FLOOD:
            return (False, f"Invalid client-flood '{value}'. Must be one of: {', '.join(VALID_BODY_CLIENT_FLOOD)}")
    ...
    if 'client-flood-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 120:
                    return (False, f"client-flood-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"client-flood-time must be numeric, got: {value}")
    ...
    if 'client-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"client-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"client-flood-thresh must be numeric, got: {value}")
    ...
    if 'block_ack-flood' in payload:
        ...
        if value and value not in VALID_BODY_BLOCK_ACK_FLOOD:
            return (False, f"Invalid block_ack-flood '{value}'. Must be one of: {', '.join(VALID_BODY_BLOCK_ACK_FLOOD)}")
    ...
    if 'block_ack-flood-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 120:
                    return (False, f"block_ack-flood-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"block_ack-flood-time must be numeric, got: {value}")
    ...
    if 'block_ack-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"block_ack-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"block_ack-flood-thresh must be numeric, got: {value}")
    ...
    if 'pspoll-flood' in payload:
        ...
        if value and value not in VALID_BODY_PSPOLL_FLOOD:
            return (False, f"Invalid pspoll-flood '{value}'. Must be one of: {', '.join(VALID_BODY_PSPOLL_FLOOD)}")
    ...
    if 'pspoll-flood-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 120:
                    return (False, f"pspoll-flood-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"pspoll-flood-time must be numeric, got: {value}")
    ...
    if 'pspoll-flood-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"pspoll-flood-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"pspoll-flood-thresh must be numeric, got: {value}")
    ...
    if 'netstumbler' in payload:
        ...
        if value and value not in VALID_BODY_NETSTUMBLER:
            return (False, f"Invalid netstumbler '{value}'. Must be one of: {', '.join(VALID_BODY_NETSTUMBLER)}")
    ...
    if 'netstumbler-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 120:
                    return (False, f"netstumbler-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"netstumbler-time must be numeric, got: {value}")
    ...
    if 'netstumbler-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"netstumbler-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"netstumbler-thresh must be numeric, got: {value}")
    ...
    if 'wellenreiter' in payload:
        ...
        if value and value not in VALID_BODY_WELLENREITER:
            return (False, f"Invalid wellenreiter '{value}'. Must be one of: {', '.join(VALID_BODY_WELLENREITER)}")
    ...
    if 'wellenreiter-time' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 120:
                    return (False, f"wellenreiter-time must be between 1 and 120")
            except (ValueError, TypeError):
                return (False, f"wellenreiter-time must be numeric, got: {value}")
    ...
    if 'wellenreiter-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 65100:
                    return (False, f"wellenreiter-thresh must be between 1 and 65100")
            except (ValueError, TypeError):
                return (False, f"wellenreiter-thresh must be numeric, got: {value}")
    ...
    if 'spoofed-deauth' in payload:
        ...
        if value and value not in VALID_BODY_SPOOFED_DEAUTH:
            return (False, f"Invalid spoofed-deauth '{value}'. Must be one of: {', '.join(VALID_BODY_SPOOFED_DEAUTH)}")
    ...
    if 'asleap-attack' in payload:
        ...
        if value and value not in VALID_BODY_ASLEAP_ATTACK:
            return (False, f"Invalid asleap-attack '{value}'. Must be one of: {', '.join(VALID_BODY_ASLEAP_ATTACK)}")
    ...
    if 'eapol-start-flood' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_START_FLOOD:
            return (False, f"Invalid eapol-start-flood '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_START_FLOOD)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 2 or int_val > 100:
                    return (False, f"eapol-start-thresh must be between 2 and 100")
            except (ValueError, TypeError):
                return (False, f"eapol-start-thresh must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 1 or int_val > 3600:
                    return (False, f"eapol-start-intv must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"eapol-start-intv must be numeric, got: {value}")
    ...
    if 'eapol-logoff-flood' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_LOGOFF_FLOOD:
            return (False, f"Invalid eapol-logoff-flood '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_LOGOFF_FLOOD)}")
    ...
    if 'eapol-logoff-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 2 or int_val > 100:
                    return (False, f"eapol-logoff-thresh must be between 2 and 100")
            except (ValueError, TypeError):
                return (False, f"eapol-logoff-thresh must be numeric, got: {value}")
    ...
    if 'eapol-logoff-intv' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 3600:
                    return (False, f"eapol-logoff-intv must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"eapol-logoff-intv must be numeric, got: {value}")
    ...
    if 'eapol-succ-flood' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_SUCC_FLOOD:
            return (False, f"Invalid eapol-succ-flood '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_SUCC_FLOOD)}")
    ...
    if 'eapol-succ-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 2 or int_val > 100:
                    return (False, f"eapol-succ-thresh must be between 2 and 100")
            except (ValueError, TypeError):
                return (False, f"eapol-succ-thresh must be numeric, got: {value}")
    ...
    if 'eapol-succ-intv' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 3600:
                    return (False, f"eapol-succ-intv must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"eapol-succ-intv must be numeric, got: {value}")
    ...
    if 'eapol-fail-flood' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_FAIL_FLOOD:
            return (False, f"Invalid eapol-fail-flood '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_FAIL_FLOOD)}")
    ...
    if 'eapol-fail-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 2 or int_val > 100:
                    return (False, f"eapol-fail-thresh must be between 2 and 100")
            except (ValueError, TypeError):
                return (False, f"eapol-fail-thresh must be numeric, got: {value}")
    ...
    if 'eapol-fail-intv' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 3600:
                    return (False, f"eapol-fail-intv must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"eapol-fail-intv must be numeric, got: {value}")
    ...
    if 'eapol-pre-succ-flood' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_PRE_SUCC_FLOOD:
            return (False, f"Invalid eapol-pre-succ-flood '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_PRE_SUCC_FLOOD)}")
    ...
    if 'eapol-pre-succ-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 2 or int_val > 100:
                    return (False, f"eapol-pre-succ-thresh must be between 2 and 100")
            except (ValueError, TypeError):
                return (False, f"eapol-pre-succ-thresh must be numeric, got: {value}")
    ...
    if 'eapol-pre-succ-intv' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 3600:
                    return (False, f"eapol-pre-succ-intv must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"eapol-pre-succ-intv must be numeric, got: {value}")
    ...
    if 'eapol-pre-fail-flood' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_PRE_FAIL_FLOOD:
            return (False, f"Invalid eapol-pre-fail-flood '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_PRE_FAIL_FLOOD)}")
    ...
    if 'eapol-pre-fail-thresh' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 2 or int_val > 100:
                    return (False, f"eapol-pre-fail-thresh must be between 2 and 100")
            except (ValueError, TypeError):
                return (False, f"eapol-pre-fail-thresh must be numeric, got: {value}")
    ...
    if 'eapol-pre-fail-intv' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 1 or int_val > 3600:
                    return (False, f"eapol-pre-fail-intv must be between 1 and 3600")
            except (ValueError, TypeError):
                return (False, f"eapol-pre-fail-intv must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (False, f"deauth-unknown-src-thresh must be between 0 and 65535")
            except (ValueError, TypeError):
                return (False, f"deauth-unknown-src-thresh must be numeric, got: {value}")
    ...
    if 'windows-bridge' in payload:
        ...
        if value and value not in VALID_BODY_WINDOWS_BRIDGE:
            return (False, f"Invalid windows-bridge '{value}'. Must be one of: {', '.join(VALID_BODY_WINDOWS_BRIDGE)}")
    ...
    if 'disassoc-broadcast' in payload:
        ...
        if value and value not in VALID_BODY_DISASSOC_BROADCAST:
            return (False, f"Invalid disassoc-broadcast '{value}'. Must be one of: {', '.join(VALID_BODY_DISASSOC_BROADCAST)}")
    ...
    if 'ap-spoofing' in payload:
        ...
        if value and value not in VALID_BODY_AP_SPOOFING:
            return (False, f"Invalid ap-spoofing '{value}'. Must be one of: {', '.join(VALID_BODY_AP_SPOOFING)}")
    ...
    if 'chan-based-mitm' in payload:
        ...
        if value and value not in VALID_BODY_CHAN_BASED_MITM:
            return (False, f"Invalid chan-based-mitm '{value}'. Must be one of: {', '.join(VALID_BODY_CHAN_BASED_MITM)}")
    ...
    if 'adhoc-valid-ssid' in payload:
        ...
        if value and value not in VALID_BODY_ADHOC_VALID_SSID:
            return (False, f"Invalid adhoc-valid-ssid '{value}'. Must be one of: {', '.join(VALID_BODY_ADHOC_VALID_SSID)}")
    ...
    if 'adhoc-network' in payload:
        ...
        if value and value not in VALID_BODY_ADHOC_NETWORK:
            return (False, f"Invalid adhoc-network '{value}'. Must be one of: {', '.join(VALID_BODY_ADHOC_NETWORK)}")
    ...
    if 'eapol-key-overflow' in payload:
        ...
        if value and value not in VALID_BODY_EAPOL_KEY_OVERFLOW:
            return (False, f"Invalid eapol-key-overflow '{value}'. Must be one of: {', '.join(VALID_BODY_EAPOL_KEY_OVERFLOW)}")
    ...
    if 'ap-impersonation' in payload:
        ...
        if value and value not in VALID_BODY_AP_IMPERSONATION:
            return (False, f"Invalid ap-impersonation '{value}'. Must be one of: {', '.join(VALID_BODY_AP_IMPERSONATION)}")
    ...
    if 'invalid-addr-combination' in payload:
        ...
        if value and value not in VALID_BODY_INVALID_ADDR_COMBINATION:
            return (False, f"Invalid invalid-addr-combination '{value}'. Must be one of: {', '.join(VALID_BODY_INVALID_ADDR_COMBINATION)}")
    ...
    if 'beacon-wrong-channel' in payload:
        ...
        if value and value not in VALID_BODY_BEACON_WRONG_CHANNEL:
            return (False, f"Invalid beacon-wrong-channel '{value}'. Must be one of: {', '.join(VALID_BODY_BEACON_WRONG_CHANNEL)}")
    ...
    if 'ht-greenfield' in payload:
        ...
        if value and value not in VALID_BODY_HT_GREENFIELD:
            return (False, f"Invalid ht-greenfield '{value}'. Must be one of: {', '.join(VALID_BODY_HT_GREENFIELD)}")
    ...
    if 'overflow-ie' in payload:
        ...
        if value and value not in VALID_BODY_OVERFLOW_IE:
            return (False, f"Invalid overflow-ie '{value}'. Must be one of: {', '.join(VALID_BODY_OVERFLOW_IE)}")
    ...
    if 'malformed-ht-ie' in payload:
        ...
        if value and value not in VALID_BODY_MALFORMED_HT_IE:
            return (False, f"Invalid malformed-ht-ie '{value}'. Must be one of: {', '.join(VALID_BODY_MALFORMED_HT_IE)}")
    ...
    if 'malformed-auth' in payload:
        ...
        if value and value not in VALID_BODY_MALFORMED_AUTH:
            return (False, f"Invalid malformed-auth '{value}'. Must be one of: {', '.join(VALID_BODY_MALFORMED_AUTH)}")
    ...
    if 'malformed-association' in payload:
        ...
        if value and value not in VALID_BODY_MALFORMED_ASSOCIATION:
            return (False, f"Invalid malformed-association '{value}'. Must be one of: {', '.join(VALID_BODY_MALFORMED_ASSOCIATION)}")
    ...
    if 'ht-40mhz-intolerance' in payload:
        ...
        if value and value not in VALID_BODY_HT_40MHZ_INTOLERANCE:
            return (False, f"Invalid ht-40mhz-intolerance '{value}'. Must be one of: {', '.join(VALID_BODY_HT_40MHZ_INTOLERANCE)}")
    ...
    if 'valid-ssid-misuse' in payload:
        ...
        if value and value not in VALID_BODY_VALID_SSID_MISUSE:
            return (False, f"Invalid valid-ssid-misuse '{value}'. Must be one of: {', '.join(VALID_BODY_VALID_SSID_MISUSE)}")
    ...
    if 'valid-client-misassociation' in payload:
        ...
        if value and value not in VALID_BODY_VALID_CLIENT_MISASSOCIATION:
            return (False, f"Invalid valid-client-misassociation '{value}'. Must be one of: {', '.join(VALID_BODY_VALID_CLIENT_MISASSOCIATION)}")
    ...
    if 'hotspotter-attack' in payload:
        ...
        if value and value not in VALID_BODY_HOTSPOTTER_ATTACK:
            return (False, f"Invalid hotspotter-attack '{value}'. Must be one of: {', '.join(VALID_BODY_HOTSPOTTER_ATTACK)}")
    ...
    if 'pwsave-dos-attack' in payload:
        ...
        if value and value not in VALID_BODY_PWSAVE_DOS_ATTACK:
            return (False, f"Invalid pwsave-dos-attack '{value}'. Must be one of: {', '.join(VALID_BODY_PWSAVE_DOS_ATTACK)}")
    ...
    if 'omerta-attack' in payload:
        ...
        if value and value not in VALID_BODY_OMERTA_ATTACK:
            return (False, f"Invalid omerta-attack '{value}'. Must be one of: {', '.join(VALID_BODY_OMERTA_ATTACK)}")
    ...
    if 'disconnect-station' in payload:
        ...
        if value and value not in VALID_BODY_DISCONNECT_STATION:
            return (False, f"Invalid disconnect-station '{value}'. Must be one of: {', '.join(VALID_BODY_DISCONNECT_STATION)}")
    ...
    if 'unencrypted-valid' in payload:
        ...
        if value and value not in VALID_BODY_UNENCRYPTED_VALID:
            return (False, f"Invalid unencrypted-valid '{value}'. Must be one of: {', '.join(VALID_BODY_UNENCRYPTED_VALID)}")
    ...
    if 'fata-jack' in payload:
        ...
        if value and value not in VALID_BODY_FATA_JACK:
            return (False, f"Invalid fata-jack '{value}'. Must be one of: {', '.join(VALID_BODY_FATA_JACK)}")
    ...
    if 'risky-encryption' in payload:
        ...
        if value and value not in VALID_BODY_RISKY_ENCRYPTION:
            return (False, f"Invalid risky-encryption '{value}'. Must be one of: {', '.join(VALID_BODY_RISKY_ENCRYPTION)}")
    ...
    if 'fuzzed-beacon' in payload:
        ...
        if value and value not in VALID_BODY_FUZZED_BEACON:
            return (False, f"Invalid fuzzed-beacon '{value}'. Must be one of: {', '.join(VALID_BODY_FUZZED_BEACON)}")
    ...
    if 'fuzzed-probe-request' in payload:
        ...
        if value and value not in VALID_BODY_FUZZED_PROBE_REQUEST:
            return (False, f"Invalid fuzzed-probe-request '{value}'. Must be one of: {', '.join(VALID_BODY_FUZZED_PROBE_REQUEST)}")
    ...
    if 'fuzzed-probe-response' in payload:
        ...
        if value and value not in VALID_BODY_FUZZED_PROBE_RESPONSE:
            return (False, f"Invalid fuzzed-probe-response '{value}'. Must be one of: {', '.join(VALID_BODY_FUZZED_PROBE_RESPONSE)}")
    ...
    if 'air-jack' in payload:
        ...
        if value and value not in VALID_BODY_AIR_JACK:
            return (False, f"Invalid air-jack '{value}'. Must be one of: {', '.join(VALID_BODY_AIR_JACK)}")
    ...
    if 'wpa-ft-attack' in payload:
        ...
        if value and value not in VALID_BODY_WPA_FT_ATTACK:
            return (False, f"Invalid wpa-ft-attack '{value}'. Must be one of: {', '.join(VALID_BODY_WPA_FT_ATTACK)}")
...
def validate_wids_profile_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
