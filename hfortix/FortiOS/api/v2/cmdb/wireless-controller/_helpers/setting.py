...
def validate_setting_put(
    ...
    if 'country' in payload:
        ...
        if value and value not in VALID_BODY_COUNTRY:
            return (False, f"Invalid country '{value}'. Must be one of: {', '.join(VALID_BODY_COUNTRY)}")
    ...
    if 'duplicate-ssid' in payload:
        ...
        if value and value not in VALID_BODY_DUPLICATE_SSID:
            return (False, f"Invalid duplicate-ssid '{value}'. Must be one of: {', '.join(VALID_BODY_DUPLICATE_SSID)}")
    ...
    if 'fapc-compatibility' in payload:
        ...
        if value and value not in VALID_BODY_FAPC_COMPATIBILITY:
            return (False, f"Invalid fapc-compatibility '{value}'. Must be one of: {', '.join(VALID_BODY_FAPC_COMPATIBILITY)}")
    ...
    if 'wfa-compatibility' in payload:
        ...
        if value and value not in VALID_BODY_WFA_COMPATIBILITY:
            return (False, f"Invalid wfa-compatibility '{value}'. Must be one of: {', '.join(VALID_BODY_WFA_COMPATIBILITY)}")
    ...
    if 'phishing-ssid-detect' in payload:
        ...
        if value and value not in VALID_BODY_PHISHING_SSID_DETECT:
            return (False, f"Invalid phishing-ssid-detect '{value}'. Must be one of: {', '.join(VALID_BODY_PHISHING_SSID_DETECT)}")
    ...
    if 'fake-ssid-action' in payload:
        ...
        if value and value not in VALID_BODY_FAKE_SSID_ACTION:
            return (False, f"Invalid fake-ssid-action '{value}'. Must be one of: {', '.join(VALID_BODY_FAKE_SSID_ACTION)}")
