...
def validate_arrp_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    """
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 65535:
                    return (False, f"selection-period must be between 0 and 65535")
            except (ValueError, TypeError):
                return (False, f"selection-period must be numeric, got: {value}")
    ...
    if 'monitor-period' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 65535:
                    return (False, f"monitor-period must be between 0 and 65535")
            except (ValueError, TypeError):
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-managed-ap must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-managed-ap must be numeric, got: {value}")
    ...
    if 'weight-rogue-ap' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-rogue-ap must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-rogue-ap must be numeric, got: {value}")
    ...
    if 'weight-noise-floor' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-noise-floor must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-noise-floor must be numeric, got: {value}")
    ...
    if 'weight-channel-load' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-channel-load must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-channel-load must be numeric, got: {value}")
    ...
    if 'weight-spectral-rssi' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-spectral-rssi must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-spectral-rssi must be numeric, got: {value}")
    ...
    if 'weight-weather-channel' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-weather-channel must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-weather-channel must be numeric, got: {value}")
    ...
    if 'weight-dfs-channel' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 2000:
                    return (False, f"weight-dfs-channel must be between 0 and 2000")
            except (ValueError, TypeError):
                return (False, f"weight-dfs-channel must be numeric, got: {value}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 100:
                    return (False, f"threshold-channel-load must be between 0 and 100")
            except (ValueError, TypeError):
                return (False, f"threshold-channel-load must be numeric, got: {value}")
    ...
    if 'threshold-spectral-rssi' in payload:
        ...
        if value and isinstance(value, str) and len(value) > 7:
            return (False, f"threshold-spectral-rssi cannot exceed 7 characters")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 1000:
                    return (False, f"threshold-tx-retries must be between 0 and 1000")
            except (ValueError, TypeError):
                return (False, f"threshold-tx-retries must be numeric, got: {value}")
    ...
    if 'threshold-rx-errors' in payload:
        ...
        if value is not None:
            try:
                int_val = int(value)
                if int_val < 0 or int_val > 100:
                    return (False, f"threshold-rx-errors must be between 0 and 100")
            except (ValueError, TypeError):
                return (False, f"threshold-rx-errors must be numeric, got: {value}")
    ...
    if 'include-weather-channel' in payload:
        ...
        if value and value not in VALID_BODY_INCLUDE_WEATHER_CHANNEL:
            return (False, f"Invalid include-weather-channel '{value}'. Must be one of: {', '.join(VALID_BODY_INCLUDE_WEATHER_CHANNEL)}")
    ...
    if 'include-dfs-channel' in payload:
        ...
        if value and value not in VALID_BODY_INCLUDE_DFS_CHANNEL:
            return (False, f"Invalid include-dfs-channel '{value}'. Must be one of: {', '.join(VALID_BODY_INCLUDE_DFS_CHANNEL)}")
    ...
    if 'override-darrp-optimize' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_DARRP_OPTIMIZE:
            return (False, f"Invalid override-darrp-optimize '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_DARRP_OPTIMIZE)}")
        ...
        if value is not None:
            try:
                ...
                if int_val < 0 or int_val > 86400:
                    return (False, f"darrp-optimize must be between 0 and 86400")
            except (ValueError, TypeError):
...
def validate_arrp_profile_delete(name: str | None = None) -> tuple[bool, str | None]:
    """
