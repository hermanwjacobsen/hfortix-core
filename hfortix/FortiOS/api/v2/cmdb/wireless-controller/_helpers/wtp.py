...
def validate_wtp_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'admin' in payload:
        ...
        if value and value not in VALID_BODY_ADMIN:
            return (False, f"Invalid admin '{value}'. Must be one of: {', '.join(VALID_BODY_ADMIN)}")
    ...
    if 'override-led-state' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_LED_STATE:
            return (False, f"Invalid override-led-state '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_LED_STATE)}")
    ...
    if 'override-wan-port-mode' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_WAN_PORT_MODE:
            return (False, f"Invalid override-wan-port-mode '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_WAN_PORT_MODE)}")
    ...
    if 'override-ip-fragment' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_IP_FRAGMENT:
            return (False, f"Invalid override-ip-fragment '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_IP_FRAGMENT)}")
    ...
    if 'override-split-tunnel' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_SPLIT_TUNNEL:
            return (False, f"Invalid override-split-tunnel '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_SPLIT_TUNNEL)}")
    ...
    if 'override-lan' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_LAN:
            return (False, f"Invalid override-lan '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_LAN)}")
    ...
    if 'override-allowaccess' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_ALLOWACCESS:
            return (False, f"Invalid override-allowaccess '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_ALLOWACCESS)}")
    ...
    if 'override-login-passwd-change' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_LOGIN_PASSWD_CHANGE:
            return (False, f"Invalid override-login-passwd-change '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_LOGIN_PASSWD_CHANGE)}")
    ...
    if 'override-default-mesh-root' in payload:
        ...
        if value and value not in VALID_BODY_OVERRIDE_DEFAULT_MESH_ROOT:
            return (False, f"Invalid override-default-mesh-root '{value}'. Must be one of: {', '.join(VALID_BODY_OVERRIDE_DEFAULT_MESH_ROOT)}")
    ...
    if 'mesh-bridge-enable' in payload:
        ...
        if value and value not in VALID_BODY_MESH_BRIDGE_ENABLE:
            return (False, f"Invalid mesh-bridge-enable '{value}'. Must be one of: {', '.join(VALID_BODY_MESH_BRIDGE_ENABLE)}")
