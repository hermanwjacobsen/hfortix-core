...
def validate_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'monitor-all-messages' in payload:
        ...
        if value and value not in VALID_BODY_MONITOR_ALL_MESSAGES:
            return (False, f"Invalid monitor-all-messages '{value}'. Must be one of: {', '.join(VALID_BODY_MONITOR_ALL_MESSAGES)}")
    ...
    if 'track-requests-answers' in payload:
        ...
        if value and value not in VALID_BODY_TRACK_REQUESTS_ANSWERS:
            return (False, f"Invalid track-requests-answers '{value}'. Must be one of: {', '.join(VALID_BODY_TRACK_REQUESTS_ANSWERS)}")
    ...
    if 'missing-request-action' in payload:
        ...
        if value and value not in VALID_BODY_MISSING_REQUEST_ACTION:
            return (False, f"Invalid missing-request-action '{value}'. Must be one of: {', '.join(VALID_BODY_MISSING_REQUEST_ACTION)}")
    ...
    if 'protocol-version-invalid' in payload:
        ...
        if value and value not in VALID_BODY_PROTOCOL_VERSION_INVALID:
            return (False, f"Invalid protocol-version-invalid '{value}'. Must be one of: {', '.join(VALID_BODY_PROTOCOL_VERSION_INVALID)}")
    ...
    if 'message-length-invalid' in payload:
        ...
        if value and value not in VALID_BODY_MESSAGE_LENGTH_INVALID:
            return (False, f"Invalid message-length-invalid '{value}'. Must be one of: {', '.join(VALID_BODY_MESSAGE_LENGTH_INVALID)}")
    ...
    if 'request-error-flag-set' in payload:
        ...
        if value and value not in VALID_BODY_REQUEST_ERROR_FLAG_SET:
            return (False, f"Invalid request-error-flag-set '{value}'. Must be one of: {', '.join(VALID_BODY_REQUEST_ERROR_FLAG_SET)}")
    ...
    if 'cmd-flags-reserve-set' in payload:
        ...
        if value and value not in VALID_BODY_CMD_FLAGS_RESERVE_SET:
            return (False, f"Invalid cmd-flags-reserve-set '{value}'. Must be one of: {', '.join(VALID_BODY_CMD_FLAGS_RESERVE_SET)}")
    ...
    if 'command-code-invalid' in payload:
        ...
        if value and value not in VALID_BODY_COMMAND_CODE_INVALID:
            return (False, f"Invalid command-code-invalid '{value}'. Must be one of: {', '.join(VALID_BODY_COMMAND_CODE_INVALID)}")
