...
def validate_list_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'other-application-action' in payload:
        ...
        if value and value not in VALID_BODY_OTHER_APPLICATION_ACTION:
            return (False, f"Invalid other-application-action '{value}'. Must be one of: {', '.join(VALID_BODY_OTHER_APPLICATION_ACTION)}")
    ...
    if 'app-replacemsg' in payload:
        ...
        if value and value not in VALID_BODY_APP_REPLACEMSG:
            return (False, f"Invalid app-replacemsg '{value}'. Must be one of: {', '.join(VALID_BODY_APP_REPLACEMSG)}")
    ...
    if 'other-application-log' in payload:
        ...
        if value and value not in VALID_BODY_OTHER_APPLICATION_LOG:
            return (False, f"Invalid other-application-log '{value}'. Must be one of: {', '.join(VALID_BODY_OTHER_APPLICATION_LOG)}")
    ...
    if 'force-inclusion-ssl-di-sigs' in payload:
        ...
        if value and value not in VALID_BODY_FORCE_INCLUSION_SSL_DI_SIGS:
            return (False, f"Invalid force-inclusion-ssl-di-sigs '{value}'. Must be one of: {', '.join(VALID_BODY_FORCE_INCLUSION_SSL_DI_SIGS)}")
    ...
    if 'unknown-application-action' in payload:
        ...
        if value and value not in VALID_BODY_UNKNOWN_APPLICATION_ACTION:
            return (False, f"Invalid unknown-application-action '{value}'. Must be one of: {', '.join(VALID_BODY_UNKNOWN_APPLICATION_ACTION)}")
    ...
    if 'unknown-application-log' in payload:
        ...
        if value and value not in VALID_BODY_UNKNOWN_APPLICATION_LOG:
            return (False, f"Invalid unknown-application-log '{value}'. Must be one of: {', '.join(VALID_BODY_UNKNOWN_APPLICATION_LOG)}")
    ...
    if 'p2p-block-list' in payload:
        ...
        if value and value not in VALID_BODY_P2P_BLOCK_LIST:
            return (False, f"Invalid p2p-block-list '{value}'. Must be one of: {', '.join(VALID_BODY_P2P_BLOCK_LIST)}")
    ...
    if 'deep-app-inspection' in payload:
        ...
        if value and value not in VALID_BODY_DEEP_APP_INSPECTION:
            return (False, f"Invalid deep-app-inspection '{value}'. Must be one of: {', '.join(VALID_BODY_DEEP_APP_INSPECTION)}")
    ...
    if 'control-default-network-services' in payload:
        ...
        if value and value not in VALID_BODY_CONTROL_DEFAULT_NETWORK_SERVICES:
            return (False, f"Invalid control-default-network-services '{value}'. Must be one of: {', '.join(VALID_BODY_CONTROL_DEFAULT_NETWORK_SERVICES)}")
