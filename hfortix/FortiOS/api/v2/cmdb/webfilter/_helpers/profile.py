...
VALID_BODY_OPTIONS = ['activexfilter', 'cookiefilter', 'javafilter', 'block-invalid-url', 'jscript', 'js', 'vbs', 'unknown', 'intrinsic', 'wf-referer', 'wf-cookie']
VALID_BODY_HTTPS_REPLACEMSG = ['enable', 'disable']
VALID_BODY_WEB_FLOW_LOG_ENCODING = ['utf-8', 'punycode']
VALID_BODY_OVRD_PERM = ['bannedword-override', 'urlfilter-override', 'fortiguard-wf-override', 'contenttype-check-override']
VALID_BODY_POST_ACTION = ['normal', 'block']
VALID_BODY_WISP = ['enable', 'disable']
VALID_BODY_WISP_ALGORITHM = ['primary-secondary', 'round-robin', 'auto-learning']
...
def validate_profile_post(payload: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    if 'feature-set' in payload:
        ...
        if value and value not in VALID_BODY_FEATURE_SET:
            return (False, f"Invalid feature-set '{value}'. Must be one of: {', '.join(VALID_BODY_FEATURE_SET)}")
    ...
    if 'options' in payload:
        ...
        if value and value not in VALID_BODY_OPTIONS:
            return (False, f"Invalid options '{value}'. Must be one of: {', '.join(VALID_BODY_OPTIONS)}")
    ...
    if 'https-replacemsg' in payload:
        ...
        if value and value not in VALID_BODY_HTTPS_REPLACEMSG:
            return (False, f"Invalid https-replacemsg '{value}'. Must be one of: {', '.join(VALID_BODY_HTTPS_REPLACEMSG)}")
    ...
    if 'web-flow-log-encoding' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FLOW_LOG_ENCODING:
            return (False, f"Invalid web-flow-log-encoding '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FLOW_LOG_ENCODING)}")
    ...
    if 'ovrd-perm' in payload:
        ...
        if value and value not in VALID_BODY_OVRD_PERM:
            return (False, f"Invalid ovrd-perm '{value}'. Must be one of: {', '.join(VALID_BODY_OVRD_PERM)}")
    ...
    if 'post-action' in payload:
        ...
        if value and value not in VALID_BODY_POST_ACTION:
            return (False, f"Invalid post-action '{value}'. Must be one of: {', '.join(VALID_BODY_POST_ACTION)}")
    
    # Validate wisp if present
    if 'wisp' in payload:
        value = payload.get('wisp')
        if value and value not in VALID_BODY_WISP:
            return (False, f"Invalid wisp '{value}'. Must be one of: {', '.join(VALID_BODY_WISP)}")
    ...
    if 'wisp-algorithm' in payload:
        ...
        if value and value not in VALID_BODY_WISP_ALGORITHM:
            return (False, f"Invalid wisp-algorithm '{value}'. Must be one of: {', '.join(VALID_BODY_WISP_ALGORITHM)}")
    ...
    if 'log-all-url' in payload:
        ...
        if value and value not in VALID_BODY_LOG_ALL_URL:
            return (False, f"Invalid log-all-url '{value}'. Must be one of: {', '.join(VALID_BODY_LOG_ALL_URL)}")
    ...
    if 'web-content-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_CONTENT_LOG:
            return (False, f"Invalid web-content-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_CONTENT_LOG)}")
    ...
    if 'web-filter-activex-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_ACTIVEX_LOG:
            return (False, f"Invalid web-filter-activex-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_ACTIVEX_LOG)}")
    ...
    if 'web-filter-command-block-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_COMMAND_BLOCK_LOG:
            return (False, f"Invalid web-filter-command-block-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_COMMAND_BLOCK_LOG)}")
    ...
    if 'web-filter-cookie-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_COOKIE_LOG:
            return (False, f"Invalid web-filter-cookie-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_COOKIE_LOG)}")
    ...
    if 'web-filter-applet-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_APPLET_LOG:
            return (False, f"Invalid web-filter-applet-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_APPLET_LOG)}")
    ...
    if 'web-filter-jscript-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_JSCRIPT_LOG:
            return (False, f"Invalid web-filter-jscript-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_JSCRIPT_LOG)}")
    ...
    if 'web-filter-js-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_JS_LOG:
            return (False, f"Invalid web-filter-js-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_JS_LOG)}")
    ...
    if 'web-filter-vbs-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_VBS_LOG:
            return (False, f"Invalid web-filter-vbs-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_VBS_LOG)}")
    ...
    if 'web-filter-unknown-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_UNKNOWN_LOG:
            return (False, f"Invalid web-filter-unknown-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_UNKNOWN_LOG)}")
    ...
    if 'web-filter-referer-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_REFERER_LOG:
            return (False, f"Invalid web-filter-referer-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_REFERER_LOG)}")
    ...
    if 'web-filter-cookie-removal-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FILTER_COOKIE_REMOVAL_LOG:
            return (False, f"Invalid web-filter-cookie-removal-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FILTER_COOKIE_REMOVAL_LOG)}")
    ...
    if 'web-url-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_URL_LOG:
            return (False, f"Invalid web-url-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_URL_LOG)}")
    ...
    if 'web-invalid-domain-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_INVALID_DOMAIN_LOG:
            return (False, f"Invalid web-invalid-domain-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_INVALID_DOMAIN_LOG)}")
    ...
    if 'web-ftgd-err-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FTGD_ERR_LOG:
            return (False, f"Invalid web-ftgd-err-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FTGD_ERR_LOG)}")
    ...
    if 'web-ftgd-quota-usage' in payload:
        ...
        if value and value not in VALID_BODY_WEB_FTGD_QUOTA_USAGE:
            return (False, f"Invalid web-ftgd-quota-usage '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_FTGD_QUOTA_USAGE)}")
    ...
    if 'web-extended-all-action-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_EXTENDED_ALL_ACTION_LOG:
            return (False, f"Invalid web-extended-all-action-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_EXTENDED_ALL_ACTION_LOG)}")
    ...
    if 'web-antiphishing-log' in payload:
        ...
        if value and value not in VALID_BODY_WEB_ANTIPHISHING_LOG:
            return (False, f"Invalid web-antiphishing-log '{value}'. Must be one of: {', '.join(VALID_BODY_WEB_ANTIPHISHING_LOG)}")
