...
class KeywordModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int = Field(ge=0, le=4294967295, default=0, description="ID.")    name: str = Field(max_length=35, default="", description="Name.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    match: Literal["or", "and"] = Field(default="or", description="Keyword matching logic.")    word: list[KeywordWord] = Field(default=None, description="List of keywords.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.843270Z
# ============================================================================
