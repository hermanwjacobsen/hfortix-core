...
class SettingsModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    storage_device: str | None = Field(max_length=35, default="", description="Storage device name.")  # datasource: ['system.storage.name']    size: int | None = Field(ge=16, le=4294967295, default=16, description="Maximum total size of files within the DLP fingerprint database (MB).")    db_mode: Literal["stop-adding", "remove-modified-then-oldest", "remove-oldest"] | None = Field(default="stop-adding", description="Behavior when the maximum size is reached in the DLP fingerprint database.")    cache_mem_percent: int | None = Field(ge=1, le=15, default=2, description="Maximum percentage of available memory allocated to caching DLP fingerprints (1 - 15).")    chunk_size: int | None = Field(ge=100, le=100000, default=2800, description="Maximum fingerprint chunk size. Caution, changing this setting will flush the entire database.")    config_builder_timeout: int | None = Field(ge=10, le=100000, default=60, description="Maximum time allowed for building a single DLP profile (default 60 seconds).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.088173Z
# ============================================================================
