...
class ExactDataMatchModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="Name of table containing the exact-data-match template.")    optional: int = Field(ge=0, le=32, default=0, description="Number of optional columns need to match.")    data: str = Field(max_length=35, default="", description="External resource for exact data match.")  # datasource: ['system.external-resource.name']    columns: list[ExactDataMatchColumns] = Field(description="DLP exact-data-match column types.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_columns_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.963586Z
# ============================================================================
