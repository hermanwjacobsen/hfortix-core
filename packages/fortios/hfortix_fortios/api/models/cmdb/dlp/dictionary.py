...
class DictionaryModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")    name: str = Field(max_length=35, default="", description="Name of table containing the dictionary.")    match_type: Literal["match-all", "match-any"] = Field(default="match-any", description="Logical relation between entries (default = match-any).")    match_around: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable match-around support.")    comment: str | None = Field(max_length=255, default=None, description="Optional comments.")    entries: list[DictionaryEntries] = Field(description="DLP dictionary entries.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.340226Z
# ============================================================================
