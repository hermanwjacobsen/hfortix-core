...
class SensorModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="Name of table containing the sensor.")    match_type: Literal["match-all", "match-any", "match-eval"] = Field(default="match-any", description="Logical relation between entries (default = match-any).")    eval: str | None = Field(max_length=255, default="", description="Expression to evaluate.")    comment: str | None = Field(max_length=255, default=None, description="Optional comments.")    entries: list[SensorEntries] = Field(description="DLP sensor entries.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.077579Z
# ============================================================================
