...
class LabelModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Name of table containing the label.")    type: Literal["mpip", "fortidata"] | None = Field(default="mpip", description="Label type.")    mpip_type: Literal["remote", "local"] | None = Field(default="remote", description="MPIP label type.")    connector: str | None = Field(max_length=35, default="", description="Name of SDN connector.")  # datasource: ['system.sdn-connector.name']    comment: str | None = Field(max_length=255, default=None, description="Optional comments.")    entries: list[LabelEntries] = Field(description="DLP label entries.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.352905Z
# ============================================================================
