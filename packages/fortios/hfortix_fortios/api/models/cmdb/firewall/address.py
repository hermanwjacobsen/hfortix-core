...
class AddressModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=79, default="", description="Address name.")    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")    subnet: Any = Field(default="0.0.0.0 0.0.0.0", description="IP address and subnet mask of address.")    type: AddressTypeEnum | None = Field(default="ipmask", description="Type of address.")    route_tag: int | None = Field(ge=1, le=4294967295, default=0, description="route-tag address.")    sub_type: AddressSubTypeEnum | None = Field(default="sdn", description="Sub-type of address.")    clearpass_spt: AddressClearpassSptEnum | None = Field(default="unknown", description="SPT (System Posture Token) value.")    macaddr: list[AddressMacaddr] = Field(default=None, description="Multiple MAC address ranges.")    start_ip: str | None = Field(default="0.0.0.0", description="First IP address (inclusive) in the range for the address.")    end_ip: str | None = Field(default="0.0.0.0", description="Final IP address (inclusive) in the range for the address.")    fqdn: str | None = Field(max_length=255, default="", description="Fully Qualified Domain Name address.")    country: str | None = Field(max_length=2, default="", description="IP addresses associated to a specific country.")    wildcard_fqdn: str | None = Field(max_length=255, default="", description="Fully Qualified Domain Name with wildcard characters.")    cache_ttl: int | None = Field(ge=0, le=86400, default=0, description="Defines the minimal TTL of individual IP addresses in FQDN cache measured in seconds.")    wildcard: Any = Field(default="0.0.0.0 0.0.0.0", description="IP address and wildcard netmask.")    sdn: str | None = Field(max_length=35, default="", description="SDN.")  # datasource: ['system.sdn-connector.name']    fsso_group: list[AddressFssoGroup] = Field(default=None, description="FSSO group(s).")    sso_attribute_value: list[AddressSsoAttributeValue] = Field(default=None, description="RADIUS attributes value.")    interface: str = Field(max_length=35, default="", description="Name of interface whose IP address is to be used.")  # datasource: ['system.interface.name']    tenant: str | None = Field(max_length=35, default="", description="Tenant.")    organization: str | None = Field(max_length=35, default="", description="Organization domain name (Syntax: organization/domain).")    epg_name: str | None = Field(max_length=255, default="", description="Endpoint group name.")    subnet_name: str | None = Field(max_length=255, default="", description="Subnet name.")    sdn_tag: str | None = Field(max_length=15, default="", description="SDN Tag.")    policy_group: str | None = Field(max_length=15, default="", description="Policy group name.")    obj_tag: str | None = Field(max_length=255, default="", description="Tag of dynamic address object.")    obj_type: Literal["ip", "mac"] | None = Field(default="ip", description="Object type.")    tag_detection_level: str | None = Field(max_length=15, default="", description="Tag detection level of dynamic address object.")    tag_type: str | None = Field(max_length=63, default="", description="Tag type of dynamic address object.")    hw_vendor: str | None = Field(max_length=35, default="", description="Dynamic address matching hardware vendor.")    hw_model: str | None = Field(max_length=35, default="", description="Dynamic address matching hardware model.")    os: str | None = Field(max_length=35, default="", description="Dynamic address matching operating system.")    sw_version: str | None = Field(max_length=35, default="", description="Dynamic address matching software version.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    associated_interface: str | None = Field(max_length=35, default="", description="Network interface associated with address.")  # datasource: ['system.interface.name', 'system.zone.name']    color: int | None = Field(ge=0, le=32, default=0, description="Color of icon on the GUI.")    filter: str = Field(max_length=2047, description="Match criteria filter.")    sdn_addr_type: Literal["private", "public", "all"] | None = Field(default="private", description="Type of addresses to collect.")    node_ip_only: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable collection of node addresses only in Kubernetes.")    obj_id: str | None = Field(max_length=255, default=None, description="Object ID for NSX.")    list: list[AddressList] = Field(default=None, description="IP address list.")    tagging: list[AddressTagging] = Field(default=None, description="Config object tagging.")    allow_routing: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable use of this address in routing configurations.")    passive_fqdn_learning: Literal["disable", "enable"] | None = Field(default="enable", description="Enable/disable passive learning of FQDNs.  When enabled, the FortiGate learns, trusts, and saves FQDNs from endpoint DNS queries (default = enable).")    fabric_object: Literal["enable", "disable"] | None = Field(default="disable", description="Security Fabric global object setting.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_fsso_group_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.774373Z
# ============================================================================
