...
class InterfacePolicy6Model(BaseModel):
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_service6_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.655200Z
# ============================================================================
