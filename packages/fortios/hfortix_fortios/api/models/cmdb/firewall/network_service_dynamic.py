...
class NetworkServiceDynamicModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=63, default="", description="Dynamic Network Service name.")    sdn: str = Field(max_length=35, default="", description="SDN connector name.")  # datasource: ['system.sdn-connector.name']    comment: str | None = Field(max_length=255, default=None, description="Comment.")    filter: str = Field(max_length=2047, description="Match criteria filter.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.408101Z
# ============================================================================
