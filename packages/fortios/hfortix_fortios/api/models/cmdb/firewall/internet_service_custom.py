...
class InternetServiceCustomModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=63, default="", description="Internet Service name.")    reputation: int | None = Field(ge=0, le=4294967295, default=3, description="Reputation level of the custom Internet Service.")  # datasource: ['firewall.internet-service-reputation.id']    comment: str | None = Field(max_length=255, default=None, description="Comment.")    entry: list[InternetServiceCustomEntry] = Field(default=None, description="Entries added to the Internet Service database and custom database.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.948616Z
# ============================================================================
