...
class InternetServiceAdditionModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=0, le=4294967295, default=0, description="Internet Service ID in the Internet Service database.")  # datasource: ['firewall.internet-service.id']    comment: str | None = Field(max_length=255, default=None, description="Comment.")    entry: list[InternetServiceAdditionEntry] = Field(default=None, description="Entries added to the Internet Service addition database.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.542780Z
# ============================================================================
