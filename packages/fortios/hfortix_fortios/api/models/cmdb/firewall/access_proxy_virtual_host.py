...
class AccessProxyVirtualHostModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=79, default="", description="Virtual host name.")    ssl_certificate: list[AccessProxyVirtualHostSslCertificate] = Field(description="SSL certificates for this host.")    host: str = Field(max_length=79, default="", description="The host name.")    host_type: Literal["sub-string", "wildcard"] = Field(default="sub-string", description="Type of host pattern.")    replacemsg_group: str | None = Field(max_length=35, default="", description="Access-proxy-virtual-host replacement message override group.")  # datasource: ['system.replacemsg-group.name']    empty_cert_action: Literal["accept", "block", "accept-unmanageable"] | None = Field(default="block", description="Action for an empty client certificate.")    user_agent_detect: Literal["disable", "enable"] | None = Field(default="enable", description="Enable/disable detecting device type by HTTP user-agent if no client certificate is provided.")    client_cert: Literal["disable", "enable"] | None = Field(default="enable", description="Enable/disable requesting client certificate.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.867696Z
# ============================================================================
