...
class Vipgrp6Model(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=79, default="", description="IPv6 VIP group name.")    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")    color: int | None = Field(ge=0, le=32, default=0, description="Integer value to determine the color of the icon in the GUI (range 1 to 32, default = 0, which sets the value to 1).")    comments: str | None = Field(max_length=255, default=None, description="Comment.")    member: list[Vipgrp6Member] = Field(description="Member VIP objects of the group (Separate multiple objects with a space).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.444491Z
# ============================================================================
