...
class MulticastAddress6Model(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=79, default="", description="IPv6 multicast address name.")    ip6: str = Field(default="::/0", description="IPv6 address prefix (format: xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:xxxx/xxx).")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    color: int | None = Field(ge=0, le=32, default=0, description="Color of icon on the GUI.")    tagging: list[MulticastAddress6Tagging] = Field(default=None, description="Config object tagging.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.809819Z
# ============================================================================
