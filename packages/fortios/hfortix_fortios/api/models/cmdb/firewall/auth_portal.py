...
class AuthPortalModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    groups: list[AuthPortalGroups] = Field(default=None, description="Firewall user groups permitted to authenticate through this portal. Separate group names with spaces.")    portal_addr: str | None = Field(max_length=63, default="", description="Address (or FQDN) of the authentication portal.")    portal_addr6: str | None = Field(max_length=63, default="", description="IPv6 address (or FQDN) of authentication portal.")    identity_based_route: str | None = Field(max_length=35, default="", description="Name of the identity-based route that applies to this portal.")  # datasource: ['firewall.identity-based-route.name']    proxy_auth: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable authentication by proxy daemon (default = disable).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.142679Z
# ============================================================================
