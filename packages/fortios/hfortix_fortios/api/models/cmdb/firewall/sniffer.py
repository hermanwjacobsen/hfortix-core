...
class SnifferModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=0, le=9999, default=0, description="Sniffer ID (0 - 9999).")    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")    status: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable the active status of the sniffer.")    logtraffic: Literal["all", "utm", "disable"] | None = Field(default="utm", description="Either log all sessions, only sessions that have a security profile applied, or disable all logging for this policy.")    ipv6: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable sniffing IPv6 packets.")    non_ip: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable sniffing non-IP packets.")    interface: str | None = Field(max_length=35, default="", description="Interface name that traffic sniffing will take place on.")  # datasource: ['system.interface.name']    host: str | None = Field(max_length=63, default="", description="Hosts to filter for in sniffer traffic (Format examples: 1.1.1.1, 2.2.2.0/24, 3.3.3.3/255.255.255.0, 4.4.4.0-4.4.4.240).")    port: str | None = Field(max_length=63, default="", description="Ports to sniff (Format examples: 10, :20, 30:40, 50-, 100-200).")    protocol: str | None = Field(max_length=63, default="", description="Integer value for the protocol type as defined by IANA (0 - 255).")    vlan: str | None = Field(max_length=63, default="", description="List of VLANs to sniff.")    application_list_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable application control profile.")    application_list: str = Field(max_length=47, default="", description="Name of an existing application list.")  # datasource: ['application.list.name']    ips_sensor_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IPS sensor.")    ips_sensor: str = Field(max_length=47, default="", description="Name of an existing IPS sensor.")  # datasource: ['ips.sensor.name']    dsri: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable DSRI.")    av_profile_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable antivirus profile.")    av_profile: str = Field(max_length=47, default="", description="Name of an existing antivirus profile.")  # datasource: ['antivirus.profile.name']    webfilter_profile_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable web filter profile.")    webfilter_profile: str = Field(max_length=47, default="", description="Name of an existing web filter profile.")  # datasource: ['webfilter.profile.name']    emailfilter_profile_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable emailfilter.")    emailfilter_profile: str = Field(max_length=47, default="", description="Name of an existing email filter profile.")  # datasource: ['emailfilter.profile.name']    dlp_profile_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable DLP profile.")    dlp_profile: str = Field(max_length=47, default="", description="Name of an existing DLP profile.")  # datasource: ['dlp.profile.name']    ip_threatfeed_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IP threat feed.")    ip_threatfeed: list[SnifferIpThreatfeed] = Field(default=None, description="Name of an existing IP threat feed.")    file_filter_profile_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable file filter.")    file_filter_profile: str = Field(max_length=47, default="", description="Name of an existing file-filter profile.")  # datasource: ['file-filter.profile.name']    ips_dos_status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IPS DoS anomaly detection.")    anomaly: list[SnifferAnomaly] = Field(default=None, description="Configuration method to edit Denial of Service (DoS) anomaly settings.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_ip_threatfeed_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.960824Z
# ============================================================================
