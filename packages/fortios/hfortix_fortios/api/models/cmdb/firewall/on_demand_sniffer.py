...
class OnDemandSnifferModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="On-demand packet sniffer name.")    interface: str = Field(max_length=35, default="", description="Interface name that on-demand packet sniffer will take place.")  # datasource: ['system.interface.name']    max_packet_count: int = Field(ge=1, le=20000, default=0, description="Maximum number of packets to capture per on-demand packet sniffer.")    hosts: list[OnDemandSnifferHosts] = Field(default=None, description="IPv4 or IPv6 hosts to filter in this traffic sniffer.")    ports: list[OnDemandSnifferPorts] = Field(default=None, description="Ports to filter for in this traffic sniffer.")    protocols: list[OnDemandSnifferProtocols] = Field(default=None, description="Protocols to filter in this traffic sniffer.")    non_ip_packet: Literal["enable", "disable"] | None = Field(default="disable", description="Include non-IP packets.")    advanced_filter: str | None = Field(max_length=255, default=None, description="Advanced freeform filter that will be used over existing filter settings if set. Can only be used by super admin.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.923896Z
# ============================================================================
