...
class InternetServiceDefinitionModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=0, le=4294967295, default=0, description="Internet Service application list ID.")    entry: list[InternetServiceDefinitionEntry] = Field(default=None, description="Protocol and port information in an Internet Service entry.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.521859Z
# ============================================================================
