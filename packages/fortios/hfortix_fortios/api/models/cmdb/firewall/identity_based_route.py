...
class IdentityBasedRouteModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="Name.")    comments: str | None = Field(max_length=127, default="", description="Comments.")    rule: list[IdentityBasedRouteRule] = Field(default=None, description="Rule.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.025568Z
# ============================================================================
