...
class ProxyAddrgrpModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=79, default="", description="Address group name.")    type: Literal["src", "dst"] | None = Field(default="src", description="Source or destination address group type.")    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")    member: list[ProxyAddrgrpMember] = Field(description="Members of address group.")    color: int | None = Field(ge=0, le=32, default=0, description="Integer value to determine the color of the icon in the GUI (1 - 32, default = 0, which sets value to 1).")    tagging: list[ProxyAddrgrpTagging] = Field(default=None, description="Config object tagging.")    comment: str | None = Field(max_length=255, default=None, description="Optional comments.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.057736Z
# ============================================================================
