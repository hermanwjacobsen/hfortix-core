...
class DecryptedTrafficMirrorModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="Name.")    dstmac: str | None = Field(default="ff:ff:ff:ff:ff:ff", description="Set destination MAC address for mirrored traffic.")    traffic_type: Literal["ssl", "ssh"] | None = Field(default="ssl", description="Types of decrypted traffic to be mirrored.")    traffic_source: Literal["client", "server", "both"] | None = Field(default="client", description="Source of decrypted traffic to be mirrored.")    interface: list[DecryptedTrafficMirrorInterface] = Field(description="Decrypted traffic mirror interface.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.883011Z
# ============================================================================
