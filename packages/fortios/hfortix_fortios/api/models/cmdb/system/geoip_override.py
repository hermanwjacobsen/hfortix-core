...
class GeoipOverrideModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=63, default="", description="Location name.")    description: str | None = Field(max_length=127, default="", description="Description.")    country_id: str | None = Field(max_length=2, default="", description="Two character Country ID code.")    ip_range: list[GeoipOverrideIpRange] = Field(default=None, description="Table of IP ranges assigned to country.")    ip6_range: list[GeoipOverrideIp6Range] = Field(default=None, description="Table of IPv6 ranges assigned to country.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.899039Z
# ============================================================================
