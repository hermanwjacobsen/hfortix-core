...
class SsoAdminModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=64, default="", description="SSO admin name.")    accprofile: str = Field(max_length=35, default="", description="SSO admin user access profile.")  # datasource: ['system.accprofile.name']    vdom: list[SsoAdminVdom] = Field(default=None, description="Virtual domain(s) that the administrator can access.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.051645Z
# ============================================================================
