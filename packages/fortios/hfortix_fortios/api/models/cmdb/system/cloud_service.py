...
class CloudServiceModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Name.")    vendor: Literal["unknown", "google-cloud-kms"] | None = Field(default="unknown", description="Cloud service vendor.")    traffic_vdom: str | None = Field(max_length=31, default="", description="Vdom used to communicate with cloud service.")  # datasource: ['system.vdom.name']    gck_service_account: str | None = Field(max_length=285, default="", description="Service account (e.g. \"account-id@sampledomain.com\").")    gck_private_key: str | None = Field(max_length=8191, default="", description="Service account private key in PEM format (e.g. \"-----BEGIN PRIVATE KEY-----\\ ...\").")    gck_keyid: str | None = Field(max_length=127, default="", description="Key id, also referred as \"kid\".")    gck_access_token_lifetime: int | None = Field(ge=1, le=3600, default=60, description="Lifetime of automatically generated access tokens in minutes (default is 60 minutes).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.385651Z
# ============================================================================
