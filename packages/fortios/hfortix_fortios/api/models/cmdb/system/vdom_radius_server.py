...
class VdomRadiusServerModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=31, default="", description="Name of the VDOM that you are adding the RADIUS server to.")  # datasource: ['system.vdom.name']    status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable the RSSO RADIUS server for this VDOM.")    radius_server_vdom: str = Field(max_length=31, default="", description="Use this option to select another VDOM containing a VDOM RSSO RADIUS server to use for the current VDOM.")  # datasource: ['system.vdom.name']    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_radius_server_vdom_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.353863Z
# ============================================================================
