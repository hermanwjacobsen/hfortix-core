...
class DnsServerModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=15, default="", description="DNS server name.")  # datasource: ['system.interface.name']    mode: DnsServerModeEnum | None = Field(default="recursive", description="DNS server mode.")    dnsfilter_profile: str | None = Field(max_length=47, default="", description="DNS filter profile.")  # datasource: ['dnsfilter.profile.name']    doh: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable DNS over HTTPS/443 (default = disable).")    doh3: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable DNS over QUIC/HTTP3/443 (default = disable).")    doq: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable DNS over QUIC/853 (default = disable).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:37.347043Z
# ============================================================================
