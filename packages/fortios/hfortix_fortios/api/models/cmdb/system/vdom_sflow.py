...
class VdomSflowModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    vdom_sflow: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable the sFlow configuration for the current VDOM.")    collectors: list[VdomSflowCollectors] = Field(default=None, description="sFlow collectors.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.794618Z
# ============================================================================
