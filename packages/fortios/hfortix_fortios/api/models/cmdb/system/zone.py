...
class ZoneModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Zone name.")    tagging: list[ZoneTagging] = Field(default=None, description="Config object tagging.")    description: str | None = Field(max_length=127, default="", description="Description.")    intrazone: Literal["allow", "deny"] | None = Field(default="deny", description="Allow or deny traffic routing between different interfaces in the same zone (default = deny).")    interface: list[ZoneInterface] = Field(default=None, description="Add interfaces to this zone. Interfaces must not be assigned to another zone or have firewall policies defined.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.750992Z
# ============================================================================
