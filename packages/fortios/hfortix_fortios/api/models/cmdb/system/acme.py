...
class AcmeModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    interface: list[AcmeInterface] = Field(default=None, description="Interface(s) on which the ACME client will listen for challenges.")    use_ha_direct: Literal["enable", "disable"] | None = Field(default="disable", description="Enable the use of 'ha-mgmt' interface to connect to the ACME server when 'ha-direct' is enabled in HA configuration")    source_ip: str | None = Field(default="0.0.0.0", description="Source IPv4 address used to connect to the ACME server.")    source_ip6: str | None = Field(default="::", description="Source IPv6 address used to connect to the ACME server.")    accounts: list[AcmeAccounts] = Field(default=None, description="ACME accounts list.")    acc_details: Any = Field(default=None, description="Print Account information and decrypted key.")    status: Any = Field(default=None, description="Print information about the current status of the acme client.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.814520Z
# ============================================================================
