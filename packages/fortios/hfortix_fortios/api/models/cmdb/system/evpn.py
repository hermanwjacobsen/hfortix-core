...
class EvpnModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=1, le=65535, default=0, description="ID.")    rd: str | None = Field(max_length=79, default="", description="Route Distinguisher: AA:NN|A.B.C.D:NN.")    import_rt: list[EvpnImportRt] = Field(default=None, description="List of import route targets.")    export_rt: list[EvpnExportRt] = Field(default=None, description="List of export route targets.")    ip_local_learning: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IP address local learning.")    arp_suppression: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable ARP suppression.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.125428Z
# ============================================================================
