...
class SsoFortigateCloudAdminModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=64, default="", description="FortiCloud SSO admin name.")    accprofile: str | None = Field(max_length=35, default="", description="FortiCloud SSO admin user access profile. Permission is set to read-only without a FortiGate Cloud Central Management license.")  # datasource: ['system.accprofile.name']    vdom: list[SsoFortigateCloudAdminVdom] = Field(default=None, description="Virtual domain(s) that the administrator can access.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.518942Z
# ============================================================================
