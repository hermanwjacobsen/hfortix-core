...
class VdomExceptionModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=1, le=4096, default=0, description="Index (1 - 4096).")    object: VdomExceptionObjectEnum = Field(default="", description="Name of the configuration object that can be configured independently for all VDOMs.")    scope: Literal["all", "inclusive", "exclusive"] | None = Field(default="all", description="Determine whether the configuration object can be configured separately for all VDOMs or if some VDOMs share the same configuration.")    vdom: list[VdomExceptionVdom] = Field(default=None, description="Names of the VDOMs.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.338814Z
# ============================================================================
