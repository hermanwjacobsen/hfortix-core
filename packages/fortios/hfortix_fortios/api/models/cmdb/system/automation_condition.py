...
class AutomationConditionModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Name.")    description: str | None = Field(max_length=255, default=None, description="Description.")    condition_type: Literal["cpu", "memory", "vpn"] | None = Field(default="cpu", description="Condition type.")    cpu_usage_percent: int = Field(ge=0, le=100, default=0, description="CPU usage reaches specified percentage.")    mem_usage_percent: int = Field(ge=0, le=100, default=0, description="Memory usage reaches specified percentage.")    vdom: str = Field(max_length=31, default="root", description="Virtual domain which the tunnel belongs to.")  # datasource: ['system.vdom.name']    vpn_tunnel_name: str = Field(max_length=79, default="", description="VPN tunnel name.")    vpn_tunnel_state: Literal["tunnel-up", "tunnel-down"] | None = Field(default="tunnel-up", description="VPN tunnel state.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.204004Z
# ============================================================================
