...
class VdomNetflowModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    vdom_netflow: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable NetFlow per VDOM.")    collectors: list[VdomNetflowCollectors] = Field(default=None, description="Netflow collectors.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.669018Z
# ============================================================================
