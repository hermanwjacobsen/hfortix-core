...
class SshConfigModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    ssh_kex_algo: SshConfigSshKexAlgoEnum | None = Field(default="diffie-hellman-group14-sha256 diffie-hellman-group16-sha512 diffie-hellman-group18-sha512 diffie-hellman-group-exchange-sha256 curve25519-sha256@libssh.org ecdh-sha2-nistp256 ecdh-sha2-nistp384 ecdh-sha2-nistp521", description="Select one or more SSH kex algorithms.")    ssh_enc_algo: SshConfigSshEncAlgoEnum | None = Field(default="aes256-ctr aes256-gcm@openssh.com", description="Select one or more SSH ciphers.")    ssh_mac_algo: SshConfigSshMacAlgoEnum | None = Field(default="hmac-sha2-256 hmac-sha2-256-etm@openssh.com hmac-sha2-512 hmac-sha2-512-etm@openssh.com", description="Select one or more SSH MAC algorithms.")    ssh_hsk_algo: SshConfigSshHskAlgoEnum | None = Field(default="ecdsa-sha2-nistp521 ecdsa-sha2-nistp384 ecdsa-sha2-nistp256 rsa-sha2-256 rsa-sha2-512 ssh-ed25519", description="Select one or more SSH hostkey algorithms.")    ssh_hsk_override: Literal["disable", "enable"] | None = Field(default="disable", description="Enable/disable SSH host key override in SSH daemon.")    ssh_hsk_password: Any = Field(max_length=128, default=None, description="Password for ssh-hostkey.")    ssh_hsk: str = Field(default="", description="Config SSH host key.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.771065Z
# ============================================================================
