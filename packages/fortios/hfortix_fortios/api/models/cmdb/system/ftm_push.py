...
class FtmPushModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    proxy: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable communication to the proxy server in FortiGuard configuration.")    interface: str | None = Field(max_length=35, default="", description="Interface of FortiToken Mobile push services server.")  # datasource: ['system.interface.name']    server: str | None = Field(max_length=127, default="", description="IPv4 address or domain name of FortiToken Mobile push services server.")    server_port: int | None = Field(ge=1, le=65535, default=4433, description="Port to communicate with FortiToken Mobile push services server (1 - 65535, default = 4433).")    server_cert: str | None = Field(max_length=35, default="Fortinet_GUI_Server", description="Name of the server certificate to be used for SSL.")  # datasource: ['certificate.local.name']    server_ip: str | None = Field(default="0.0.0.0", description="IPv4 address of FortiToken Mobile push services server (format: xxx.xxx.xxx.xxx).")    status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable the use of FortiToken Mobile push services.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.584352Z
# ============================================================================
