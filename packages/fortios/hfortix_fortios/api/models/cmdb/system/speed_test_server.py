...
class SpeedTestServerModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Speed test server name.")    timestamp: int | None = Field(ge=0, le=4294967295, default=0, description="Speed test server timestamp.")    host: list[SpeedTestServerHost] = Field(default=None, description="Hosts of the server.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.627581Z
# ============================================================================
