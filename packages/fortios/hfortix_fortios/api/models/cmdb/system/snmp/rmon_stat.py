...
class RmonStatModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int = Field(ge=0, le=4294967295, default=0, description="RMON Ethernet statistics entry ID.")    source: str = Field(max_length=15, default="", description="Data source of the Ethernet statistics entry.")  # datasource: ['system.interface.name']    owner: str | None = Field(max_length=127, default="", description="Owner of the Ethernet statistics entry.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.940652Z
# ============================================================================
