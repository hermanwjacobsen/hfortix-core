...
class NetflowModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    active_flow_timeout: int | None = Field(ge=60, le=3600, default=1800, description="Timeout to report active flows (60 - 3600 sec, default = 1800).")    inactive_flow_timeout: int | None = Field(ge=10, le=600, default=15, description="Timeout for periodic report of finished flows (10 - 600 sec, default = 15).")    template_tx_timeout: int | None = Field(ge=60, le=86400, default=1800, description="Timeout for periodic template flowset transmission (60 - 86400 sec, default = 1800).")    template_tx_counter: int | None = Field(ge=10, le=6000, default=20, description="Counter of flowset records before resending a template flowset record.")    session_cache_size: Literal["min", "default", "max"] | None = Field(default="default", description="Maximum RAM usage allowed for Netflow session cache.")    exclusion_filters: list[NetflowExclusionFilters] = Field(default=None, description="Exclusion filters")    collectors: list[NetflowCollectors] = Field(default=None, description="Netflow collectors.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.507913Z
# ============================================================================
