...
class IpsecAggregateModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=15, default="", description="IPsec aggregate name.")    member: list[IpsecAggregateMember] = Field(description="Member tunnels of the aggregate.")    algorithm: IpsecAggregateAlgorithmEnum | None = Field(default="round-robin", description="Frame distribution algorithm.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.077003Z
# ============================================================================
