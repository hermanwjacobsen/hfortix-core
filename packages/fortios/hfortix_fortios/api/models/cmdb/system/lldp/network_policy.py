...
class NetworkPolicyModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="LLDP network policy name.")    comment: str | None = Field(max_length=1023, default=None, description="Comment.")    voice: list[NetworkPolicyVoice] = Field(default=None, description="Voice.")    voice_signaling: list[NetworkPolicyVoiceSignaling] = Field(default=None, description="Voice signaling.")    guest: list[NetworkPolicyGuest] = Field(default=None, description="Guest.")    guest_voice_signaling: list[NetworkPolicyGuestVoiceSignaling] = Field(default=None, description="Guest Voice Signaling.")    softphone: list[NetworkPolicySoftphone] = Field(default=None, description="Softphone.")    video_conferencing: list[NetworkPolicyVideoConferencing] = Field(default=None, description="Video Conferencing.")    streaming_video: list[NetworkPolicyStreamingVideo] = Field(default=None, description="Streaming Video.")    video_signaling: list[NetworkPolicyVideoSignaling] = Field(default=None, description="Video Signaling.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:37.005855Z
# ============================================================================
