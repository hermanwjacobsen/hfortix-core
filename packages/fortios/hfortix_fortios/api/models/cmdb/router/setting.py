...
class SettingModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    show_filter: str | None = Field(max_length=35, default="", description="Prefix-list as filter for showing routes.")  # datasource: ['router.prefix-list.name']    hostname: str | None = Field(max_length=14, default="", description="Hostname for this virtual domain router.")    kernel_route_distance: int | None = Field(ge=0, le=255, default=255, description="Administrative distance for routes learned from kernel (0 - 255).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.660558Z
# ============================================================================
