...
class Multicast6Model(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    multicast_routing: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IPv6 multicast routing.")    multicast_pmtu: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable PMTU for IPv6 multicast.")    interface: list[Multicast6Interface] = Field(default=None, description="Protocol Independent Multicast (PIM) interfaces.")    pim_sm_global: list[Multicast6PimSmGlobal] = Field(default=None, description="PIM sparse-mode global settings.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.390548Z
# ============================================================================
