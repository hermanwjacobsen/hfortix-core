...
class L2tpModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    status: Literal["enable", "disable"] = Field(default="disable", description="Enable/disable FortiGate as a L2TP gateway.")    eip: str = Field(default="0.0.0.0", description="End IP.")    sip: str = Field(default="0.0.0.0", description="Start IP.")    usrgrp: str = Field(max_length=35, default="", description="User group.")  # datasource: ['user.group.name']    enforce_ipsec: Literal["enable", "disable"] = Field(default="disable", description="Enable/disable IPsec enforcement.")    lcp_echo_interval: int | None = Field(ge=0, le=32767, default=5, description="Time in seconds between PPPoE Link Control Protocol (LCP) echo requests.")    lcp_max_echo_fails: int | None = Field(ge=0, le=32767, default=3, description="Maximum number of missed LCP echo messages before disconnect.")    hello_interval: int | None = Field(ge=0, le=3600, default=60, description="L2TP hello message interval in seconds (0 - 3600 sec, default = 60).")    compress: Literal["enable", "disable"] = Field(default="disable", description="Enable/disable data compression.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.004817Z
# ============================================================================
