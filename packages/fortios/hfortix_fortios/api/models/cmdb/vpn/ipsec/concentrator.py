...
class ConcentratorModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=1, le=65535, default=0, description="Concentrator ID (1 - 65535).")    name: str | None = Field(max_length=35, default="", description="Concentrator name.")    src_check: Literal["disable", "enable"] | None = Field(default="disable", description="Enable to check source address of phase 2 selector. Disable to check only the destination selector.")    member: list[ConcentratorMember] = Field(default=None, description="Names of up to 3 VPN tunnels to add to the concentrator.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.230465Z
# ============================================================================
