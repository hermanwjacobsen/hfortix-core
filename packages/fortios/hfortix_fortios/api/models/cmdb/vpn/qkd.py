...
class QkdModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="Quantum Key Distribution configuration name.")    server: str = Field(max_length=63, default="", description="IPv4, IPv6 or DNS address of the KME.")    port: int = Field(ge=1, le=65535, default=0, description="Port to connect to on the KME.")    id: str = Field(max_length=291, default="", description="Quantum Key Distribution ID assigned by the KME.")    peer: str = Field(max_length=35, default="", description="Authenticate Quantum Key Device's certificate with the peer/peergrp.")  # datasource: ['user.peer.name', 'user.peergrp.name']    certificate: list[QkdCertificate] = Field(default=None, description="Names of up to 4 certificates to offer to the KME.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.665152Z
# ============================================================================
