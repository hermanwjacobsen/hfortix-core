...
class OcspServerModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="OCSP server entry name.")    url: str | None = Field(max_length=127, default="", description="OCSP server URL.")    cert: str | None = Field(max_length=127, default="", description="OCSP server certificate.")  # datasource: ['vpn.certificate.remote.name', 'vpn.certificate.ca.name']    secondary_url: str | None = Field(max_length=127, default="", description="Secondary OCSP server URL.")    secondary_cert: str | None = Field(max_length=127, default="", description="Secondary OCSP server certificate.")  # datasource: ['vpn.certificate.remote.name', 'vpn.certificate.ca.name']    unavail_action: Literal["revoke", "ignore"] | None = Field(default="revoke", description="Action when server is unavailable (revoke the certificate or ignore the result of the check).")    source_ip: str | None = Field(max_length=63, default="", description="Source IP address for dynamic AIA and OCSP queries.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_secondary_cert_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.365451Z
# ============================================================================
