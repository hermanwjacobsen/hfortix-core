...
class SensorModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=47, default="", description="Sensor name.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    replacemsg_group: str | None = Field(max_length=35, default="", description="Replacement message group.")  # datasource: ['system.replacemsg-group.name']    block_malicious_url: Literal["disable", "enable"] | None = Field(default="disable", description="Enable/disable malicious URL blocking.")    scan_botnet_connections: Literal["disable", "block", "monitor"] | None = Field(default="disable", description="Block or monitor connections to Botnet servers, or disable Botnet scanning.")    extended_log: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable extended logging.")    entries: list[SensorEntries] = Field(default=None, description="IPS sensor filter.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.430762Z
# ============================================================================
