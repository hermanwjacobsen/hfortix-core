...
class GroupModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=63, default="", description="Application group name.")    comment: str | None = Field(max_length=255, default=None, description="Comments.")    type: Literal["application", "filter"] | None = Field(default="application", description="Application group type.")    application: list[GroupApplication] = Field(default=None, description="Application ID list.")    category: list[GroupCategory] = Field(default=None, description="Application category ID list.")    risk: list[GroupRisk] = Field(default=None, description="Risk, or impact, of allowing traffic from this application to occur (1 - 5; Low, Elevated, Medium, High, and Critical).")    protocols: str | None = Field(default="all", description="Application protocol filter.")    vendor: str | None = Field(default="all", description="Application vendor filter.")    technology: str | None = Field(default="all", description="Application technology filter.")    behavior: str | None = Field(default="all", description="Application behavior filter.")    popularity: GroupPopularityEnum | None = Field(default="1 2 3 4 5", description="Application popularity filter (1 - 5, from least to most popular).")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.098623Z
# ============================================================================
