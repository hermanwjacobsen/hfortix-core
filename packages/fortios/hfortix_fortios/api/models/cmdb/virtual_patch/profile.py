...
class ProfileModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=47, default="", description="Profile name.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    severity: ProfileSeverityEnum | None = Field(default="info low medium high critical", description="Relative severity of the signature (low, medium, high, critical).")    action: Literal["pass", "block"] | None = Field(default="block", description="Action (pass/block).")    log: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable logging of detection.")    exemption: list[ProfileExemption] = Field(default=None, description="Exempt devices or rules.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.712221Z
# ============================================================================
