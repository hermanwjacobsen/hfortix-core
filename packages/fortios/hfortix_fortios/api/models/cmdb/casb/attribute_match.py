...
class AttributeMatchModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=79, default="", description="CASB attribute match name.")    application: str = Field(max_length=79, default="", description="CASB attribute application name.")  # datasource: ['casb.saas-application.name']    match_strategy: Literal["or", "and", "subset"] | None = Field(default="or", description="CASB attribute match strategy.")    match: list[AttributeMatchMatch] = Field(default=None, description="CASB tenant match rules.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.844949Z
# ============================================================================
