...
class IpsUrlfilterSettingModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    device: str | None = Field(max_length=35, default="", description="Interface for this route.")  # datasource: ['system.interface.name']    distance: int | None = Field(ge=1, le=255, default=1, description="Administrative distance (1 - 255) for this route.")    gateway: str | None = Field(default="0.0.0.0", description="Gateway IP address for this route.")    geo_filter: str | None = Field(max_length=255, default=None, description="Filter based on geographical location. Route will NOT be installed if the resolved IP address belongs to the country in the filter.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.396147Z
# ============================================================================
