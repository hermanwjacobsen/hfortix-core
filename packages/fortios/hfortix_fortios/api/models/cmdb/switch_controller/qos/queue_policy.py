...
class QueuePolicyModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=63, default="", description="QoS policy name.")    schedule: Literal["strict", "round-robin", "weighted"] = Field(default="round-robin", description="COS queue scheduling.")    rate_by: Literal["kbps", "percent"] = Field(default="kbps", description="COS queue rate by kbps or percent.")    cos_queue: list[QueuePolicyCosQueue] = Field(default=None, description="COS queue configuration.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.979826Z
# ============================================================================
