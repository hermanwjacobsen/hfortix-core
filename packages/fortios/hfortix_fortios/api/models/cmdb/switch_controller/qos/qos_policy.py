...
class QosPolicyModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=63, default="", description="QoS policy name.")    default_cos: int = Field(ge=0, le=7, default=0, description="Default cos queue for untagged packets.")    trust_dot1p_map: str | None = Field(max_length=63, default="", description="QoS trust 802.1p map.")  # datasource: ['switch-controller.qos.dot1p-map.name']    trust_ip_dscp_map: str | None = Field(max_length=63, default="", description="QoS trust ip dscp map.")  # datasource: ['switch-controller.qos.ip-dscp-map.name']    queue_policy: str | None = Field(max_length=63, default="default", description="QoS egress queue policy.")  # datasource: ['switch-controller.qos.queue-policy.name']    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_trust_ip_dscp_map_references(client)
        all_errors.extend(errors)        errors = await self.validate_queue_policy_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.570936Z
# ============================================================================
