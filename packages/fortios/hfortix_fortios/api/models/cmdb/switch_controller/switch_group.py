...
class SwitchGroupModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Switch group name.")    description: str | None = Field(max_length=63, default="", description="Optional switch group description.")    fortilink: str | None = Field(max_length=15, default="", description="FortiLink interface to which switch group members belong.")  # datasource: ['system.interface.name']    members: list[SwitchGroupMembers] = Field(default=None, description="FortiSwitch members belonging to this switch group.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.092164Z
# ============================================================================
