...
class TrafficSnifferModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    mode: Literal["erspan-auto", "rspan", "none"] | None = Field(default="erspan-auto", description="Configure traffic sniffer mode.")    erspan_ip: str | None = Field(default="0.0.0.0", description="Configure ERSPAN collector IP address.")    target_mac: list[TrafficSnifferTargetMac] = Field(default=None, description="Sniffer MACs to filter.")    target_ip: list[TrafficSnifferTargetIp] = Field(default=None, description="Sniffer IPs to filter.")    target_port: list[TrafficSnifferTargetPort] = Field(default=None, description="Sniffer ports to filter.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.392483Z
# ============================================================================
