...
class StpInstanceModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: str | None = Field(max_length=2, default="", description="Instance ID.")    vlan_range: list[StpInstanceVlanRange] = Field(default=None, description="Configure VLAN range for STP instance.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:32.966805Z
# ============================================================================
