...
class LocationModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=63, default="", description="Unique location item name.")    address_civic: list[LocationAddressCivic] = Field(default=None, description="Configure location civic address.")    coordinates: list[LocationCoordinates] = Field(default=None, description="Configure location GPS coordinates.")    elin_number: list[LocationElinNumber] = Field(default=None, description="Configure location ELIN number.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:37.296273Z
# ============================================================================
