...
class IngressModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    id: int | None = Field(ge=0, le=4294967295, default=0, description="ACL ID.")    description: str | None = Field(max_length=63, default="", description="Description for the ACL policy.")    action: list[IngressAction] = Field(default=None, description="ACL actions.")    classifier: list[IngressClassifier] = Field(default=None, description="ACL classifiers.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.341254Z
# ============================================================================
