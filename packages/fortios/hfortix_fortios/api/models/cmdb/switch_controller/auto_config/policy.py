...
class PolicyModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=63, default="", description="Auto-config policy name.")    qos_policy: str | None = Field(max_length=63, default="default", description="Auto-Config QoS policy.")  # datasource: ['switch-controller.qos.qos-policy.name']    storm_control_policy: str | None = Field(max_length=63, default="auto-config", description="Auto-Config storm control policy.")  # datasource: ['switch-controller.storm-control-policy.name']    poe_status: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable PoE status.")    igmp_flood_report: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IGMP flood report.")    igmp_flood_traffic: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable IGMP flood traffic.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_storm_control_policy_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.842747Z
# ============================================================================
