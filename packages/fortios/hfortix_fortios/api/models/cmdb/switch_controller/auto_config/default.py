...
class DefaultModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    fgt_policy: str | None = Field(max_length=63, default="default", description="Default FortiLink auto-config policy.")  # datasource: ['switch-controller.auto-config.policy.name']    isl_policy: str | None = Field(max_length=63, default="default", description="Default ISL auto-config policy.")  # datasource: ['switch-controller.auto-config.policy.name']    icl_policy: str | None = Field(max_length=63, default="default-icl", description="Default ICL auto-config policy.")  # datasource: ['switch-controller.auto-config.policy.name']    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_isl_policy_references(client)
        all_errors.extend(errors)        errors = await self.validate_icl_policy_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.778779Z
# ============================================================================
