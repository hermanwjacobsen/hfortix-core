...
class CustomModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=15, default="", description="Auto-Config FortiLink or ISL/ICL interface name.")    switch_binding: list[CustomSwitchBinding] = Field(default=None, description="Switch binding list.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.637259Z
# ============================================================================
