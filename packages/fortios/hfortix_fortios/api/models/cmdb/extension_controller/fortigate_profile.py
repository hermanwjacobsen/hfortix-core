...
class FortigateProfileModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=31, default="", description="FortiGate connector profile name.")    id: int | None = Field(ge=0, le=102400000, default=32, description="ID.")    extension: Literal["lan-extension"] | None = Field(default="lan-extension", description="Extension option.")    lan_extension: list[FortigateProfileLanExtension] = Field(description="FortiGate connector LAN extension configuration.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.565658Z
# ============================================================================
