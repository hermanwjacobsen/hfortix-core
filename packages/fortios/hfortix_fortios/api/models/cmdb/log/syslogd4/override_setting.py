...
class OverrideSettingModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    status: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable remote syslog logging.")    server: str = Field(max_length=127, default="", description="Address of remote syslog server.")    mode: Literal["udp", "legacy-reliable", "reliable"] | None = Field(default="udp", description="Remote syslog logging over UDP/Reliable TCP.")    use_management_vdom: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable use of management VDOM as source VDOM for logs sent to syslog server.")    port: int | None = Field(ge=0, le=65535, default=514, description="Server listen port.")    facility: OverrideSettingFacilityEnum | None = Field(default="local7", description="Remote syslog facility.")    source_ip_interface: str | None = Field(max_length=15, default="", description="Source interface of syslog.")  # datasource: ['system.interface.name']    source_ip: str | None = Field(max_length=63, default="", description="Source IP address of syslog.")    format: OverrideSettingFormatEnum | None = Field(default="default", description="Log format.")    priority: Literal["default", "low"] | None = Field(default="default", description="Set log transmission priority.")    max_log_rate: int | None = Field(ge=0, le=100000, default=0, description="Syslog maximum log rate in MBps (0 = unlimited).")    enc_algorithm: OverrideSettingEncAlgorithmEnum | None = Field(default="disable", description="Enable/disable reliable syslogging with TLS encryption.")    ssl_min_proto_version: OverrideSettingSslMinProtoVersionEnum | None = Field(default="default", description="Minimum supported protocol version for SSL/TLS connections (default is to follow system global setting).")    certificate: str | None = Field(max_length=35, default="", description="Certificate used to communicate with Syslog server.")  # datasource: ['certificate.local.name']    custom_field_name: list[OverrideSettingCustomFieldName] = Field(default=None, description="Custom field name for CEF format logging.")    interface_select_method: Literal["auto", "sdwan", "specify"] | None = Field(default="auto", description="Specify how to select outgoing interface to reach server.")    interface: str = Field(max_length=15, default="", description="Specify outgoing interface to reach server.")  # datasource: ['system.interface.name']    vrf_select: int | None = Field(ge=0, le=511, default=0, description="VRF ID used for connection to server.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.183093Z
# ============================================================================
