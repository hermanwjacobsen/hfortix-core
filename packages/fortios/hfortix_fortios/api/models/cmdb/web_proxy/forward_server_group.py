...
class ForwardServerGroupModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=63, default="", description="Configure a forward server group consisting one or multiple forward servers. Supports failover and load balancing.")    affinity: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable affinity, attaching a source-ip's traffic to the assigned forwarding server until the forward-server-affinity-timeout is reached (under web-proxy global).")    ldb_method: Literal["weighted", "least-session", "active-passive"] | None = Field(default="weighted", description="Load balance method: weighted or least-session.")    group_down_option: Literal["block", "pass"] | None = Field(default="block", description="Action to take when all of the servers in the forward server group are down: block sessions until at least one server is back up or pass sessions to their destination.")    server_list: list[ForwardServerGroupServerList] = Field(default=None, description="Add web forward servers to a list to form a server group. Optionally assign weights to each server.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.848603Z
# ============================================================================
