...
class UrlMatchModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=63, default="", description="Configure a name for the URL to be exempted.")    status: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable exempting the URLs matching the URL pattern from web proxy forwarding, caching and fast-fallback.")    url_pattern: str = Field(max_length=511, default="", description="URL pattern to be exempted from web proxy forwarding, caching and fast-fallback.")    forward_server: str | None = Field(max_length=63, default="", description="Forward server name.")  # datasource: ['web-proxy.forward-server.name', 'web-proxy.forward-server-group.name']    fast_fallback: str | None = Field(max_length=63, default="", description="Fast fallback configuration entry name.")  # datasource: ['web-proxy.fast-fallback.name']    cache_exemption: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable exempting this URL pattern from caching.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_fast_fallback_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.853857Z
# ============================================================================
