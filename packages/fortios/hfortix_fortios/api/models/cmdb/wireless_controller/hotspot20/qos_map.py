...
class QosMapModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="QOS-MAP name.")    dscp_except: list[QosMapDscpExcept] = Field(default=None, description="Differentiated Services Code Point (DSCP) exceptions.")    dscp_range: list[QosMapDscpRange] = Field(default=None, description="Differentiated Services Code Point (DSCP) ranges.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:37.026094Z
# ============================================================================
