...
class H2qpOsuProviderModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="OSU provider ID.")    friendly_name: list[H2qpOsuProviderFriendlyName] = Field(default=None, description="OSU provider friendly name.")    server_uri: str | None = Field(max_length=255, default="", description="Server URI.")    osu_method: Literal["oma-dm", "soap-xml-spp", "reserved"] | None = Field(default="", description="OSU method list.")    osu_nai: str | None = Field(max_length=255, default="", description="OSU NAI.")    service_description: list[H2qpOsuProviderServiceDescription] = Field(default=None, description="OSU service name.")    icon: str | None = Field(max_length=35, default="", description="OSU provider icon.")  # datasource: ['wireless-controller.hotspot20.icon.name']    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.010276Z
# ============================================================================
