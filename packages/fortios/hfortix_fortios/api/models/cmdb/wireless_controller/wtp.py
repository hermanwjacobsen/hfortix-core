...
class WtpModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    wtp_id: str = Field(max_length=35, default="", description="WTP ID.")    index: int | None = Field(ge=0, le=4294967295, default=0, description="Index (0 - 4294967295).")    uuid: str | None = Field(default="00000000-0000-0000-0000-000000000000", description="Universally Unique Identifier (UUID; automatically assigned but can be manually reset).")    admin: Literal["discovered", "disable", "enable"] | None = Field(default="enable", description="Configure how the FortiGate operating as a wireless controller discovers and manages this WTP, AP or FortiAP.")    name: str | None = Field(max_length=35, default="", description="WTP, AP or FortiAP configuration name.")    location: str | None = Field(max_length=35, default="", description="Field for describing the physical location of the WTP, AP or FortiAP.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    region: str | None = Field(max_length=35, default="", description="Region name WTP is associated with.")  # datasource: ['wireless-controller.region.name']    region_x: str | None = Field(max_length=15, default="0", description="Relative horizontal region coordinate (between 0 and 1).")    region_y: str | None = Field(max_length=15, default="0", description="Relative vertical region coordinate (between 0 and 1).")    firmware_provision: str | None = Field(max_length=35, default="", description="Firmware version to provision to this FortiAP on bootup (major.minor.build, i.e. 6.2.1234).")    firmware_provision_latest: Literal["disable", "once"] | None = Field(default="disable", description="Enable/disable one-time automatic provisioning of the latest firmware version.")    wtp_profile: str = Field(max_length=35, default="", description="WTP profile name to apply to this WTP, AP or FortiAP.")  # datasource: ['wireless-controller.wtp-profile.name']    apcfg_profile: str | None = Field(max_length=35, default="", description="AP local configuration profile name.")  # datasource: ['wireless-controller.apcfg-profile.name']    bonjour_profile: str | None = Field(max_length=35, default="", description="Bonjour profile name.")  # datasource: ['wireless-controller.bonjour-profile.name']    ble_major_id: int | None = Field(ge=0, le=65535, default=0, description="Override BLE Major ID.")    ble_minor_id: int | None = Field(ge=0, le=65535, default=0, description="Override BLE Minor ID.")    override_led_state: Literal["enable", "disable"] | None = Field(default="disable", description="Enable to override the profile LED state setting for this FortiAP. You must enable this option to use the led-state command to turn off the FortiAP's LEDs.")    led_state: Literal["enable", "disable"] | None = Field(default="enable", description="Enable to allow the FortiAPs LEDs to light. Disable to keep the LEDs off. You may want to keep the LEDs off so they are not distracting in low light areas etc.")    override_wan_port_mode: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable overriding the wan-port-mode in the WTP profile.")    wan_port_mode: Literal["wan-lan", "wan-only"] | None = Field(default="wan-only", description="Enable/disable using the FortiAP WAN port as a LAN port.")    override_ip_fragment: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable overriding the WTP profile IP fragment prevention setting.")    ip_fragment_preventing: Literal["tcp-mss-adjust", "icmp-unreachable"] | None = Field(default="tcp-mss-adjust", description="Method(s) by which IP fragmentation is prevented for control and data packets through CAPWAP tunnel (default = tcp-mss-adjust).")    tun_mtu_uplink: int | None = Field(ge=576, le=1500, default=0, description="The maximum transmission unit (MTU) of uplink CAPWAP tunnel (576 - 1500 bytes or 0; 0 means the local MTU of FortiAP; default = 0).")    tun_mtu_downlink: int | None = Field(ge=576, le=1500, default=0, description="The MTU of downlink CAPWAP tunnel (576 - 1500 bytes or 0; 0 means the local MTU of FortiAP; default = 0).")    override_split_tunnel: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable overriding the WTP profile split tunneling setting.")    split_tunneling_acl_path: Literal["tunnel", "local"] | None = Field(default="local", description="Split tunneling ACL path is local/tunnel.")    split_tunneling_acl_local_ap_subnet: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable automatically adding local subnetwork of FortiAP to split-tunneling ACL (default = disable).")    split_tunneling_acl: list[WtpSplitTunnelingAcl] = Field(default=None, description="Split tunneling ACL filter list.")    override_lan: Literal["enable", "disable"] | None = Field(default="disable", description="Enable to override the WTP profile LAN port setting.")    lan: list[WtpLan] = Field(default=None, description="WTP LAN port mapping.")    override_allowaccess: Literal["enable", "disable"] | None = Field(default="disable", description="Enable to override the WTP profile management access configuration.")    allowaccess: Literal["https", "ssh", "snmp"] | None = Field(default="", description="Control management access to the managed WTP, FortiAP, or AP. Separate entries with a space.")    override_login_passwd_change: Literal["enable", "disable"] | None = Field(default="disable", description="Enable to override the WTP profile login-password (administrator password) setting.")    login_passwd_change: Literal["yes", "default", "no"] | None = Field(default="no", description="Change or reset the administrator password of a managed WTP, FortiAP or AP (yes, default, or no, default = no).")    login_passwd: Any = Field(max_length=128, default=None, description="Set the managed WTP, FortiAP, or AP's administrator password.")    override_default_mesh_root: Literal["enable", "disable"] | None = Field(default="disable", description="Enable to override the WTP profile default mesh root SSID setting.")    default_mesh_root: Literal["enable", "disable"] | None = Field(default="disable", description="Configure default mesh root SSID when it is not included by radio's SSID configuration.")    radio_1: list[WtpRadio1] = Field(default=None, description="Configuration options for radio 1.")    radio_2: list[WtpRadio2] = Field(default=None, description="Configuration options for radio 2.")    radio_3: list[WtpRadio3] = Field(default=None, description="Configuration options for radio 3.")    radio_4: list[WtpRadio4] = Field(default=None, description="Configuration options for radio 4.")    image_download: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable WTP image download.")    mesh_bridge_enable: Literal["default", "enable", "disable"] | None = Field(default="default", description="Enable/disable mesh Ethernet bridge when WTP is configured as a mesh branch/leaf AP.")    purdue_level: WtpPurdueLevelEnum | None = Field(default="3", description="Purdue Level of this WTP.")    coordinate_latitude: str | None = Field(max_length=19, default="", description="WTP latitude coordinate.")    coordinate_longitude: str | None = Field(max_length=19, default="", description="WTP longitude coordinate.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_wtp_profile_references(client)
        all_errors.extend(errors)        errors = await self.validate_apcfg_profile_references(client)
        all_errors.extend(errors)        errors = await self.validate_bonjour_profile_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.139821Z
# ============================================================================
