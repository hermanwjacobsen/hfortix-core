...
class InterControllerModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    inter_controller_mode: Literal["disable", "l2-roaming", "1+1"] | None = Field(default="disable", description="Configure inter-controller mode (disable, l2-roaming, 1+1, default = disable).")    l3_roaming: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable layer 3 roaming (default = disable).")    inter_controller_key: Any = Field(max_length=127, default=None, description="Secret key for inter-controller communications.")    inter_controller_pri: Literal["primary", "secondary"] | None = Field(default="primary", description="Configure inter-controller's priority (primary or secondary, default = primary).")    fast_failover_max: int | None = Field(ge=3, le=64, default=10, description="Maximum number of retransmissions for fast failover HA messages between peer wireless controllers (3 - 64, default = 10).")    fast_failover_wait: int | None = Field(ge=10, le=86400, default=10, description="Minimum wait time before an AP transitions from secondary controller to primary controller (10 - 86400 sec, default = 10).")    inter_controller_peer: list[InterControllerInterControllerPeer] = Field(default=None, description="Fast failover peer wireless controller list.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.324553Z
# ============================================================================
