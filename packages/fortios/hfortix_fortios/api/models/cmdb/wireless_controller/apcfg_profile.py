...
class ApcfgProfileModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="AP local configuration profile name.")    ap_family: Literal["fap", "fap-u", "fap-c"] | None = Field(default="fap", description="FortiAP family type (default = fap).")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    ac_type: Literal["default", "specify", "apcfg"] | None = Field(default="default", description="Validation controller type (default = default).")    ac_timer: int | None = Field(ge=3, le=30, default=10, description="Maximum waiting time for the AP to join the validation controller after applying AP local configuration (3 - 30 min, default = 10).")    ac_ip: str | None = Field(default="0.0.0.0", description="IP address of the validation controller that AP must be able to join after applying AP local configuration.")    ac_port: int | None = Field(ge=1024, le=49150, default=5246, description="Port of the validation controller that AP must be able to join after applying AP local configuration (1024 - 49150, default = 5246).")    command_list: list[ApcfgProfileCommandList] = Field(default=None, description="AP local configuration command list.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.100937Z
# ============================================================================
