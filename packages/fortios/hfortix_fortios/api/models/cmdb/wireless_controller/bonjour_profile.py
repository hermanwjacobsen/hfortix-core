...
class BonjourProfilePolicyList(BaseModel):
    ...
    services: ServicesEnum | None = Field(default="all", description="Bonjour services for the VLAN connecting to the Bonjour network.")
...
class BonjourProfileModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Bonjour profile name.")    comment: str | None = Field(max_length=63, default="", description="Comment.")    micro_location: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable Micro location for Bonjour profile (default = disable).")    policy_list: list[BonjourProfilePolicyList] = Field(default=None, description="Bonjour policy list.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:34.156959Z
# ============================================================================
