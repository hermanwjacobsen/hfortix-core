...
class VapGroupModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str = Field(max_length=35, default="", description="Group Name.")    comment: str | None = Field(max_length=255, default=None, description="Comment.")    vaps: list[VapGroupVaps] = Field(default=None, description="List of SSIDs to be included in the VAP group.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.414450Z
# ============================================================================
