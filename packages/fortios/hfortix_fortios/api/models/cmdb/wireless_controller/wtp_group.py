...
class WtpGroupModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="WTP group name.")    platform_type: WtpGroupPlatformTypeEnum | None = Field(default="", description="FortiAP models to define the WTP group platform type.")    ble_major_id: int | None = Field(ge=0, le=65535, default=0, description="Override BLE Major ID.")    wtps: list[WtpGroupWtps] = Field(default=None, description="WTP list.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:35.923911Z
# ============================================================================
