...
class PeergrpModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Peer group name.")    member: list[PeergrpMember] = Field(default=None, description="Peer group members.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.498523Z
# ============================================================================
