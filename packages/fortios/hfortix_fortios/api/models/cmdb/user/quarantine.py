...
class QuarantineModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    quarantine: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable quarantine.")    traffic_policy: str | None = Field(max_length=63, default="", description="Traffic policy for quarantined MACs.")  # datasource: ['switch-controller.traffic-policy.name']    firewall_groups: str | None = Field(max_length=79, default="", description="Firewall address group which includes all quarantine MAC address.")  # datasource: ['firewall.addrgrp.name']    targets: list[QuarantineTargets] = Field(default=None, description="Quarantine entry to hold multiple MACs.")    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    async def validate_all_references(self, client: Any) -> list[str]:
        ...
        all_errors.extend(errors)        errors = await self.validate_firewall_groups_references(client)
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:33.198678Z
# ============================================================================
