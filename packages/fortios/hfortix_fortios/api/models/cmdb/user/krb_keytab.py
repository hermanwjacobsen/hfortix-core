...
class KrbKeytabModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=35, default="", description="Kerberos keytab entry name.")    pac_data: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable parsing PAC data in the ticket.")    principal: str = Field(max_length=511, default="", description="Kerberos service principal. For example, HTTP/myfgt.example.com@example.com.")    ldap_server: list[KrbKeytabLdapServer] = Field(default=None, description="LDAP server name(s).")    keytab: str = Field(max_length=8191, default="", description="Base64 coded keytab file containing a pre-shared key.")    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.894616Z
# ============================================================================
