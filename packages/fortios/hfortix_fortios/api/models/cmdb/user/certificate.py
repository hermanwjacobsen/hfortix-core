...
class CertificateModel(BaseModel):
    ...
    # Model Fields
    # ========================================================================
    name: str | None = Field(max_length=64, default="", description="User name.")    id: int | None = Field(ge=0, le=4294967295, default=0, description="User ID.")    status: Literal["enable", "disable"] = Field(default="enable", description="Enable/disable allowing the certificate user to authenticate with the FortiGate unit.")    type: Literal["single-certificate", "trusted-issuer"] = Field(default="single-certificate", description="Type of certificate authentication method.")    common_name: str = Field(max_length=64, default="", description="Certificate common name.")    issuer: str = Field(max_length=79, default="", description="CA certificate used for client certificate verification.")  # datasource: ['vpn.certificate.ca.name']    # ========================================================================
    # Custom Validators
    # ========================================================================
...
# Schema: 1.7.0
# Generated: 2026-01-14T15:56:36.418317Z
# ============================================================================
