"""
FortiOS MONITOR - Router bgp

Configuration endpoint for managing monitor router/bgp objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.router_bgp.get()
...
class Bgp:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_bgp.get()
            ...
            >>> schema = fgt.api.monitor.router_bgp.get(action="schema")
        ...
        cache_key = f"monitor/router/bgp"
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Bgp.validate_field("name", "test")
            >>> if not is_valid:
