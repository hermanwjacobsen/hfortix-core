"""
FortiOS MONITOR - Router ospf

Configuration endpoint for managing monitor router/ospf objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.router_ospf.get()
...
class Ospf:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.router_ospf.get()
            ...
            >>> schema = fgt.api.monitor.router_ospf.get(action="schema")
        ...
        cache_key = f"monitor/router/ospf"
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Ospf.validate_field("name", "test")
            >>> if not is_valid:
