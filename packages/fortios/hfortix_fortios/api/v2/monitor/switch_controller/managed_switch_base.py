"""
FortiOS MONITOR - Switch_controller managed_switch

Configuration endpoint for managing monitor switch_controller/managed_switch objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.switch_controller_managed_switch.get()
...
class ManagedSwitch:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.switch_controller_managed_switch.get()
            ...
            >>> schema = fgt.api.monitor.switch_controller_managed_switch.get(action="schema")
        ...
        cache_key = f"monitor/switch_controller/managed_switch"
        ...
        if name:
            endpoint = f"/switch-controller/managed-switch/{name}"
        else:
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = ManagedSwitch.field_info("name")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = ManagedSwitch.validate_field("name", "test")
            >>> if not is_valid:
