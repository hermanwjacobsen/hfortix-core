"""
FortiOS MONITOR - Network ddns

Configuration endpoint for managing monitor network/ddns objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.network_ddns.get()
...
class Ddns:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve network/ddns configuration.
        ...
        Examples:
            >>> # Get all network/ddns objects
            >>> result = fgt.api.monitor.network_ddns.get()
            ...
            >>> schema = fgt.api.monitor.network_ddns.get(action="schema")

        See Also:
            - post(): Create new network/ddns object
            - put(): Update existing network/ddns object
            - delete(): Remove network/ddns object
            - exists(): Check if object exists
        """
        # Check cache for readonly reference data (24hr TTL)
        cache_key = f"monitor/network/ddns"
        ...
        if name:
            endpoint = f"/network/ddns/{name}"
        else:
            endpoint = "/network/ddns"
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Ddns.validate_field("name", "test")
            >>> if not is_valid:
