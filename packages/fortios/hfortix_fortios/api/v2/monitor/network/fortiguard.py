"""
FortiOS MONITOR - Network fortiguard

Configuration endpoint for managing monitor network/fortiguard objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.network_fortiguard.get()
...
class Fortiguard:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve network/fortiguard configuration.
        ...
        Examples:
            >>> # Get all network/fortiguard objects
            >>> result = fgt.api.monitor.network_fortiguard.get()
            ...
            >>> schema = fgt.api.monitor.network_fortiguard.get(action="schema")

        See Also:
            - post(): Create new network/fortiguard object
            - put(): Update existing network/fortiguard object
            - delete(): Remove network/fortiguard object
            - exists(): Check if object exists
        """
        # Check cache for readonly reference data (24hr TTL)
        cache_key = f"monitor/network/fortiguard"
        ...
        if name:
            endpoint = f"/network/fortiguard/{name}"
        else:
            endpoint = "/network/fortiguard"
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Fortiguard.field_info("name")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Fortiguard.validate_field("name", "test")
            >>> if not is_valid:
