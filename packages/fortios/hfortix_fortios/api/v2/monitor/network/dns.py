"""
FortiOS MONITOR - Network dns

Configuration endpoint for managing monitor network/dns objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.network_dns.get()
...
class Dns:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve network/dns configuration.
        ...
        Examples:
            >>> # Get all network/dns objects
            >>> result = fgt.api.monitor.network_dns.get()
            ...
            >>> schema = fgt.api.monitor.network_dns.get(action="schema")

        See Also:
            - post(): Create new network/dns object
            - put(): Update existing network/dns object
            - delete(): Remove network/dns object
            - exists(): Check if object exists
        """
        # Check cache for readonly reference data (24hr TTL)
        cache_key = f"monitor/network/dns"
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Dns.validate_field("name", "test")
            >>> if not is_valid:
