"""
FortiOS MONITOR - Casb saas_application

Configuration endpoint for managing monitor casb/saas_application objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.casb_saas_application.get()
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.casb_saas_application.get()
            ...
            >>> schema = fgt.api.monitor.casb_saas_application.get(action="schema")
        ...
        cache_key = f"monitor/casb/saas_application"
