"""
FortiOS MONITOR - System fortiguard

Configuration endpoint for managing monitor system/fortiguard objects.

API Endpoints:
    GET    /monitor/system/fortiguard
    POST   /monitor/system/fortiguard
    PUT    /monitor/system/fortiguard/{identifier}
    DELETE /monitor/system/fortiguard/{identifier}
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.system_fortiguard.get()
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_fortiguard.get()
            ...
            >>> schema = fgt.api.monitor.system_fortiguard.get(action="schema")
