"""
FortiOS MONITOR - System ntp

Configuration endpoint for managing monitor system/ntp objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.system_ntp.get()
...
class Ntp:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_ntp.get()
            ...
            >>> schema = fgt.api.monitor.system_ntp.get(action="schema")
        ...
        cache_key = f"monitor/system/ntp"
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Ntp.validate_field("name", "test")
            >>> if not is_valid:
