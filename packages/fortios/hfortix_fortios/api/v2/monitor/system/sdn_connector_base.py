"""
FortiOS MONITOR - System sdn_connector

Configuration endpoint for managing monitor system/sdn_connector objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.system_sdn_connector.get()
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_sdn_connector.get()
            ...
            >>> schema = fgt.api.monitor.system_sdn_connector.get(action="schema")
        ...
        cache_key = f"monitor/system/sdn_connector"
