"""
FortiOS MONITOR - System config

Configuration endpoint for managing monitor system/config objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.system_config.get()
...
class Config:
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        """
        Retrieve system/config configuration.
        ...
        Examples:
            >>> # Get all system/config objects
            >>> result = fgt.api.monitor.system_config.get()
            ...
            >>> schema = fgt.api.monitor.system_config.get(action="schema")

        See Also:
            - post(): Create new system/config object
            - put(): Update existing system/config object
            - delete(): Remove system/config object
            - exists(): Check if object exists
        """
        # Check cache for readonly reference data (24hr TTL)
        cache_key = f"monitor/system/config"
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            ...
            >>> # Detailed info
            >>> fields = Config.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.config import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Config.field_info("name")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.config import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Config.validate_field("name", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.config import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        """
        from ._helpers.config import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        """
        from ._helpers.config import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        """
        from ._helpers.config import get_schema_info
