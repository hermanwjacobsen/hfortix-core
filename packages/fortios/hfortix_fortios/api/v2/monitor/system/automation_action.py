"""
FortiOS MONITOR - System automation_action

Configuration endpoint for managing monitor system/automation_action objects.
...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.system_automation_action.get()
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_automation_action.get()
            ...
            >>> schema = fgt.api.monitor.system_automation_action.get(action="schema")
        ...
        cache_key = f"monitor/system/automation_action"
