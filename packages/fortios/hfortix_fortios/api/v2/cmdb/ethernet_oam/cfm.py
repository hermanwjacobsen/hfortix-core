...
class Cfm:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new ethernet_oam/cfm object.
        ...
        Examples:
            ...
            >>> payload = Cfm.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.ethernet_oam_cfm.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Cfm.required_fields()) }}
            
            Use Cfm.help('field_name') to get field details.
