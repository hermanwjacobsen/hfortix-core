...
class Sysinfo:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new system/snmp/sysinfo object.
        ...
        Examples:
            ...
            >>> payload = Sysinfo.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.system_snmp_sysinfo.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Sysinfo.required_fields()) }}
            
            Use Sysinfo.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete system/snmp/sysinfo object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update system/snmp/sysinfo object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Sysinfo.help("status"))
        """
        from ._helpers.sysinfo import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = Sysinfo.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = Sysinfo.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.sysinfo import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Sysinfo.field_info("status")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.sysinfo import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Sysinfo.validate_field("status", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.sysinfo import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = Sysinfo.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.sysinfo import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = Sysinfo.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.sysinfo import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = Sysinfo.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.sysinfo import get_schema_info
