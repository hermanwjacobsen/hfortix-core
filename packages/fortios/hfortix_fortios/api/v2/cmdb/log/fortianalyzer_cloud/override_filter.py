...
class OverrideFilter:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new log/fortianalyzer_cloud/override_filter object.
        ...
        Examples:
            ...
            >>> payload = OverrideFilter.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.log_fortianalyzer_cloud_override_filter.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(OverrideFilter.required_fields()) }}
            
            Use OverrideFilter.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete log/fortianalyzer_cloud/override_filter object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update log/fortianalyzer_cloud/override_filter object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(OverrideFilter.help())
            
            >>> # Get field information
            >>> print(OverrideFilter.help("severity"))
        """
        from ._helpers.override_filter import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = OverrideFilter.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = OverrideFilter.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.override_filter import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = OverrideFilter.field_info("severity")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.override_filter import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = OverrideFilter.validate_field("severity", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.override_filter import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = OverrideFilter.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.override_filter import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = OverrideFilter.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.override_filter import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = OverrideFilter.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.override_filter import get_schema_info
