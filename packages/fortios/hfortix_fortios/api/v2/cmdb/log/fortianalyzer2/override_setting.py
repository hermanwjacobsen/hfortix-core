...
class OverrideSetting:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new log/fortianalyzer2/override_setting object.
        ...
        Examples:
            ...
            >>> payload = OverrideSetting.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.log_fortianalyzer2_override_setting.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(OverrideSetting.required_fields()) }}
            
            Use OverrideSetting.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete log/fortianalyzer2/override_setting object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update log/fortianalyzer2/override_setting object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(OverrideSetting.help())
            
            >>> # Get field information
            >>> print(OverrideSetting.help("use-management-vdom"))
        """
        from ._helpers.override_setting import (
            get_schema_info,
            get_field_metadata,
        )
    ...
    def fields(detailed: bool = False) -> Union[list[str], dict[str, dict]]:
        ...
        Examples:
            >>> # Simple list
            >>> fields = OverrideSetting.fields()
            >>> print(f"Available fields: {len(fields)}")
            
            >>> # Detailed info
            >>> fields = OverrideSetting.fields(detailed=True)
            >>> for name, meta in fields.items():
            ...     print(f"{name}: {meta['type']}")
        """
        from ._helpers.override_setting import get_all_fields, get_field_metadata
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = OverrideSetting.field_info("use-management-vdom")
            >>> print(f"Type: {info['type']}")
            >>> if 'options' in info:
            ...     print(f"Options: {info['options']}")
        """
        from ._helpers.override_setting import get_field_metadata
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = OverrideSetting.validate_field("use-management-vdom", "test")
            >>> if not is_valid:
            ...     print(f"Validation error: {error}")
        """
        from ._helpers.override_setting import validate_field_value
    ...
    def required_fields() -> list[str]:
        ...
        Examples:
            >>> required = OverrideSetting.required_fields()
            >>> print(f"Required fields: {', '.join(required)}")
        """
        from ._helpers.override_setting import REQUIRED_FIELDS
    ...
    def defaults() -> dict[str, Any]:
        ...
        Examples:
            >>> defaults = OverrideSetting.defaults()
            >>> print(f"Fields with defaults: {len(defaults)}")
            >>> # Use as starting point for payload
            >>> payload = defaults.copy()
            >>> payload['name'] = 'my-custom-name'
        """
        from ._helpers.override_setting import FIELDS_WITH_DEFAULTS
    ...
    def schema() -> dict[str, Any]:
        ...
        Examples:
            >>> schema = OverrideSetting.schema()
            >>> print(f"Endpoint: {schema['endpoint']}")
            >>> print(f"Total fields: {schema['total_fields']}")
            >>> print(f"Primary key: {schema.get('mkey', 'N/A')}")
        """
        from ._helpers.override_setting import get_schema_info
