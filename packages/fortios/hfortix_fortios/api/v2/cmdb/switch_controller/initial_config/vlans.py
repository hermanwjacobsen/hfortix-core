...
class Vlans:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new switch_controller/initial_config/vlans object.
        ...
        Examples:
            ...
            >>> payload = Vlans.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.cmdb.switch_controller_initial_config_vlans.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Vlans.required_fields()) }}
            
            Use Vlans.help('field_name') to get field details.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete switch_controller/initial_config/vlans object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update switch_controller/initial_config/vlans object (intelligent operation).
