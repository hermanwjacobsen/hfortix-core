...
class Vip6:
    ...
    def post(
        ...
        src_filter: str | list[Vip6SrcfilterItem] | None = ...,
        ...
        realservers: str | list[Vip6RealserversItem] | None = ...,
        ...
        monitor: str | list[Vip6MonitorItem] | None = ...,
