...
class Setting:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new firewall/ipmacbinding/setting object.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete firewall/ipmacbinding/setting object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update firewall/ipmacbinding/setting object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Setting.help("bindthroughfw"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Setting.field_info("bindthroughfw")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Setting.validate_field("bindthroughfw", "test")
            >>> if not is_valid:
