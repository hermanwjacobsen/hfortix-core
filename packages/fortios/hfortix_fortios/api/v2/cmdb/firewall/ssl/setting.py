...
class Setting:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new firewall/ssl/setting object.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete firewall/ssl/setting object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update firewall/ssl/setting object (intelligent operation).
    ...
    def help(field_name: str | None = None) -> str:
        ...
        Examples:
            ...
            >>> print(Setting.help("proxy-connect-timeout"))
        """
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Setting.field_info("proxy-connect-timeout")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Setting.validate_field("proxy-connect-timeout", "test")
            >>> if not is_valid:
