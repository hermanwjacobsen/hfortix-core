...
class InterfacePolicy6:
    ...
    def post(
        ...
        interface: str | None = ...,
        srcaddr6: str | list[InterfacePolicy6Srcaddr6Item] | None = ...,
        dstaddr6: str | list[InterfacePolicy6Dstaddr6Item] | None = ...,
        service6: str | list[InterfacePolicy6Service6Item] | None = ...,
