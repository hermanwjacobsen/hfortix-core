...
class CentralSnatMap:
    ...
    def post(
        ...
        srcintf: str | list[CentralSnatMapSrcintfItem] | None = ...,
        dstintf: str | list[CentralSnatMapDstintfItem] | None = ...,
        orig_addr: str | list[CentralSnatMapOrigaddrItem] | None = ...,
        orig_addr6: str | list[CentralSnatMapOrigaddr6Item] | None = ...,
        dst_addr: str | list[CentralSnatMapDstaddrItem] | None = ...,
        dst_addr6: str | list[CentralSnatMapDstaddr6Item] | None = ...,
        protocol: int | None = ...,
        orig_port: str | None = ...,
        nat: Literal["disable", "enable"] | None = ...,
        nat46: Literal["enable", "disable"] | None = ...,
        nat64: Literal["enable", "disable"] | None = ...,
        nat_ippool: str | list[CentralSnatMapNatippoolItem] | None = ...,
        nat_ippool6: str | list[CentralSnatMapNatippool6Item] | None = ...,
