...
class Setting:
    ...
    def post(
        ...
        **kwargs: Any,
        ...
        """
        Create new firewall/ssh/setting object.
    ...
    def delete(
        ...
        **kwargs: Any,
        ...
        """
        Delete firewall/ssh/setting object.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update firewall/ssh/setting object (intelligent operation).
    ...
    def field_info(field_name: str) -> dict[str, Any] | None:
        ...
        Examples:
            >>> info = Setting.field_info("caname")
    ...
    def validate_field(field_name: str, value: Any) -> tuple[bool, str | None]:
        ...
        Examples:
            >>> is_valid, error = Setting.validate_field("caname", "test")
            >>> if not is_valid:
